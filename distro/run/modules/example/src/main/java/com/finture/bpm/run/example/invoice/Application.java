 ...
 */
package com.finture.bpm.run.example.invoice;

import jakarta.annotation.PostConstruct;
import com.finture.bpm.engine.ProcessEngine;
import com.finture.bpm.example.invoice.InvoiceApplicationHelper;
import com.finture.bpm.example.invoice.InvoiceProcessApplication;
import com.finture.bpm.spring.boot.starter.annotation.EnableProcessApplication;
...
@ConditionalOnProperty(name = "enabled", havingValue = "true", prefix = FloweeBPMSBpmProperties.PREFIX + ".run.example")
@Configuration
