...
public class FloweeBPMSBpmRunDeploymentProperties {

  public static final String PREFIX = FloweeBPMSBpmRunProperties.PREFIX + ".deployment";
  ...
  public String toString() {
    return "FloweeBPMSBpmRunDeploymentProperties[" + "deployChangedOnly=" + deployChangedOnly + ']';
  }
}
