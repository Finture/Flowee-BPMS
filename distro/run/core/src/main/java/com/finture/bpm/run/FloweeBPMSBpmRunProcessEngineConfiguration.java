...
public class FloweeBPMSBpmRunProcessEngineConfiguration extends SpringProcessEngineConfiguration {

  private final String normalizedDeploymentDir;

  public FloweeBPMSBpmRunProcessEngineConfiguration(String normalizedDeploymentDir,
                                                    boolean deployChangedOnly,
                                                    List<ProcessEnginePlugin> processEnginePluginsFromContext,
                                                    List<FloweeBPMSBpmRunProcessEnginePluginProperty> processEnginePluginsFromYaml) {
  ...
  protected void initTelemetryData() {
    ...
    camundaIntegration.add(CamundaIntegration.FLOWEE_BPMS_BPM_RUN);
  }
  ...
  protected void configureProcessEnginePlugins(List<ProcessEnginePlugin> processEnginePluginsFromContext,
    ...
    FloweeBPMSBpmRunProcessEnginePluginHelper.registerYamlPlugins(processEnginePluginsFromContext, processEnginePluginsFromYaml);
