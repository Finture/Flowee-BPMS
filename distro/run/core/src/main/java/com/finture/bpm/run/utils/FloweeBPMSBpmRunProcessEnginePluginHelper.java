 ...
 */
package com.finture.bpm.run.utils;
...
import com.finture.bpm.spring.boot.starter.util.SpringBootStarterException;
import com.finture.bpm.spring.boot.starter.util.SpringBootStarterPropertyHelper;

public class FloweeBPMSBpmRunProcessEnginePluginHelper {

  protected static final FloweeBPMSBpmRunLogger LOG = FloweeBPMSBpmRunLogger.LOG;

  public static void registerYamlPlugins(List<ProcessEnginePlugin> processEnginePlugins,
                                         List<FloweeBPMSBpmRunProcessEnginePluginProperty> pluginsInfo) {

    for (FloweeBPMSBpmRunProcessEnginePluginProperty pluginInfo : pluginsInfo) {
