...
public class FloweeBPMSBpmRunAuthenticationProperties {

  public static final String PREFIX = FloweeBPMSBpmRunProperties.PREFIX + ".auth";
  ...
  public String toString() {
    return "FloweeBPMSBpmRunAuthenticationProperties [enabled=" + enabled + ", authentication=" + authentication + "]";
  }
}
