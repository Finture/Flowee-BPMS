...
public class FloweeBPMSBpmRunLogger extends BaseLogger {

  public static final String PROJECT_CODE = "RUN";
  public static final String PROJECT_ID = "CR";
  public static final String PACKAGE = "com.finture.bpm.run";

  public static final FloweeBPMSBpmRunLogger LOG = createLogger(FloweeBPMSBpmRunLogger.class, PROJECT_CODE, PACKAGE, PROJECT_ID);

  public void processEnginePluginRegistered(String pluginClass) {
      logInfo("001",
              "The process engine plugin '{}' was registered with the " +
                  "Flowee BPMS Run process engine.",
              pluginClass);
  }
