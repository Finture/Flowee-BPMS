...
public class FloweeBPMSBpmRunLdapProperties extends LdapIdentityProviderPlugin {

  public static final String PREFIX = FloweeBPMSBpmRunProperties.PREFIX + ".ldap";
  ...
  public String toString() {
    return "FloweeBPMSBpmRunLdapProperty [enabled=" + enabled +
