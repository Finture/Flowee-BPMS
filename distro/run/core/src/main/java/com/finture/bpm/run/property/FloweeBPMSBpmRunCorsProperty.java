...
public class FloweeBPMSBpmRunCorsProperty {

  public static final String PREFIX = FloweeBPMSBpmRunProperties.PREFIX + ".cors";
  ...
  public FloweeBPMSBpmRunCorsProperty() {
  ...
  public String toString() {
    return "FloweeBPMSBpmRunCorsProperty [" +
        "enabled=" + enabled +
