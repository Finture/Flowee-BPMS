...
public class JBossSubsystemXMLTest extends AbstractSubsystemTest {
  ...
  public static final ServiceName PROCESS_ENGINE_SERVICE_BINDING_SERVICE_NAME = ContextNames.GLOBAL_CONTEXT_SERVICE_NAME
    ...
    .append("ProcessEngineService!com.finture.bpm.ProcessEngineService");
  ...
  static {
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.isDefault", "true");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.datasource", "java:jboss/datasources/ExampleDS");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.history-level", "audit");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.configuration", "com.finture.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.property.job-acquisition-name", "default");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.plugin.ldap.class", "com.finture.bpm.identity.impl.ldap.plugin.LdapIdentityProviderPlugin");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.plugin.ldap.property.test", "abc");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.plugin.ldap.property.number", "123");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.process-engine.test.plugin.ldap.property.bool", "true");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.thread-pool-name", "job-executor-tp");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.core-threads", "5");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.max-threads", "15");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.queue-length", "15");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.keepalive-time", "10");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.allow-core-timeout", "false");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.job-acquisition.default.acquisition-strategy", "SEQUENTIAL");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.job-acquisition.default.property.lockTimeInMillis", "300000");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.job-acquisition.default.property.waitTimeInMillis", "5000");
    EXPRESSION_PROPERTIES.put("com.finture.bpm.jboss.job-executor.job-acquisition.default.property.maxJobsPerAcquisition", "3");                                             
  }
