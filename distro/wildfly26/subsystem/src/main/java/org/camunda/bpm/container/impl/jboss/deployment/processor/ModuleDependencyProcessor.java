...
import com.finture.bpm.container.impl.jboss.service.ProcessApplicationModuleService;
...
public class ModuleDependencyProcessor implements DeploymentUnitProcessor {
  ...
  public static ModuleIdentifier MODULE_IDENTIFYER_PROCESS_ENGINE = ModuleIdentifier.create("com.finture.bpm.camunda-engine");
  public static ModuleIdentifier MODULE_IDENTIFYER_XML_MODEL = ModuleIdentifier.create("com.finture.bpm.model.camunda-xml-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_BPMN_MODEL = ModuleIdentifier.create("com.finture.bpm.model.camunda-bpmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_CMMN_MODEL = ModuleIdentifier.create("com.finture.bpm.model.camunda-cmmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_DMN_MODEL = ModuleIdentifier.create("com.finture.bpm.model.camunda-dmn-model");
  public static ModuleIdentifier MODULE_IDENTIFYER_SPIN = ModuleIdentifier.create("com.finture.spin.camunda-spin-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_CONNECT = ModuleIdentifier.create("com.finture.connect.camunda-connect-core");
  public static ModuleIdentifier MODULE_IDENTIFYER_ENGINE_DMN = ModuleIdentifier.create("com.finture.bpm.dmn.camunda-engine-dmn");
  public static ModuleIdentifier MODULE_IDENTIFYER_GRAAL_JS = ModuleIdentifier.create("org.graalvm.js.js-scriptengine");
  public static ModuleIdentifier MODULE_IDENTIFYER_JUEL = ModuleIdentifier.create("com.finture.bpm.juel.camunda-juel");
