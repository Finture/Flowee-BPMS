 ...
 */
package com.finture.bpm.quarkus.engine.test;

import static org.assertj.core.api.Assertions.assertThat;
import static com.finture.bpm.engine.impl.test.TestHelper.waitForJobExecutorToProcessAllJobs;
...
import com.finture.bpm.quarkus.engine.extension.impl.ManagedJobExecutor;
...
public class ManagedJobExecutorTest {
  ...
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("com/finture/bpm/quarkus/engine/test/config/" +
