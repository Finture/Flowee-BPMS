 ...
 */
package com.finture.bpm.quarkus.engine.test.config;
...
import com.finture.bpm.quarkus.engine.test.helper.ProcessEngineAwareExtension;
...
public class CamundaEngineProgrammaticAndConfigFileTest {
  ...
  static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .withConfigurationResource("com/finture/bpm/quarkus/engine/test/config/mixed-application.properties")
  ...
  public void shouldUseProvidedConfigurationAndConfigProperties() throws SQLException {
    ...
    assertThat(configuration.getDataSource().getConnection()).asString().contains("h2:mem:flowee-bpms");
  }
}