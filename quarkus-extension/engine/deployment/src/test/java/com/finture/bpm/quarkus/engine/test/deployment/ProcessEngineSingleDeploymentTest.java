 ...
 */
package com.finture.bpm.quarkus.engine.test.deployment;
...
public class ProcessEngineSingleDeploymentTest {
  ...
  protected static final QuarkusUnitTest unitTest = new ProcessEngineAwareExtension()
      .setArchiveProducer(() -> ShrinkWrap.create(JavaArchive.class)
          .addAsResource("com/finture/bpm/quarkus/engine/test/deployment/simpleServiceTaskProcess.bpmn"));
  ...
  static class MyConfig {
    ...
    public void createDeployment(@Observes CamundaEngineStartupEvent event) {
      repositoryService.createDeployment()
          .addClasspathResource("com/finture/bpm/quarkus/engine/test/deployment/simpleServiceTaskProcess.bpmn")
          .deploy();
    }
