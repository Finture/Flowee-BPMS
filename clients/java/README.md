...
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.finture.bpm/camunda-external-task-client/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.finture.bpm/camunda-external-task-client)
...
* The client can be configured with the fluent api of the [ExternalTaskClientBuilder](client/src/main/java/com/finture/bpm/client/ExternalTaskClientBuilder.java).
* The topic subscription can be configured with the fluent api of the [TopicSubscriptionBuilder](client/src/main/java/com/finture/bpm/client/topic/TopicSubscriptionBuilder.java).
