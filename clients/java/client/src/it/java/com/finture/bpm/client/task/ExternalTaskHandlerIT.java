 ...
 */
package com.finture.bpm.client.task;

import static org.assertj.core.api.Assertions.assertThat;
import static com.finture.bpm.client.rule.ClientRule.LOCK_DURATION;
import static com.finture.bpm.client.util.ProcessModels.BPMN_ERROR_EXTERNAL_TASK_PROCESS;
import static com.finture.bpm.client.util.ProcessModels.EXTERNAL_TASK_ID;
import static com.finture.bpm.client.util.ProcessModels.EXTERNAL_TASK_PRIORITY;
import static com.finture.bpm.client.util.ProcessModels.EXTERNAL_TASK_TOPIC_FOO;
import static com.finture.bpm.client.util.ProcessModels.PROCESS_KEY;
import static com.finture.bpm.client.util.ProcessModels.PROCESS_KEY_2;
import static com.finture.bpm.client.util.ProcessModels.USER_TASK_AFTER_BPMN_ERROR;
import static com.finture.bpm.client.util.ProcessModels.USER_TASK_ID;
import static com.finture.bpm.client.util.ProcessModels.createProcessWithExclusiveGateway;
...
import com.finture.bpm.client.dto.IncidentDto;
import com.finture.bpm.client.dto.ProcessDefinitionDto;
import com.finture.bpm.client.dto.ProcessInstanceDto;
import com.finture.bpm.client.dto.TaskDto;
import com.finture.bpm.client.dto.VariableInstanceDto;
import com.finture.bpm.client.rule.ClientRule;
import com.finture.bpm.client.rule.EngineRule;
import com.finture.bpm.client.util.ProcessModels;
import com.finture.bpm.client.util.RecordingExternalTaskHandler;
