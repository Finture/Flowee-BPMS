 ...
 */
package com.finture.bpm.client;
...
public interface ExternalTaskClientBuilder {
  ...
  /**
   * Adds a custom strategy to the client for defining the com.finture.bpm.client.backoff between two requests.
   * This information is optional. By default {@link ExponentialBackoffStrategy} is applied.
   *
   * @param backoffStrategy which realizes a custom com.finture.bpm.client.backoff strategy
   * @return the builder
   */
