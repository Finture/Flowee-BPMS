...
import com.finture.bpm.client.exception.ConnectionLostException;
import com.finture.bpm.client.exception.ExternalTaskClientException;
import com.finture.bpm.client.exception.BadRequestException;
import com.finture.bpm.client.exception.NotFoundException;
import com.finture.bpm.client.exception.EngineException;
import com.finture.bpm.client.exception.RestException;
import com.finture.bpm.client.exception.UnknownHttpErrorException;
...
import com.finture.bpm.client.topic.impl.TopicSubscriptionManagerLogger;
import com.finture.bpm.client.variable.impl.format.json.JacksonJsonLogger;
import com.finture.bpm.client.variable.impl.format.serializable.SerializableLogger;
import com.finture.bpm.client.variable.impl.format.xml.DomXmlLogger;
...
public class ExternalTaskClientLogger extends BaseLogger {
  ...
  protected static final String PROJECT_LOGGER = "com.finture.bpm.client";
