 ...
 */
package com.finture.spin.impl.test;
...
public class ScriptEngineRule implements TestRule {
  ...
  /**
   * Create script engine from {@literal @}{@link com.finture.spin.impl.test.ScriptEngine} Annotation. The created
  ...
  private ScriptEngine createScriptEngine(Description description) {
    com.finture.spin.impl.test.ScriptEngine annotation = description.getTestClass().getAnnotation(com.finture.spin.impl.test.ScriptEngine.class);
    if (annotation == null) {
      return null;
    }
    else {
  ...
  /**
   * Get the script engine defined by the {@literal @}{@link com.finture.spin.impl.test.ScriptEngine} Annotation
   *
