...
import com.finture.spin.SpinScriptException;
...
public class SpinTestLogger extends SpinLogger {
  ...
  public static final SpinTestLogger TEST_LOGGER = BaseLogger.createLogger(SpinTestLogger.class, PROJECT_CODE, "com.finture.spin.test", "02");
