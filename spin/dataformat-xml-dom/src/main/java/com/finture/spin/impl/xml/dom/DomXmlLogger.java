...
import com.finture.spin.impl.logging.SpinLogger;
import com.finture.spin.xml.SpinXPathException;
...
import com.finture.spin.xml.SpinXmlElementImplementationException;
...
public class DomXmlLogger extends SpinLogger {
  ...
  public static final DomXmlLogger XML_DOM_LOGGER = BaseLogger.createLogger(DomXmlLogger.class, PROJECT_CODE, "com.finture.spin.xml", "01");
