...
public class DomXmlDeserializationValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("com.finture.spin.impl.xml.dom.format.DomXmlDeserializationValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(SpinRuntimeException.class);
    thrown.expectMessage("'com.finture.spin.impl.xml.dom.format.DomXmlDeserializationValidationTest$Complex'");
