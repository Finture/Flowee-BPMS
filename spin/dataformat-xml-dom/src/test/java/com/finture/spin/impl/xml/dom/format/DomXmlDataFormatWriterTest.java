...
import com.finture.spin.SpinFactory;
import com.finture.spin.spi.DataFormat;
import com.finture.spin.xml.JdkUtil;
...
public class DomXmlDataFormatWriterTest {
  ...
  // see https://github.com/camunda/camunda-bpm-platform/blob/master/engine-plugins/spin-plugin/src/main/java/com/finture/spin/plugin/impl/SpinValueSerializer.java
  ...
  public void testCustomStripSpaceXSL() throws Exception {
    ...
    try (final InputStream inputStream = DomXmlDataFormatWriterTest.class.getClassLoader()
        .getResourceAsStream("com/finture/spin/strip-space-preserve-space.xsl")) {
