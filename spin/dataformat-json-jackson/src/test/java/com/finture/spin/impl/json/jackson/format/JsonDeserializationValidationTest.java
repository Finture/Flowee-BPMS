...
public class JsonDeserializationValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("com.finture.spin.impl.json.jackson.format.JsonDeserializationValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(SpinRuntimeException.class);
    thrown.expectMessage("[com.finture.spin.impl.json.jackson.format.JsonDeserializationValidationTest$Complex]");
