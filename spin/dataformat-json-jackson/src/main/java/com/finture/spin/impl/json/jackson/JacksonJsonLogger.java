...
import com.finture.spin.json.SpinJsonPathException;
import com.finture.spin.json.SpinJsonPropertyException;
...
public class JacksonJsonLogger extends SpinLogger {
  ...
  public static final JacksonJsonLogger JSON_TREE_LOGGER = BaseLogger.createLogger(JacksonJsonLogger.class, PROJECT_CODE, "com.finture.spin.json", "01");
