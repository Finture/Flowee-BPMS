...
import static com.finture.spin.plugin.variable.SpinValues.jsonValue;
import static com.finture.spin.plugin.variable.type.SpinValueType.JSON;
...
import com.finture.spin.plugin.variable.value.JsonValue;
import com.finture.spin.plugin.variable.value.builder.JsonValueBuilder;
...
public class JsonValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "com/finture/spin/plugin/jsonConditionProcess.bpmn20.xml")
