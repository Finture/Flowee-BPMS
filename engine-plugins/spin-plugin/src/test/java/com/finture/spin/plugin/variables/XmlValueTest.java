...
import static com.finture.spin.DataFormats.xml;
import static com.finture.spin.plugin.variable.SpinValues.xmlValue;
import static com.finture.spin.plugin.variable.type.SpinValueType.XML;
...
import com.finture.spin.SpinRuntimeException;
import com.finture.spin.plugin.variable.type.SpinValueType;
import com.finture.spin.plugin.variable.value.XmlValue;
import com.finture.spin.plugin.variable.value.builder.XmlValueBuilder;
...
public class XmlValueTest extends PluggableProcessEngineTestCase {
  ...
  @Deployment(resources = "com/finture/spin/plugin/xmlConditionProcess.bpmn20.xml")
