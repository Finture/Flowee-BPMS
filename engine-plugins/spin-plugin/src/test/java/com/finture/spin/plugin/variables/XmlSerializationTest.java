...
import static com.finture.spin.plugin.variables.TypedValueAssert.assertObjectValueDeserializedNull;
import static com.finture.spin.plugin.variables.TypedValueAssert.assertObjectValueSerializedNull;
import static com.finture.spin.plugin.variables.TypedValueAssert.assertUntypedNullValue;
...
public class XmlSerializationTest extends PluggableProcessEngineTestCase {
  ...
  protected static final String ONE_TASK_PROCESS = "com/finture/spin/plugin/oneTaskProcess.bpmn20.xml";
  ...
  public void testOverloadedAppendMethod() {
    ...
    Reader xmlInput = SpinIoUtil.classpathResourceAsReader("com/finture/spin/plugin/XmlSerializationTest-input.xml");
    String expectedOutput = SpinIoUtil.fileAsString("com/finture/spin/plugin/XmlSerializationTest-output.xml");
