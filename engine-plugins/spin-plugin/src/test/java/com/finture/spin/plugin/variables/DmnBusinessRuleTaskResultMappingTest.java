 ...
 */
package com.finture.spin.plugin.variables;

import java.util.Collections;

import com.finture.bpm.engine.impl.test.ResourceProcessEngineTestCase;
...
public class DmnBusinessRuleTaskResultMappingTest extends ResourceProcessEngineTestCase {
  ...
  protected static final String TEST_DECISION = "com/finture/spin/plugin/DmnBusinessRuleTaskResultMappingTest.dmn11.xml";
  protected static final String CUSTOM_MAPPING_BPMN = "com/finture/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testCustomOutputMapping.bpmn20.xml";
  protected static final String SINGLE_ENTRY_BPMN = "com/finture/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testSingleEntry.bpmn20.xml";
  protected static final String DEFAULT_MAPPING_BPMN = "com/finture/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testDefaultMapping.bpmn20.xml";
  protected static final String STORE_DECISION_RESULT_BPMN = "com/finture/spin/plugin/DmnBusinessRuleTaskResultMappingTest.testStoreDecisionResult.bpmn20.xml";

  public DmnBusinessRuleTaskResultMappingTest() {
    super("com/finture/spin/plugin/json.camunda.cfg.xml");
  }
