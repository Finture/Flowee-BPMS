 ...
 */
package com.finture.connect.plugin;
...
import com.finture.bpm.engine.impl.test.PluggableProcessEngineTestCase;
...
import com.finture.connect.ConnectorException;
import com.finture.connect.Connectors;
import com.finture.connect.httpclient.HttpConnector;
import com.finture.connect.httpclient.soap.SoapHttpConnector;
import com.finture.connect.plugin.util.TestConnector;
...
public class ConnectProcessEnginePluginTest extends PluggableProcessEngineTestCase {
  ...
  public void testConnectorIdMissing() {
    try {
      repositoryService.createDeployment().addClasspathResource("com/finture/connect/plugin/ConnectProcessEnginePluginTest.testConnectorIdMissing.bpmn")
        .deploy();
  ...
  @Deployment(resources="com/finture/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptInputOutputMapping.bpmn")
  ...
  @Deployment(resources="com/finture/connect/plugin/ConnectProcessEnginePluginTest.testConnectorWithThrownExceptionInScriptResourceInputOutputMapping.bpmn")
  ...
  @Deployment(resources="com/finture/connect/plugin/ConnectProcessEnginePluginTest.testConnectorBpmnErrorThrownInScriptResourceNoAsyncAfterJobIsCreated.bpmn")
