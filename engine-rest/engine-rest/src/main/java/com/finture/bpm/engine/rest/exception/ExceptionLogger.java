...
import static com.finture.bpm.engine.impl.util.ExceptionUtil.PERSISTENCE_CONNECTION_ERROR_CLASS;
...
public class ExceptionLogger extends BaseLogger {
  ...
  public static final String REST_API = "com.finture.bpm.engine.rest.exception";
