 ...
 */
package com.finture.bpm.engine.rest.sub.repository.impl;
...
import com.finture.bpm.engine.rest.ProcessInstanceRestService;
import com.finture.bpm.engine.rest.dto.StatisticsResultDto;
import com.finture.bpm.engine.rest.dto.HistoryTimeToLiveDto;
import com.finture.bpm.engine.rest.dto.VariableValueDto;
import com.finture.bpm.engine.rest.dto.batch.BatchDto;
import com.finture.bpm.engine.rest.dto.converter.StringListConverter;
import com.finture.bpm.engine.rest.dto.repository.ActivityStatisticsResultDto;
import com.finture.bpm.engine.rest.dto.repository.CalledProcessDefinitionDto;
import com.finture.bpm.engine.rest.dto.repository.ProcessDefinitionDiagramDto;
import com.finture.bpm.engine.rest.dto.repository.ProcessDefinitionDto;
import com.finture.bpm.engine.rest.dto.repository.ProcessDefinitionSuspensionStateDto;
import com.finture.bpm.engine.rest.dto.runtime.ProcessInstanceDto;
import com.finture.bpm.engine.rest.dto.runtime.ProcessInstanceWithVariablesDto;
import com.finture.bpm.engine.rest.dto.runtime.RestartProcessInstanceDto;
import com.finture.bpm.engine.rest.dto.runtime.StartProcessInstanceDto;
import com.finture.bpm.engine.rest.dto.runtime.modification.ProcessInstanceModificationInstructionDto;
import com.finture.bpm.engine.rest.dto.task.FormDto;
...
import com.finture.bpm.engine.rest.sub.repository.ProcessDefinitionResource;
import com.finture.bpm.engine.rest.util.ApplicationContextPathUtil;
import com.finture.bpm.engine.rest.util.ContentTypeUtil;
import com.finture.bpm.engine.rest.util.EncodingUtil;
import com.finture.bpm.engine.rest.util.URLEncodingUtil;
