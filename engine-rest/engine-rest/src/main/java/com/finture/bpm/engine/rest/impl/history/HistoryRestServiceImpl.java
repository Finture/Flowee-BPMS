...
import com.finture.bpm.engine.rest.history.HistoricActivityInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricProcessDefinitionRestService;
import com.finture.bpm.engine.rest.history.HistoricBatchRestService;
import com.finture.bpm.engine.rest.history.HistoricCaseActivityInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricCaseDefinitionRestService;
import com.finture.bpm.engine.rest.history.HistoricCaseInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricDecisionDefinitionRestService;
import com.finture.bpm.engine.rest.history.HistoricDecisionInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricDecisionStatisticsRestService;
import com.finture.bpm.engine.rest.history.HistoricDetailRestService;
import com.finture.bpm.engine.rest.history.HistoricExternalTaskLogRestService;
import com.finture.bpm.engine.rest.history.HistoricIdentityLinkLogRestService;
import com.finture.bpm.engine.rest.history.HistoricIncidentRestService;
import com.finture.bpm.engine.rest.history.HistoricJobLogRestService;
import com.finture.bpm.engine.rest.history.HistoricProcessInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricTaskInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoricVariableInstanceRestService;
import com.finture.bpm.engine.rest.history.HistoryCleanupRestService;
import com.finture.bpm.engine.rest.history.HistoryRestService;
import com.finture.bpm.engine.rest.history.UserOperationLogRestService;

import com.finture.bpm.engine.rest.impl.AbstractRestProcessEngineAware;
