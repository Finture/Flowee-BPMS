...
import static com.finture.bpm.engine.rest.util.EngineUtil.getProcessEngineProvider;
...
import com.finture.bpm.engine.rest.AuthorizationRestService;
import com.finture.bpm.engine.rest.BatchRestService;
import com.finture.bpm.engine.rest.CaseDefinitionRestService;
import com.finture.bpm.engine.rest.CaseExecutionRestService;
import com.finture.bpm.engine.rest.CaseInstanceRestService;
import com.finture.bpm.engine.rest.ConditionRestService;
import com.finture.bpm.engine.rest.DecisionDefinitionRestService;
import com.finture.bpm.engine.rest.DecisionRequirementsDefinitionRestService;
import com.finture.bpm.engine.rest.DeploymentRestService;
import com.finture.bpm.engine.rest.EventSubscriptionRestService;
import com.finture.bpm.engine.rest.ExecutionRestService;
import com.finture.bpm.engine.rest.ExternalTaskRestService;
import com.finture.bpm.engine.rest.FilterRestService;
import com.finture.bpm.engine.rest.GroupRestService;
import com.finture.bpm.engine.rest.IdentityRestService;
import com.finture.bpm.engine.rest.IncidentRestService;
import com.finture.bpm.engine.rest.JobDefinitionRestService;
import com.finture.bpm.engine.rest.JobRestService;
import com.finture.bpm.engine.rest.MessageRestService;
import com.finture.bpm.engine.rest.MetricsRestService;
import com.finture.bpm.engine.rest.MigrationRestService;
import com.finture.bpm.engine.rest.ModificationRestService;
import com.finture.bpm.engine.rest.ProcessDefinitionRestService;
import com.finture.bpm.engine.rest.ProcessInstanceRestService;
import com.finture.bpm.engine.rest.SchemaLogRestService;
import com.finture.bpm.engine.rest.SignalRestService;
import com.finture.bpm.engine.rest.TaskRestService;
import com.finture.bpm.engine.rest.TelemetryRestService;
import com.finture.bpm.engine.rest.TenantRestService;
import com.finture.bpm.engine.rest.UserRestService;
import com.finture.bpm.engine.rest.VariableInstanceRestService;
import com.finture.bpm.engine.rest.dto.ProcessEngineDto;
import com.finture.bpm.engine.rest.history.HistoryRestService;
import com.finture.bpm.engine.rest.impl.optimize.OptimizeRestService;
