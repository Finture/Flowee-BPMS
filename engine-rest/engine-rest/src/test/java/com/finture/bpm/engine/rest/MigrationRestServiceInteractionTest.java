...
import static com.finture.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.createMockBatch;
import static com.finture.bpm.engine.rest.helper.NoIntermediaryInvocation.immediatelyAfter;
import static org.assertj.core.api.Assertions.assertThat;
import static com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import com.finture.bpm.engine.migration.MigratingActivityInstanceValidationReport;
import com.finture.bpm.engine.migration.MigratingProcessInstanceValidationException;
import com.finture.bpm.engine.migration.MigratingProcessInstanceValidationReport;
import com.finture.bpm.engine.migration.MigratingTransitionInstanceValidationReport;
import com.finture.bpm.engine.migration.MigrationInstruction;
import com.finture.bpm.engine.migration.MigrationInstructionValidationReport;
import com.finture.bpm.engine.migration.MigrationPlan;
import com.finture.bpm.engine.migration.MigrationPlanBuilder;
import com.finture.bpm.engine.migration.MigrationPlanExecutionBuilder;
import com.finture.bpm.engine.migration.MigrationPlanValidationException;
import com.finture.bpm.engine.migration.MigrationPlanValidationReport;
import com.finture.bpm.engine.migration.MigrationVariableValidationReport;
import com.finture.bpm.engine.rest.dto.VariableValueDto;
import com.finture.bpm.engine.rest.dto.migration.MigrationInstructionDto;
import com.finture.bpm.engine.rest.dto.runtime.ProcessInstanceQueryDto;
import com.finture.bpm.engine.rest.helper.FluentAnswer;
import com.finture.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import com.finture.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import com.finture.bpm.engine.rest.util.container.TestContainerRule;
import com.finture.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import com.finture.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import com.finture.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
