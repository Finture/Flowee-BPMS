...
import com.finture.bpm.engine.rest.AbstractRestServiceTest;
...
import static com.finture.bpm.engine.query.PeriodUnit.MONTH;
import static com.finture.bpm.engine.query.PeriodUnit.QUARTER;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_END_TIME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_AVG;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MAX;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_MIN;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_DURATION_REPORT_PERIOD;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_END_TIME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_INST_START_TIME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_COUNT;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_DEFINITION;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEFINITION;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_PROC_DEF_NAME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_REPORT_TASK_NAME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_HISTORIC_TASK_START_TIME;
import static com.finture.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static com.finture.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceDurationReport;
import static com.finture.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReport;
import static com.finture.bpm.engine.rest.helper.MockProvider.createMockHistoricTaskInstanceReportWithProcDef;
