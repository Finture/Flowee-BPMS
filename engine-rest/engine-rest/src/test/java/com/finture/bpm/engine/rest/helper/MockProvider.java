 ...
 */
package com.finture.bpm.engine.rest.helper;
...
import com.finture.bpm.dmn.engine.DmnDecisionResult;
...
import com.finture.bpm.engine.batch.BatchStatistics;
...
import com.finture.bpm.engine.form.FormType;
import com.finture.bpm.engine.form.StartFormData;
import com.finture.bpm.engine.form.TaskFormData;
import com.finture.bpm.engine.history.DurationReportResult;
import com.finture.bpm.engine.history.HistoricActivityInstance;
import com.finture.bpm.engine.history.HistoricActivityStatistics;
import com.finture.bpm.engine.history.HistoricCaseActivityInstance;
import com.finture.bpm.engine.history.HistoricCaseActivityStatistics;
import com.finture.bpm.engine.history.HistoricCaseInstance;
import com.finture.bpm.engine.history.HistoricDecisionInputInstance;
import com.finture.bpm.engine.history.HistoricDecisionInstance;
import com.finture.bpm.engine.history.HistoricDecisionInstanceStatistics;
import com.finture.bpm.engine.history.HistoricDecisionOutputInstance;
import com.finture.bpm.engine.history.HistoricDetail;
import com.finture.bpm.engine.history.HistoricExternalTaskLog;
import com.finture.bpm.engine.history.HistoricFormField;
import com.finture.bpm.engine.history.HistoricIdentityLinkLog;
import com.finture.bpm.engine.history.HistoricIncident;
import com.finture.bpm.engine.history.HistoricJobLog;
import com.finture.bpm.engine.history.HistoricProcessInstance;
import com.finture.bpm.engine.history.HistoricTaskInstance;
import com.finture.bpm.engine.history.HistoricTaskInstanceReportResult;
import com.finture.bpm.engine.history.HistoricVariableInstance;
import com.finture.bpm.engine.history.HistoricVariableUpdate;
...
import com.finture.bpm.engine.impl.persistence.entity.MetricIntervalEntity;
import com.finture.bpm.engine.impl.persistence.entity.ResourceEntity;
import com.finture.bpm.engine.impl.telemetry.dto.ApplicationServerImpl;
import com.finture.bpm.engine.impl.telemetry.dto.CommandImpl;
...
import com.finture.bpm.engine.impl.telemetry.dto.MetricImpl;
...
import com.finture.bpm.engine.management.IncidentStatistics;
import com.finture.bpm.engine.management.JobDefinition;
import com.finture.bpm.engine.management.MetricIntervalValue;
import com.finture.bpm.engine.management.MetricsQuery;
import com.finture.bpm.engine.management.ProcessDefinitionStatistics;
import com.finture.bpm.engine.management.SetJobRetriesBuilder;
...
import com.finture.bpm.engine.query.PeriodUnit;
...
import com.finture.bpm.engine.repository.Resource;
...
import com.finture.bpm.engine.runtime.MessageCorrelationResult;
...
import com.finture.bpm.engine.runtime.ProcessInstanceWithVariables;
...
import com.finture.bpm.engine.task.TaskCountByCandidateGroupResult;
import com.finture.bpm.engine.variable.VariableMap;
import com.finture.bpm.engine.variable.Variables;
import com.finture.bpm.engine.variable.impl.value.ObjectValueImpl;
import com.finture.bpm.engine.variable.value.BytesValue;
import com.finture.bpm.engine.variable.value.ObjectValue;
import com.finture.bpm.engine.variable.value.StringValue;
