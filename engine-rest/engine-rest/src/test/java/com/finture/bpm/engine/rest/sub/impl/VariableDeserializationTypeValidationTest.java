...
public class VariableDeserializationTypeValidationTest {
  ...
  public void shouldValidateBaseTypeOnlyForComplexClass() {
    ...
    // then
    Mockito.verify(validator).validate("com.finture.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex");
    Mockito.verifyNoMoreInteractions(validator);
  }
  ...
  public void shouldFailForComplexClass() {
    ...
    // then
    thrown.expect(IllegalArgumentException.class);
    thrown.expectMessage("[com.finture.bpm.engine.rest.sub.impl.VariableDeserializationTypeValidationTest$Complex]");
