...
import com.finture.bpm.engine.cdi.impl.annotation.CompleteTaskInterceptor;
...
public class CompleteTaskTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/cdi/test/api/annotation/CompleteTaskTest.bpmn20.xml")
