 ...
 */
package com.finture.bpm.engine.cdi.test.bpmn;
...
public class SignalEventTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/cdi/test/bpmn/SignalEventTests.catchAlertSignalBoundaryWithReceiveTask.bpmn20.xml", 
                          "com/finture/bpm/engine/cdi/test/bpmn/SignalEventTests.throwAlertSignalWithDelegate.bpmn20.xml"})
