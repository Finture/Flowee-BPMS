 ...
 */
package com.finture.bpm.engine.cdi.test.api;
...
import com.finture.bpm.engine.cdi.ProcessEngineCdiException;
...
public class BusinessProcessBeanTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/cdi/test/api/BusinessProcessBeanTest.test.bpmn20.xml")
