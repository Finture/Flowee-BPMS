...
import com.finture.bpm.engine.cdi.test.impl.beans.InjectedProcessEngineBean;
...
public class InjectCustomProcessEngineTest extends CdiProcessEngineTestCase {
  ...
  @Before
  public void init() {
    processEngine = TestHelper.getProcessEngine("com/finture/bpm/engine/cdi/test/impl/util/camunda.cfg.xml");
