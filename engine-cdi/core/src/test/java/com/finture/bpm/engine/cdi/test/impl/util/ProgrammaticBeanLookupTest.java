 ...
 */
package com.finture.bpm.engine.cdi.test.impl.util;
...
import com.finture.bpm.engine.cdi.impl.ProcessEngineServicesProducer;
import com.finture.bpm.engine.cdi.impl.util.ProgrammaticBeanLookup;
import com.finture.bpm.engine.cdi.test.impl.beans.SpecializedTestBean;
...
public class ProgrammaticBeanLookupTest {
  ...
  public static JavaArchive createDeployment() {
    return ShrinkWrap.create(JavaArchive.class)
        ...
        .addAsManifestResource("com/finture/bpm/engine/cdi/test/impl/util/beans.xml", "beans.xml");
  }
  ...
  public static JavaArchive createDeploymentWithAlternative() {
    return ShrinkWrap.create(JavaArchive.class)
        ...
        .addAsManifestResource("com/finture/bpm/engine/cdi/test/impl/util/beansWithAlternative.xml", "beans.xml");
  }
