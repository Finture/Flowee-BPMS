 ...
 */
package com.finture.bpm.engine.cdi.test.impl.event;
...
public class EventNotificationTest extends CdiProcessEngineTestCase {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml"})
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/cdi/test/impl/event/EventNotificationTest.process1.bpmn20.xml",
      "com/finture/bpm/engine/cdi/test/impl/event/EventNotificationTest.process2.bpmn20.xml" })
