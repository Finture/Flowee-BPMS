 ...
 */
package com.finture.bpm.engine.cdi.impl.el;
...
public class ElContextDelegate extends ELContext {
  ...
  protected final com.finture.bpm.impl.juel.jakarta.el.ELContext delegateContext;

  protected final ELResolver elResolver;

  public ElContextDelegate(com.finture.bpm.impl.juel.jakarta.el.ELContext delegateContext, ELResolver elResolver) {
