 ...
 */
package com.finture.bpm.integrationtest.functional.transactions;
...
import com.finture.bpm.integrationtest.functional.transactions.beans.FailingTransactionListenerDelegate;
import com.finture.bpm.integrationtest.functional.transactions.beans.GetVersionInfoDelegate;
import com.finture.bpm.integrationtest.functional.transactions.beans.UpdateRouterConfiguration;
...
public class AsyncJobExecutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("com/finture/bpm/integrationtest/functional/transactions/AsyncJobExecutionTest.testAsyncServiceTasks.bpmn20.xml")
            .addAsResource("com/finture/bpm/integrationtest/functional/transactions/AsyncJobExecutionTest.failingTransactionListener.bpmn20.xml")
