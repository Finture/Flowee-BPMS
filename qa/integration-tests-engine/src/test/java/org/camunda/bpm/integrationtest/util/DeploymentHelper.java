...
public class DeploymentHelper extends AbstractDeploymentHelper {
  ...
  protected static final String CAMUNDA_EJB_CLIENT = "com.finture.bpm.javaee:camunda-ejb-client";
  protected static final String CAMUNDA_ENGINE_CDI = "com.finture.bpm:camunda-engine-cdi";
  protected static final String CAMUNDA_ENGINE_SPRING = "com.finture.bpm:camunda-engine-spring";
