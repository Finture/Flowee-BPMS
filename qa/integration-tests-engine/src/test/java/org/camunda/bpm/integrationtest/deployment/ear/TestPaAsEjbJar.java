...
import com.finture.bpm.integrationtest.deployment.ear.beans.NamedCdiBean;
...
public class TestPaAsEjbJar extends AbstractFoxPlatformIntegrationTest {
   ...
   *        |-- com/finture/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml
  ...
  public static EnterpriseArchive paAsEjbModule() throws Exception {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "pa.jar")
      ...
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/paAsEjbJar-process.bpmn20.xml")
      .addAsResource("META-INF/processes.xml", "META-INF/processes.xml")
      .addAsManifestResource("com/finture/bpm/integrationtest/beans.xml", "beans.xml");
