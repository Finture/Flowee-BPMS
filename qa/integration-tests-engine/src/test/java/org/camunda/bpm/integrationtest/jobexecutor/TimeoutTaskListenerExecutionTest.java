...
import com.finture.bpm.integrationtest.jobexecutor.beans.SampleTaskListenerBean;
...
public class TimeoutTaskListenerExecutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    WebArchive archive = initWebArchiveDeployment()
            .addAsResource("com/finture/bpm/integrationtest/jobexecutor/TimeoutTaskListenerExecution.bpmn20.xml")
