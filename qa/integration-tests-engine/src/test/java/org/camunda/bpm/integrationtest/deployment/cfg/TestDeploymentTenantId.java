...
public class TestDeploymentTenantId extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("com/finture/bpm/integrationtest/deployment/cfg/processes-with-tenant-id.xml", "META-INF/processes.xml")
  ...
  public void testDeployProcessArchiveWithTenantId() {
    ...
    com.finture.bpm.engine.repository.Deployment deployment = processEngine
