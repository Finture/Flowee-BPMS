 ...
 */
package com.finture.bpm.integrationtest.functional.message;
...
public class IntermediateMessageCatchEventTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeployment() {
    return initWebArchiveDeployment()
      .addAsResource("com/finture/bpm/integrationtest/functional/message/IntermediateMessageCatchEventTest.bpmn20.xml");
  }
