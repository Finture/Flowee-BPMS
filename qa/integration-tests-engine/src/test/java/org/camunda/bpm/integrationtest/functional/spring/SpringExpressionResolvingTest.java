 ...
 */
package com.finture.bpm.integrationtest.functional.spring;

import com.finture.bpm.integrationtest.functional.spring.beans.ExampleBean;
...
public class SpringExpressionResolvingTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest.testResolveBean.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest.testResolveBeanFromJobExecutor.bpmn20.xml")
      ...
      .addAsWebInfResource("com/finture/bpm/integrationtest/functional/spring/web.xml", "web.xml")

      // spring application context & libs
      .addAsWebInfResource("com/finture/bpm/integrationtest/functional/spring/SpringExpressionResolvingTest-context.xml", "applicationContext.xml")
      .addAsLibraries(DeploymentHelper.getEngineSpring())

      // adding module dependency on process engine module (jboss only)
      .addAsManifestResource("com/finture/bpm/integrationtest/functional/spring/jboss-deployment-structure.xml", "jboss-deployment-structure.xml");
  }
