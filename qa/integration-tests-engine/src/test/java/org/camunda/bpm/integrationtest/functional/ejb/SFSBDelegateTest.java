...
import com.finture.bpm.integrationtest.functional.ejb.beans.SFSBClientDelegate;
import com.finture.bpm.integrationtest.functional.ejb.beans.SFSBDelegate;
...
public class SFSBDelegateTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolution.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/functional/ejb/SFSBDelegateTest.testBeanResolutionFromClient.bpmn20.xml");
  }
