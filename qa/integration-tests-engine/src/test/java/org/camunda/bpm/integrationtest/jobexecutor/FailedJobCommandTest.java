...
import com.finture.bpm.integrationtest.jobexecutor.beans.FailingSLSB;
...
public class FailedJobCommandTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/finture/bpm/integrationtest/jobexecutor/FailedJobCommandTest.bpmn20.xml");
