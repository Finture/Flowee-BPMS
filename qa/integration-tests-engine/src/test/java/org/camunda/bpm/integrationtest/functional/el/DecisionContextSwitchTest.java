...
public class DecisionContextSwitchTest extends AbstractFoxPlatformIntegrationTest {
  ...
  protected static final String DMN_RESOURCE_NAME = "com/finture/bpm/integrationtest/functional/el/BeanResolvingDecision.dmn11.xml";
  ...
  public void shouldSwitchContextWhenUsingDecisionServiceAfterRedeployment() {
    ...
    // given
    List<com.finture.bpm.engine.repository.Deployment> deployments = repositoryService.createDeploymentQuery()
        .list();

    // find dmn deployment
    com.finture.bpm.engine.repository.Deployment dmnDeployment = null;
