...
import com.finture.bpm.engine.cdi.CdiStandaloneProcessEngineConfiguration;
import com.finture.bpm.engine.cdi.impl.util.ProgrammaticBeanLookup;
import com.finture.bpm.integrationtest.functional.cdi.beans.ExampleBean;
...
public class CdiBeanResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("com/finture/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBean.bpmn20.xml")
            .addAsResource("com/finture/bpm/integrationtest/functional/cdi/CdiBeanResolutionTest.testResolveBeanFromJobExecutor.bpmn20.xml");
  }
