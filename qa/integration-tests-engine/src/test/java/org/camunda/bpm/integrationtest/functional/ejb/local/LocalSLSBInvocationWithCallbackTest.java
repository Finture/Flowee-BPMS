 ...
 */
package com.finture.bpm.integrationtest.functional.ejb.local;

import com.finture.bpm.engine.runtime.ProcessInstance;
import com.finture.bpm.integrationtest.functional.ejb.local.bean.CallbackBean;
import com.finture.bpm.integrationtest.functional.ejb.local.bean.InvokeStartProcessDelegateSLSB;
import com.finture.bpm.integrationtest.functional.ejb.local.bean.StartProcessInterface;
import com.finture.bpm.integrationtest.functional.ejb.local.bean.StartProcessSLSB;
...
public class LocalSLSBInvocationWithCallbackTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.testStartProcess.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/functional/ejb/local/LocalSLSBInvocationTest.callbackProcess.bpmn20.xml")
      .addAsWebInfResource("com/finture/bpm/integrationtest/functional/ejb/local/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
  ...
  public static WebArchive delegateDeployment() {
    WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "service.war")
      ...
      .addAsManifestResource(new StringAsset("Dependencies: com.finture.bpm.camunda-engine"), "MANIFEST.MF"); // get access to engine classes
