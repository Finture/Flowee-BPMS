...
public class TestAdditionalResourceSuffixes extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("com/finture/bpm/integrationtest/deployment/cfg/processes-additional-resource-suffixes.xml", "META-INF/processes.xml")
        .addClass(AbstractFoxPlatformIntegrationTest.class)
        .addClass(DummyProcessApplication.class)
        .addAsResource("com/finture/bpm/integrationtest/deployment/cfg/invoice-it.bpmn20.xml")
        .addAsResource("com/finture/bpm/integrationtest/deployment/cfg/hello.groovy")
        .addAsResource("com/finture/bpm/integrationtest/deployment/cfg/hello.py");
