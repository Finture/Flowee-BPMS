...
import com.finture.bpm.integrationtest.functional.spring.beans.ErrorDelegate;
import com.finture.bpm.integrationtest.functional.spring.beans.RetryConfig;
...
public class SpringRetryConfigurationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    ...
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/RetryConfigurationTest.testResolveRetryConfigBean.bpmn20.xml")
      ...
      .addAsWebInfResource("com/finture/bpm/integrationtest/functional/spring/SpringRetryConfigurationTest-context.xml", "applicationContext.xml")
