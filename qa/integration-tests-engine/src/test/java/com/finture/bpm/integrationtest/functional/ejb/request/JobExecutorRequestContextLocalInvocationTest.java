...
import com.finture.bpm.integrationtest.functional.cdi.beans.RequestScopedDelegateBean;
...
import com.finture.bpm.integrationtest.functional.ejb.request.beans.InvocationCounterDelegateBeanLocal;
...
import com.finture.bpm.integrationtest.functional.ejb.request.beans.RequestScopedSFSBDelegate;
...
public class JobExecutorRequestContextLocalInvocationTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/ejb/request/JobExecutorRequestContextLocalInvocationTest.testContextPropagationEjbLocal.bpmn20.xml")
      .addAsWebInfResource("com/finture/bpm/integrationtest/functional/ejb/request/jboss-deployment-structure.xml","jboss-deployment-structure.xml");
  }
...
//    "global/" +
//    "service/" +
//    "InvocationCounterServiceBean!com.finture.bpm.integrationtest.functional.cdi.beans.InvocationCounterServiceLocal");
//
