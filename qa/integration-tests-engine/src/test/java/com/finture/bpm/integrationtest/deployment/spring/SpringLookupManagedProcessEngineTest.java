...
public class SpringLookupManagedProcessEngineTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive() {    
    return ShrinkWrap.create(WebArchive.class, "test.war")
      ...
      .addAsWebInfResource("com/finture/bpm/integrationtest/deployment/spring/SpringLookupManagedProcessEngineTest-context.xml", "applicationContext.xml")
      .addAsLibraries(DeploymentHelper.getEngineSpring())
      .addAsManifestResource("com/finture/bpm/integrationtest/deployment/spring/jboss-deployment-structure.xml", "jboss-deployment-structure.xml")
      .addAsWebInfResource("com/finture/bpm/integrationtest/deployment/spring/web.xml", "web.xml");
  }
