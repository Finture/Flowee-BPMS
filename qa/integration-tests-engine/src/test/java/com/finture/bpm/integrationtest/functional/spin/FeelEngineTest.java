...
public class FeelEngineTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public void testSpinIntegration() {
    // Accessing SPIN object from FEEL requires the com.finture.spin.plugin.impl.feel.integration.SpinValueMapper SPI
    // given
  ...
  public void testFeelEngineComplexContext() {
    // Mapping complex FEEL context into Java requires the com.finture.feel.impl.JavaValueMapper SPI to be registered
    // when
