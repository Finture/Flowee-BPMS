 ...
 */
package com.finture.bpm.integrationtest.functional.classloading.jobexecution;
...
public class ClassloadingDuringJobExecutionTest extends AbstractFoxPlatformIntegrationTest {
  protected static String process =
      ...
      "            <camunda:script scriptFormat=\"Javascript\">throw new com.finture.bpm.engine.delegate.BpmnError(\"Test error thrown\");</camunda:script>\r\n" +
