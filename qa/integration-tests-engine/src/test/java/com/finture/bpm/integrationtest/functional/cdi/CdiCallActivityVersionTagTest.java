...
import com.finture.bpm.integrationtest.functional.cdi.beans.VersionTagBean;
...
public class CdiCallActivityVersionTagTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeployment() {
    return initWebArchiveDeployment()
      ...
      .addAsResource("com/finture/bpm/integrationtest/functional/cdi/CdiCallActivityVersionTagTest.subProcess.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/functional/cdi/CdiCallActivityVersionTagTest.bpmn20.xml");
  }
