...
import com.finture.bpm.integrationtest.deployment.ear.beans.EeComponent;
...
public class TestFoxPlatformClientAsEjbModule_pasAsEjbModule extends AbstractFoxPlatformIntegrationTest {
   ...
   *        |-- com/finture/bpm/integrationtest/deployment/ear/paAsEjbModule-process.bpmn20.xml
   *
  ...
  public static EnterpriseArchive paAsEjbModule() throws Exception {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "pa.jar")
      ...
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/paAsEjbModule-process.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/paAsEjbModule-pa.xml", "META-INF/processes.xml");
