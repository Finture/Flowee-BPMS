...
import com.finture.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener;
...
public class CaseVariableListenerResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("com/finture/bpm/integrationtest/functional/classloading/CaseVariableListenerResolutionTest.cmmn");
  }
  ...
  public void testResolveCaseExecutionListenerClass() {
    ...
    try {
      Class.forName("com.finture.bpm.integrationtest.functional.classloading.beans.ExampleCaseVariableListener");
