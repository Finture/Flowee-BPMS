 ...
 */
package com.finture.bpm.integrationtest.functional.event;

import com.finture.bpm.engine.runtime.ProcessInstance;
import com.finture.bpm.engine.task.Task;
import com.finture.bpm.integrationtest.functional.event.beans.CdiEventSupportProcessApplication;
import com.finture.bpm.integrationtest.functional.event.beans.EventObserverCdiBean;
import com.finture.bpm.integrationtest.functional.event.beans.ExecutionListenerProcessApplication;
...
import com.finture.bpm.integrationtest.util.TestProcessApplication;
...
public class CdiProcessApplicationEventSupportTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createDeployment() {
    WebArchive archive = ShrinkWrap.create(WebArchive.class, "test.war")
        ...
        .addAsResource("com/finture/bpm/integrationtest/functional/event/ProcessApplicationEventSupportTest.testExecutionListener.bpmn20.xml");
