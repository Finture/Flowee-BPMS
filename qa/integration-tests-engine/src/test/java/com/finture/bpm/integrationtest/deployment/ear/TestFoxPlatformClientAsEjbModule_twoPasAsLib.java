...
public class TestFoxPlatformClientAsEjbModule_twoPasAsLib extends AbstractFoxPlatformIntegrationTest {
   ...
   *          |-- com/finture/bpm/integrationtest/deployment/ear/process1.bpmn20.xml
   *        |-- processes2.jar
   *          |-- META-INF/processes.xml
   *          |-- com/finture/bpm/integrationtest/deployment/ear/process2.bpmn20.xml
   *
  ...
  public static EnterpriseArchive twoPasAsLib() {
    ...
    JavaArchive processArchive1Jar = ShrinkWrap.create(JavaArchive.class, "processes1.jar")
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/process1.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/pa1.xml", "META-INF/processes.xml");

    JavaArchive processArchive2Jar = ShrinkWrap.create(JavaArchive.class, "processes.jar")
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/process2.bpmn20.xml")
      .addAsResource("com/finture/bpm/integrationtest/deployment/ear/pa2.xml", "META-INF/processes.xml");
