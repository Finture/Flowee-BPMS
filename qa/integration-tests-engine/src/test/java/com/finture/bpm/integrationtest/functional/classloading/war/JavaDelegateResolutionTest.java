...
import com.finture.bpm.integrationtest.functional.classloading.beans.ExampleDelegate;
...
public class JavaDelegateResolutionTest extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive createProcessArchiveDeplyoment() {
    return initWebArchiveDeployment()
            ...
            .addAsResource("com/finture/bpm/integrationtest/functional/classloading/JavaDelegateResolutionTest.testResolveClass.bpmn20.xml")
            .addAsResource("com/finture/bpm/integrationtest/functional/classloading/JavaDelegateResolutionTest.testResolveClassFromJobExecutor.bpmn20.xml");
  }
  ...
  public void testResolveClass() {
    ...
    try {
      Class.forName("com.finture.bpm.integrationtest.functional.classloading.ExampleDelegate");
