...
public class NestedNonInterruptingBoundaryEventOnInnerSubprocessScenario {
  ...
  public static String deployTimerBoundary() {
    return "com/finture/bpm/qa/upgrade/boundary/nestedNonInterruptingTimerBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployMessageBoundary() {
    return "com/finture/bpm/qa/upgrade/boundary/nestedNonInterruptingMessageBoundaryEventOnInnerSubprocess.bpmn20.xml";
  }
