...
public class SubprocessCompensationScenario {
  ...
  public static String deployProcess() {
    return "com/finture/bpm/qa/upgrade/compensation/subprocessCompensationProcess.bpmn20.xml";
  }

  @Deployment
  public static String deployConcurrentCompensationProcess() {
    return "com/finture/bpm/qa/upgrade/compensation/subprocessConcurrentCompensationProcess.bpmn20.xml";
  }
