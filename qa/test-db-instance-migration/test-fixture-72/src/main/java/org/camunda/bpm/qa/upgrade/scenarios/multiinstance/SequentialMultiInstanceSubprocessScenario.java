...
public class SequentialMultiInstanceSubprocessScenario {
  ...
  public static String deployProcess() {
    return "com/finture/bpm/qa/upgrade/multiinstance/sequentialMultiInstanceSubprocess.bpmn20.xml";
  }

  @Deployment
  public static String deployProcessWithNonInterruptingBoundaryEvent() {
    return "com/finture/bpm/qa/upgrade/multiinstance/sequentialMultiInstanceSubprocessNonInterruptingBoundaryEvent.bpmn20.xml";
  }
