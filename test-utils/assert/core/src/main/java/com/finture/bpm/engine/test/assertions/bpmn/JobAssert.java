...
public class JobAssert extends AbstractProcessAssert<JobAssert, Job> {
   ...
   * @see     com.finture.bpm.engine.runtime.Job#getId()
   */
   ...
   * @return  this {@link JobAssert}
   * @see     com.finture.bpm.engine.runtime.Job#getDuedate()
   */
   ...
   * @return  this {@link JobAssert}
   * @see     com.finture.bpm.engine.runtime.Job#getProcessInstanceId()
   */
   ...
   * @return  this {@link JobAssert}
   * @see     com.finture.bpm.engine.runtime.Job#getExecutionId()
   */
   ...
   *
   * @return  this {@link JobAssert}
   * @see     com.finture.bpm.engine.runtime.Job#getExceptionMessage()
   */
   ...
   * @return  this {@link JobAssert}
   * @see     com.finture.bpm.engine.runtime.Job#getDeploymentId()
   */
