...
import com.finture.bpm.engine.test.assertions.bpmn.AbstractProcessAssert;
import com.finture.bpm.engine.test.assertions.bpmn.TaskAssert;
...
public abstract class AbstractCaseAssert<S extends AbstractCaseAssert<S, A>, A extends CaseExecution> extends AbstractProcessAssert<S, A> {
   ...
   * @throws  com.finture.bpm.engine.ProcessEngineException in case more than
