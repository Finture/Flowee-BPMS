 ...
 *
 * import static com.finture.bpm.engine.test.assertions.bpmn.BpmnAwareTests.*;
 *
 * @see com.finture.bpm.engine.test.assertions.ProcessEngineTests
...
public class BpmnAwareTests extends AbstractAssertions {
   ...
   * @see     com.finture.bpm.engine.RuntimeService
   */
   ...
   *          testing thread
   * @see     com.finture.bpm.engine.AuthorizationService
   */
   ...
   * @see     com.finture.bpm.engine.FormService
   */
   ...
   * @see     com.finture.bpm.engine.HistoryService
   */
   ...
   * @see     com.finture.bpm.engine.IdentityService
   */
   ...
   * @see     com.finture.bpm.engine.ManagementService
   */
   ...
   * @see     com.finture.bpm.engine.RepositoryService
   */
   ...
   * @see     com.finture.bpm.engine.TaskService
   */
   ...
   * @see com.finture.bpm.engine.ExternalTaskService
   */
   ...
   * @see com.finture.bpm.engine.DecisionService
   */
   ...
   * @see     com.finture.bpm.engine.task.TaskQuery
   */
   ...
   * @see     com.finture.bpm.engine.externaltask.ExternalTaskQuery
   */
   ...
   * @see     com.finture.bpm.engine.runtime.JobQuery
   */
   ...
   *          testing thread
   * @see     com.finture.bpm.engine.runtime.ProcessInstanceQuery
   */
   ...
   *          testing thread
   * @see     com.finture.bpm.engine.repository.ProcessDefinitionQuery
   */
   ...
   * @see     com.finture.bpm.engine.runtime.ExecutionQuery
   */
   ...
   * @throws  com.finture.bpm.engine.ProcessEngineException in case more
