...
public class EvaluateDecisionTest extends DmnEngineTest {
  ...
  public static final String EXAMPLE_DMN = "com/finture/bpm/dmn/engine/api/Example.dmn";
  public static final String DATA_TYPE_DMN = "com/finture/bpm/dmn/engine/api/DataType.dmn";
