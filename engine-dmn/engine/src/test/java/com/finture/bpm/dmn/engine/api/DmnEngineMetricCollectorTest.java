...
public class DmnEngineMetricCollectorTest extends DmnEngineTest {
  ...
  public static final String DISH_EXAMPLE_DMN = "com/finture/bpm/dmn/engine/api/DrdDishDecisionExample.dmn";
  public static final String DRG_WITH_LITERAL_EXPRESSIONS = "com/finture/bpm/dmn/engine/api/DrgWithLiteralExpressions.dmn";
