...
import com.finture.bpm.dmn.feel.impl.scala.function.CustomFunctionTransformer;
import com.finture.bpm.dmn.feel.impl.scala.function.FeelCustomFunctionProvider;
import com.finture.bpm.dmn.feel.impl.scala.spin.SpinValueMapperFactory;
import com.finture.bpm.engine.variable.context.VariableContext;
import com.finture.feel.FeelEngine$;
import com.finture.feel.FeelEngine.Builder;
import com.finture.feel.FeelEngine.Failure;
import com.finture.feel.context.CustomContext;
import com.finture.feel.context.VariableProvider;
import com.finture.feel.context.VariableProvider.StaticVariableProvider;
import com.finture.feel.impl.JavaValueMapper;
import com.finture.feel.valuemapper.CustomValueMapper;
import com.finture.feel.valuemapper.ValueMapper.CompositeValueMapper;
import floweebpmsjar.impl.scala.collection.immutable.List;
import floweebpmsjar.impl.scala.collection.immutable.Map;
import floweebpmsjar.impl.scala.runtime.BoxesRunTime;
import floweebpmsjar.impl.scala.util.Either;
import floweebpmsjar.impl.scala.util.Left;
import floweebpmsjar.impl.scala.util.Right;

import java.util.Arrays;

import static com.finture.feel.context.VariableProvider.CompositeVariableProvider;
import static floweebpmsjar.impl.scala.jdk.CollectionConverters.ListHasAsScala;
...
public class ScalaFeelEngine implements FeelEngine {
  ...
  protected com.finture.feel.FeelEngine feelEngine;
  ...
  protected com.finture.feel.FeelEngine buildFeelEngine(CustomFunctionTransformer transformer,
