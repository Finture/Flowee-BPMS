 ...
 */
package com.finture.bpm.container.impl.threading.ra.inflow;
...
import com.finture.bpm.container.impl.threading.ra.JcaExecutorServiceConnector;
...
import com.finture.bpm.engine.impl.jobexecutor.ExecuteJobsRunnable;
...
public class JcaInflowExecuteJobsRunnable extends ExecuteJobsRunnable {
   ...
   * @see com.finture.bpm.engine.impl.jobexecutor.ExecuteJobsRunnable#switchClassLoader()
   *
