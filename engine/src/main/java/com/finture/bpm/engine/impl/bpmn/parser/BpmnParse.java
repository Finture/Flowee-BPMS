 ...
 */
package com.finture.bpm.engine.impl.bpmn.parser;

import static com.finture.bpm.engine.impl.bpmn.parser.BpmnParseUtil.findCamundaExtensionElement;
import static com.finture.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseCamundaExtensionProperties;
import static com.finture.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseCamundaScript;
import static com.finture.bpm.engine.impl.bpmn.parser.BpmnParseUtil.parseInputOutput;
import static com.finture.bpm.engine.impl.util.ClassDelegateUtil.instantiateDelegate;
...
import com.finture.bpm.engine.ActivityTypes;
import com.finture.bpm.engine.BpmnParseException;
...
import com.finture.bpm.engine.delegate.VariableListener;
import com.finture.bpm.engine.impl.Condition;
import com.finture.bpm.engine.impl.HistoryTimeToLiveParser;
import com.finture.bpm.engine.impl.ProcessEngineLogger;
import com.finture.bpm.engine.impl.bpmn.behavior.BoundaryConditionalEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.BoundaryEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CallActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CallableElementActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CancelBoundaryEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CancelEndEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CaseCallActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ClassDelegateActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.CompensationEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.DmnBusinessRuleTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ErrorEndEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.EventBasedGatewayActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.EventSubProcessActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.EventSubProcessStartConditionalEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.EventSubProcessStartEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ExclusiveGatewayActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.InclusiveGatewayActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.IntermediateCatchEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.IntermediateCatchLinkEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.IntermediateConditionalEventBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.IntermediateThrowNoneEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.MailActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ManualTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.MultiInstanceActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.NoneEndEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.NoneStartEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ParallelGatewayActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ParallelMultiInstanceActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ReceiveTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.SequentialMultiInstanceActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ServiceTaskDelegateExpressionActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ServiceTaskExpressionActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ShellActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.SubProcessActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.TaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.TerminateEndEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ThrowEscalationEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.ThrowSignalEventActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.behavior.UserTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.helper.BpmnProperties;
import com.finture.bpm.engine.impl.bpmn.listener.ClassDelegateExecutionListener;
import com.finture.bpm.engine.impl.bpmn.listener.DelegateExpressionExecutionListener;
import com.finture.bpm.engine.impl.bpmn.listener.ExpressionExecutionListener;
import com.finture.bpm.engine.impl.bpmn.listener.ScriptExecutionListener;
import com.finture.bpm.engine.impl.bpmn.parser.*;
import com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener;
import com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition;
import com.finture.bpm.engine.impl.bpmn.parser.Error;
import com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition;
import com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition;
import com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration;
import com.finture.bpm.engine.impl.bpmn.parser.MessageDefinition;
import com.finture.bpm.engine.impl.bpmn.parser.SignalDefinition;
import com.finture.bpm.engine.impl.context.Context;
import com.finture.bpm.engine.impl.core.model.BaseCallableElement;
import com.finture.bpm.engine.impl.core.model.BaseCallableElement.CallableElementBinding;
import com.finture.bpm.engine.impl.core.model.CallableElement;
import com.finture.bpm.engine.impl.core.model.CallableElementParameter;
import com.finture.bpm.engine.impl.core.model.Properties;
import com.finture.bpm.engine.impl.core.variable.mapping.IoMapping;
import com.finture.bpm.engine.impl.core.variable.mapping.value.ConstantValueProvider;
import com.finture.bpm.engine.impl.core.variable.mapping.value.NullValueProvider;
import com.finture.bpm.engine.impl.core.variable.mapping.value.ParameterValueProvider;
import com.finture.bpm.engine.impl.dmn.result.DecisionResultMapper;
import com.finture.bpm.engine.impl.el.ElValueProvider;
import com.finture.bpm.engine.impl.el.Expression;
import com.finture.bpm.engine.impl.el.ExpressionManager;
import com.finture.bpm.engine.impl.el.FixedValue;
import com.finture.bpm.engine.impl.el.UelExpressionCondition;
import com.finture.bpm.engine.impl.event.EventType;
import com.finture.bpm.engine.impl.form.FormDefinition;
import com.finture.bpm.engine.impl.form.handler.DefaultStartFormHandler;
import com.finture.bpm.engine.impl.form.handler.DefaultTaskFormHandler;
import com.finture.bpm.engine.impl.form.handler.DelegateStartFormHandler;
import com.finture.bpm.engine.impl.form.handler.DelegateTaskFormHandler;
...
import com.finture.bpm.engine.impl.jobexecutor.AsyncAfterMessageJobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.AsyncBeforeMessageJobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.EventSubscriptionJobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.JobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.MessageJobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.TimerCatchIntermediateEventJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerDeclarationImpl;
import com.finture.bpm.engine.impl.jobexecutor.TimerDeclarationType;
import com.finture.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
...
import com.finture.bpm.engine.impl.pvm.PvmTransition;
import com.finture.bpm.engine.impl.pvm.delegate.ActivityBehavior;
import com.finture.bpm.engine.impl.pvm.process.ActivityImpl;
import com.finture.bpm.engine.impl.pvm.process.ActivityStartBehavior;
import com.finture.bpm.engine.impl.pvm.process.HasDIBounds;
import com.finture.bpm.engine.impl.pvm.process.Lane;
import com.finture.bpm.engine.impl.pvm.process.LaneSet;
import com.finture.bpm.engine.impl.pvm.process.ParticipantProcess;
import com.finture.bpm.engine.impl.pvm.process.ProcessDefinitionImpl;
import com.finture.bpm.engine.impl.pvm.process.ScopeImpl;
import com.finture.bpm.engine.impl.pvm.process.TransitionImpl;
import com.finture.bpm.engine.impl.pvm.runtime.LegacyBehavior;
import com.finture.bpm.engine.impl.scripting.ExecutableScript;
import com.finture.bpm.engine.impl.scripting.ScriptCondition;
...
import com.finture.bpm.engine.impl.task.listener.ClassDelegateTaskListener;
import com.finture.bpm.engine.impl.task.listener.DelegateExpressionTaskListener;
import com.finture.bpm.engine.impl.task.listener.ExpressionTaskListener;
import com.finture.bpm.engine.impl.task.listener.ScriptTaskListener;
import com.finture.bpm.engine.impl.util.DecisionEvaluationUtil;
import com.finture.bpm.engine.impl.util.ReflectUtil;
import com.finture.bpm.engine.impl.util.ScriptUtil;
import com.finture.bpm.engine.impl.util.StringUtil;
import com.finture.bpm.engine.impl.util.xml.Element;
import com.finture.bpm.engine.impl.util.xml.Namespace;
import com.finture.bpm.engine.impl.util.xml.Parse;
import com.finture.bpm.engine.impl.variable.VariableDeclaration;
...
public class BpmnParse extends Parse {
  ...
  protected Map<String, com.finture.bpm.engine.impl.bpmn.parser.Error> errors = new HashMap<>();
   ...
   * definition.
   */
  protected Map<String, com.finture.bpm.engine.impl.bpmn.parser.MessageDefinition> messages = new HashMap<>();
  protected Map<String, com.finture.bpm.engine.impl.bpmn.parser.SignalDefinition> signals = new HashMap<>();

  // Members
  protected ExpressionManager expressionManager;
  protected List<com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener> parseListeners;
  ...
  protected void parseRootElement() {
    ...
    for (com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener parseListener : parseListeners) {
  ...
  protected XMLImporter getImporter(String importType, Element theImport) {
    if (this.importers.containsKey(importType)) {
      ...
      if (importType.equals("http://schemas.xmlsoap.org/wsdl/")) {
        ...
        try {
          wsdlImporterClass = Class.forName("com.finture.bpm.engine.impl.webservice.CxfWSDLImporter", true, Thread.currentThread().getContextClassLoader());
  ...
  public void parseMessages() {
    for (Element messageElement : rootElement.elements("message")) {
      ...
      com.finture.bpm.engine.impl.bpmn.parser.MessageDefinition messageDefinition = new com.finture.bpm.engine.impl.bpmn.parser.MessageDefinition(this.targetNamespace + ":" + id, messageExpression);
  ...
  protected void parseSignals() {
    for (Element signalElement : rootElement.elements("signal")) {
      ...
      for (com.finture.bpm.engine.impl.bpmn.parser.SignalDefinition signalDefinition : signals.values()) {
      ...
      if (id == null) {
        ...
        com.finture.bpm.engine.impl.bpmn.parser.SignalDefinition signal = new com.finture.bpm.engine.impl.bpmn.parser.SignalDefinition();
  ...
  public void parseErrors() {
    for (Element errorElement : rootElement.elements("error")) {
      com.finture.bpm.engine.impl.bpmn.parser.Error error = new com.finture.bpm.engine.impl.bpmn.parser.Error();
  ...
  protected void parseProcessDefinitionStartEvent(ActivityImpl startEventActivity, Element startEventElement, Element parentElement, ScopeImpl scope) {
    ...
    if (timerEventDefinition != null) {
      ...
      com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition conditionalEventDefinition = parseConditionalEventDefinition(conditionEventDefinition, startEventActivity);
  ...
  protected void parseScopeStartEvent(ActivityImpl startEventActivity, Element startEventElement, Element parentElement, ActivityImpl scopeActivity) {
    ...
    if (scopeActivity.isTriggeredByEvent()) {
      ...
      if (errorEventDefinition != null) {
        ...
        com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition escalationEventDefinition = createEscalationEventDefinitionForEscalationHandler(escalationEventDefinitionElement, scopeActivity, isInterrupting, startEventActivity.getId());
        ...
        final com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition conditionalEventDef = parseConditionalStartEventForEventSubprocess(conditionalEventDefinitionElement, startEventActivity, isInterrupting);
  ...
  protected void parseErrorStartEventDefinition(Element errorEventDefinition, ActivityImpl startEventActivity) {
    ...
    com.finture.bpm.engine.impl.bpmn.parser.Error error = null;
    ...
    com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition definition = new com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition(eventSubProcessActivity);
    if (errorRef != null) {
   ...
   */
  protected void setErrorCodeVariableOnErrorEventDefinition(Element errorEventDefinition, com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition definition) {
   ...
   */
  protected void setErrorMessageVariableOnErrorEventDefinition(Element errorEventDefinition, com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition definition) {
  ...
  protected void addEventSubscriptionDeclaration(EventSubscriptionDeclaration subscription, ScopeImpl scope, Element element) {
    ...
    if (subscription.isStartEvent() && hasMultipleConditionalEventDefinitionsWithSameCondition(subscription, eventDefinitions.values())) {
      addError("Cannot have more than one conditional event subscription with the same condition '" + ((com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition) subscription).getConditionAsString() + "'", element, subscription.getActivityId());
    }
    ...
    if (subscription.getEventType().equals(EventType.CONDITONAL.name())) {
      for (EventSubscriptionDeclaration eventDefinition : eventDefinitions) {
        if (eventDefinition.getEventType().equals(EventType.CONDITONAL.name()) && eventDefinition.isStartEvent() == subscription.isStartEvent()
            && ((com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition) eventDefinition).getConditionAsString().equals(((com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition) subscription).getConditionAsString())) {
          return true;
        }
      }
    }
  ...
  public ActivityImpl parseIntermediateCatchEvent(Element intermediateEventElement, ScopeImpl scopeElement, ActivityImpl eventBasedGateway) {
    ...
    if (timerEventDefinition != null) {
      ...
      com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition conditionalEvent = parseIntermediateConditionalEventDefinition(conditionalEventDefinitionElement, nestedActivity);
  ...
  protected void parseEmailServiceTask(ActivityImpl activity, Element serviceTaskElement, List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> fieldDeclarations) {
  ...
  protected void parseShellServiceTask(ActivityImpl activity, Element serviceTaskElement, List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> fieldDeclarations) {
  ...
  protected void validateFieldDeclarationsForEmail(Element serviceTaskElement, List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> fieldDeclarations) {
    boolean toDefined = false;
    boolean textOrHtmlDefined = false;
    for (com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration fieldDeclaration : fieldDeclarations) {
  ...
  protected void validateFieldDeclarationsForShell(Element serviceTaskElement, List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> fieldDeclarations) {
  ...
  public List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> parseFieldDeclarations(Element element) {
    List<com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration> fieldDeclarations = new ArrayList<>();
    ...
    if (fieldDeclarationElements != null && !fieldDeclarationElements.isEmpty()) {
      ...
      for (Element fieldDeclarationElement : fieldDeclarationElements) {
        com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration fieldDeclaration = parseFieldDeclaration(element, fieldDeclarationElement);
  ...
  protected com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration parseFieldDeclaration(Element serviceTaskElement, Element fieldDeclarationElement) {
    String fieldName = fieldDeclarationElement.attribute("name");

    com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration fieldDeclaration = parseStringFieldDeclaration(fieldDeclarationElement, serviceTaskElement, fieldName);
    if (fieldDeclaration == null) {
  ...
  protected com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration parseStringFieldDeclaration(Element fieldDeclarationElement, Element serviceTaskElement, String fieldName) {
    try {
      ...
      if (fieldValue != null) {
        return new com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration(fieldName, Expression.class.getName(), new FixedValue(fieldValue));
      }
  ...
  protected com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration parseExpressionFieldDeclaration(Element fieldDeclarationElement, Element serviceTaskElement, String fieldName) {
    try {
    ...
    for (Element endEventElement : parentElement.elements("endEvent")) {
      ...
      if (errorEventDefinition != null) { // error end event
        ...
        if (errorRef == null || "".equals(errorRef)) {
          ...
          com.finture.bpm.engine.impl.bpmn.parser.Error error = errors.get(errorRef);
  ...
  public void parseBoundaryErrorEventDefinition(Element errorEventDefinition, ActivityImpl boundaryEventActivity) {
    ...
    String errorRef = errorEventDefinition.attribute("errorRef");
    Error error = null;
    com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition definition = new com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition(boundaryEventActivity.getId());
    if (errorRef != null) {
      error = errors.get(errorRef);
      definition.setErrorCode(error == null ? errorRef : error.getErrorCode());
    }
  ...
  protected void addErrorEventDefinition(com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition errorEventDefinition, ScopeImpl catchingScope) {
    catchingScope.getProperties().addListItem(BpmnProperties.ERROR_EVENT_DEFINITIONS, errorEventDefinition);

    List<com.finture.bpm.engine.impl.bpmn.parser.ErrorEventDefinition> errorEventDefinitions = catchingScope.getProperties().get(BpmnProperties.ERROR_EVENT_DEFINITIONS);
  ...
  protected void parseBoundaryEscalationEventDefinition(Element escalationEventDefinitionElement, boolean cancelActivity, ActivityImpl boundaryEventActivity) {
    ...
    com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition escalationEventDefinition = createEscalationEventDefinitionForEscalationHandler(escalationEventDefinitionElement, boundaryEventActivity, cancelActivity, boundaryEventActivity.getId());
  ...
  protected com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition createEscalationEventDefinitionForEscalationHandler(Element escalationEventDefinitionElement, ActivityImpl escalationHandler, boolean cancelActivity, String parentElementId) {
    com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition escalationEventDefinition = new com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition(escalationHandler, cancelActivity);
  ...
  protected void addEscalationEventDefinition(ScopeImpl catchingScope, com.finture.bpm.engine.impl.bpmn.parser.EscalationEventDefinition escalationEventDefinition, Element element, String escalationElementId) {
  ...
  public BoundaryConditionalEventActivityBehavior parseBoundaryConditionalEventDefinition(Element element, boolean interrupting, ActivityImpl conditionalActivity) {
    ...
    com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition conditionalEventDefinition = parseConditionalEventDefinition(element, conditionalActivity);
   ...
   */
  public com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition parseIntermediateConditionalEventDefinition(Element element, ActivityImpl conditionalActivity) {
   ...
   * @return
   */
  public com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition parseConditionalStartEventForEventSubprocess(Element element, ActivityImpl conditionalActivity, boolean interrupting) {
   ...
   */
  protected com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition parseConditionalEventDefinition(Element element, ActivityImpl conditionalActivity) {
    com.finture.bpm.engine.impl.bpmn.parser.ConditionalEventDefinition conditionalEventDefinition = null;
