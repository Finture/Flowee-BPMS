...
public class DbUserQueryImpl extends UserQueryImpl {
  ...
  public long executeCount(CommandContext commandContext) {
    checkQueryOk();
    final com.finture.bpm.engine.impl.identity.db.DbReadOnlyIdentityServiceProvider identityProvider = getIdentityProvider(commandContext);
  ...
  private com.finture.bpm.engine.impl.identity.db.DbReadOnlyIdentityServiceProvider getIdentityProvider(CommandContext commandContext) {
