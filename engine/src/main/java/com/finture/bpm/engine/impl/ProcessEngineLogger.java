...
import java.net.URL;
import com.finture.bpm.application.impl.ProcessApplicationLogger;
...
import com.finture.bpm.engine.impl.bpmn.parser.BpmnParseLogger;
import com.finture.bpm.engine.impl.cfg.ConfigurationLogger;
import com.finture.bpm.engine.impl.cfg.TransactionLogger;
import com.finture.bpm.engine.impl.cmd.CommandLogger;
import com.finture.bpm.engine.impl.cmmn.behavior.CmmnBehaviorLogger;
import com.finture.bpm.engine.impl.cmmn.operation.CmmnOperationLogger;
import com.finture.bpm.engine.impl.cmmn.transformer.CmmnTransformerLogger;
import com.finture.bpm.engine.impl.core.CoreLogger;
import com.finture.bpm.engine.impl.db.EnginePersistenceLogger;
import com.finture.bpm.engine.impl.digest.SecurityLogger;
import com.finture.bpm.engine.impl.dmn.DecisionLogger;
import com.finture.bpm.engine.impl.externaltask.ExternalTaskLogger;
import com.finture.bpm.engine.impl.identity.IndentityLogger;
import com.finture.bpm.engine.impl.incident.IncidentLogger;
import com.finture.bpm.engine.impl.interceptor.ContextLogger;
import com.finture.bpm.engine.impl.jobexecutor.JobExecutorLogger;
import com.finture.bpm.engine.impl.metrics.MetricsLogger;
import com.finture.bpm.engine.impl.migration.MigrationLogger;
import com.finture.bpm.engine.impl.persistence.entity.JobEntity;
import com.finture.bpm.engine.impl.plugin.AdministratorAuthorizationPluginLogger;
import com.finture.bpm.engine.impl.pvm.PvmLogger;
import com.finture.bpm.engine.impl.scripting.ScriptLogger;
import com.finture.bpm.engine.impl.test.TestLogger;
import com.finture.bpm.engine.impl.util.EngineUtilLogger;
import com.finture.commons.logging.BaseLogger;
