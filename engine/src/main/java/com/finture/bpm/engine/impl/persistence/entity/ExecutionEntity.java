...
import com.finture.bpm.engine.impl.bpmn.parser.EventSubscriptionDeclaration;
...
import com.finture.bpm.engine.impl.cfg.multitenancy.TenantIdProviderProcessInstanceContext;
...
import com.finture.bpm.engine.impl.core.operation.CoreAtomicOperation;
...
import com.finture.bpm.engine.impl.core.variable.scope.VariableCollectionProvider;
...
import com.finture.bpm.engine.impl.core.variable.scope.VariableListenerInvocationListener;
...
import com.finture.bpm.engine.impl.history.event.HistoryEventProcessor;
...
import com.finture.bpm.engine.impl.incident.IncidentContext;
import com.finture.bpm.engine.impl.incident.IncidentHandling;
import com.finture.bpm.engine.impl.interceptor.AtomicOperationInvocation;
...
import com.finture.bpm.engine.impl.persistence.entity.ExecutionEntityReferencer;
...
import com.finture.bpm.engine.impl.pvm.runtime.ActivityInstanceState;
import com.finture.bpm.engine.impl.pvm.runtime.AtomicOperation;
import com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl;
import com.finture.bpm.engine.impl.pvm.runtime.operation.PvmAtomicOperation;
import com.finture.bpm.engine.impl.tree.ExecutionTopDownWalker;
import com.finture.bpm.engine.impl.tree.TreeVisitor;
import com.finture.bpm.engine.impl.util.BitMaskUtil;
