 ...
 */
package com.finture.bpm.engine.impl.pvm.runtime;

import static com.finture.bpm.engine.impl.bpmn.helper.CompensationUtil.SIGNAL_COMPENSATION_DONE;
...
import com.finture.bpm.engine.impl.bpmn.behavior.BpmnBehaviorLogger;
...
import com.finture.bpm.engine.impl.cmd.GetActivityInstanceCmd;
import com.finture.bpm.engine.impl.jobexecutor.AsyncContinuationJobHandler;
import com.finture.bpm.engine.impl.persistence.entity.ActivityInstanceImpl;
import com.finture.bpm.engine.impl.persistence.entity.EventSubscriptionEntity;
import com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity;
import com.finture.bpm.engine.impl.persistence.entity.JobDefinitionEntity;
...
import com.finture.bpm.engine.impl.persistence.entity.VariableInstanceHistoryListener;
import com.finture.bpm.engine.impl.pvm.PvmActivity;
import com.finture.bpm.engine.impl.pvm.PvmScope;
...
import com.finture.bpm.engine.impl.pvm.delegate.CompositeActivityBehavior;
import com.finture.bpm.engine.impl.pvm.process.ActivityImpl;
import com.finture.bpm.engine.impl.pvm.process.ScopeImpl;
import com.finture.bpm.engine.impl.pvm.runtime.CompensationBehavior;
import com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl;
import com.finture.bpm.engine.impl.tree.ExecutionWalker;
import com.finture.bpm.engine.impl.tree.ReferenceWalker;
...
public class LegacyBehavior {
   ...
   *
   * This is an inverse operation to {@link #createConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl)}.
   *
   * See: javadoc of this class for note about concurrent scopes.
   *
   * @param execution
   */
  public static void pruneConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
   ...
   */
  public static void cancelConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution, PvmActivity cancelledScopeActivity) {
    ensureConcurrentScope(execution);
   ...
   */
  public static void destroyConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    ensureConcurrentScope(execution);
   ...
   */
  public static boolean destroySecondNonScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
  ...
  protected static boolean isLegacyBehaviorRequired(ActivityExecution scopeExecution) {
    ...
    Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> activityExecutionMapping = scopeExecution.createActivityExecutionMapping();
   ...
   * @return
   */
  public static com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl getScopeExecution(ScopeImpl scope, Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> activityExecutionMapping) {
  ...
  protected static void ensureConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    ensureScope(execution);
    ensureConcurrent(execution);
  }

  protected static void ensureConcurrent(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    if(!execution.isConcurrent()) {
      throw new ProcessEngineException("Execution must be concurrent.");
    }
  }

  protected static void ensureScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
   ...
   * @return
   */
  public static Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> createActivityExecutionMapping(List<com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> scopeExecutions, List<ScopeImpl> scopes) {
    com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl deepestExecution = scopeExecutions.get(0);
    ...
    Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> mapping  = new HashMap<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl>();
    ...
    for(int i = 1; i < scopes.size(); i++) {
      ...
      com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl scopeExecutionCandidate = null;
      ...
      com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution = scopeExecutions.get(executionCounter);
   ...
   */
  protected static boolean wasNoScope(ActivityImpl activity, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl scopeExecutionCandidate) {
  ...
  protected static boolean wasNoScope73(ActivityImpl activity, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl scopeExecutionCandidate) {
    ActivityBehavior activityBehavior = activity.getActivityBehavior();
  ...
  protected static boolean isMultiInstanceInCompensation(ActivityImpl activity, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl scopeExecutionCandidate) {
    return
   ...
   */
  protected static boolean isLegacyAsyncAtMultiInstance(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
   ...
   *
   */
  public static com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl determinePropagatingExecutionOnEnd(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl propagatingExecution, Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> activityExecutionMapping) {
    if (!propagatingExecution.isScope()) {
      ...
      if (activityExecutionMapping.values().contains(propagatingExecution)) {
        ...
        com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl parent = propagatingExecution.getParent();
   ...
   */
  public static boolean isConcurrentScope(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl propagatingExecution) {
   ...
   */
  public static void removeLegacyNonScopesFromMapping(Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> mapping) {
    Map<com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl, List<ScopeImpl>> scopesForExecutions = new HashMap<com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl, List<ScopeImpl>>();

    for (Map.Entry<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> mappingEntry : mapping.entrySet()) {
    ...
    for (Map.Entry<com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl, List<ScopeImpl>> scopesForExecution : scopesForExecutions.entrySet()) {
   ...
   */
  public static boolean hasInvalidIntermediaryActivityId(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    return !execution.getNonEventScopeExecutions().isEmpty() && !com.finture.bpm.engine.impl.pvm.runtime.CompensationBehavior.isCompensationThrowing(execution);
  }
   ...
   */
  public static boolean isCompensationThrowing(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution, Map<ScopeImpl, com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl> activityExecutionMapping) {
    if (com.finture.bpm.engine.impl.pvm.runtime.CompensationBehavior.isCompensationThrowing(execution)) {
  ...
  public static boolean isCompensationThrowing(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    return isCompensationThrowing(execution, execution.createActivityExecutionMapping());
  }

  protected static com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl findCompensationThrowingAncestorExecution(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl execution) {
    ExecutionWalker walker = new ExecutionWalker(execution);
    walker.walkUntil(new ReferenceWalker.WalkCondition<com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl>() {
      public boolean isFulfilled(com.finture.bpm.engine.impl.pvm.runtime.PvmExecutionImpl element) {
