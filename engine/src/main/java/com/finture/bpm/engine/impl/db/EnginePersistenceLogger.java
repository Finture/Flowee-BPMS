...
import com.finture.bpm.engine.WrongDbException;
...
import com.finture.bpm.engine.impl.util.ClassNameUtil;
...
public class EnginePersistenceLogger extends ProcessEngineLogger {
  ...
  public <T extends com.finture.bpm.engine.impl.db.DbEntity> ProcessEngineException entityCacheLookupException(Class<T> type, String id,
                                                                                                               Class<? extends com.finture.bpm.engine.impl.db.DbEntity> entity, Throwable cause) {
  ...
  public ProcessEngineException entityCacheDuplicateEntryException(String currentState, String id,
                                                                   Class<? extends com.finture.bpm.engine.impl.db.DbEntity> entityClass, DbEntityState foundState) {
    return new ProcessEngineException(exceptionMessage(
      "002",
  ...
  public ProcessEngineException alreadyMarkedEntityInEntityCacheException(String id,
                                                                          Class<? extends com.finture.bpm.engine.impl.db.DbEntity> entityClass, DbEntityState state) {
  ...
  public ProcessEngineException mergeDbEntityException(com.finture.bpm.engine.impl.db.DbEntity entity) {
  ...
  public void executeDatabaseOperation(String operationType, Object parameter) {
    if(isDebugEnabled()) {
      ...
      if(parameter instanceof com.finture.bpm.engine.impl.db.DbEntity) {
        com.finture.bpm.engine.impl.db.DbEntity dbEntity = (DbEntity) parameter;
