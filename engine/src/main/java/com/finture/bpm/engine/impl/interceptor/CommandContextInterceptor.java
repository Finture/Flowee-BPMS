...
import com.finture.bpm.engine.impl.context.ProcessEngineContextImpl;
...
/**
 * <p>Interceptor used for opening the {@link CommandContext} and {@link com.finture.bpm.engine.impl.interceptor.CommandInvocationContext}.</p>
 *
...
public class CommandContextInterceptor extends CommandInterceptor {
  ...
  public <T> T execute(Command<T> command) {
    ...
    com.finture.bpm.engine.impl.interceptor.CommandInvocationContext commandInvocationContext = new CommandInvocationContext(command, processEngineConfiguration, isOuterCommand);
