...
import com.finture.bpm.engine.query.Report;
...
public interface HistoricTaskInstanceReport extends Report {
  ...
  /**
   * <p>Executes the task report query and returns a list of {@link com.finture.bpm.engine.history.HistoricTaskInstanceReportResult}s</p>
   *
   * @throws AuthorizationException
   *          If the user has no {@link Permissions#READ_HISTORY} permission
   *          on any {@link Resources#PROCESS_DEFINITION}.
   *
   * @return a list of {@link com.finture.bpm.engine.history.HistoricTaskInstanceReportResult}s
   */
  List<com.finture.bpm.engine.history.HistoricTaskInstanceReportResult> countByProcessDefinitionKey();
