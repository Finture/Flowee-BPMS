...
import com.finture.bpm.engine.ProcessEngineInfo;
import com.finture.bpm.engine.impl.ProcessEngineInfoImpl;
 ...
 * (<code>com.finture.bpm.engine.test.impl.servlet.listener.ProcessEnginesServletContextListener</code>).  That way,
...
public abstract class ProcessEngines {
  ...
  protected static Map<String, com.finture.bpm.engine.ProcessEngineInfo> processEngineInfosByName = new HashMap<String, com.finture.bpm.engine.ProcessEngineInfo>();
  protected static Map<String, com.finture.bpm.engine.ProcessEngineInfo> processEngineInfosByResourceUrl = new HashMap<String, com.finture.bpm.engine.ProcessEngineInfo>();
  protected static List<com.finture.bpm.engine.ProcessEngineInfo> processEngineInfos = new ArrayList<com.finture.bpm.engine.ProcessEngineInfo>();
  ...
  protected static void initProcessEngineFromSpringResource(URL resource) {
    try {
      Class< ? > springConfigurationHelperClass = ReflectUtil.loadClass("com.finture.bpm.engine.spring.SpringConfigurationHelper");
      Method method = springConfigurationHelperClass.getMethod("buildProcessEngine", new Class<?>[]{URL.class});
      ProcessEngine processEngine = (ProcessEngine) method.invoke(null, new Object[]{resource});

      String processEngineName = processEngine.getName();
      com.finture.bpm.engine.ProcessEngineInfo processEngineInfo = new ProcessEngineInfoImpl(processEngineName, resource.toString(), null);
  ...
  /**
   * Registers the given process engine. No {@link com.finture.bpm.engine.ProcessEngineInfo} will be
  ...
  private static com.finture.bpm.engine.ProcessEngineInfo initProcessEngineFromResource(URL resourceUrl) {
    com.finture.bpm.engine.ProcessEngineInfo processEngineInfo = processEngineInfosByResourceUrl.get(resourceUrl);
  ...
  public static List<com.finture.bpm.engine.ProcessEngineInfo> getProcessEngineInfos() {
    return processEngineInfos;
  }

  /** Get initialization results. Only info will we available for process engines
   * which were added in the {@link ProcessEngines#init()}. No {@link com.finture.bpm.engine.ProcessEngineInfo}
   * is available for engines which were registered programatically.
  */
  public static com.finture.bpm.engine.ProcessEngineInfo getProcessEngineInfo(String processEngineName) {
