 ...
 */
package com.finture.bpm.engine.impl.batch;
...
import com.finture.bpm.engine.impl.batch.BatchMonitorJobDeclaration;
import com.finture.bpm.engine.impl.batch.BatchSeedJobDeclaration;
...
import com.finture.bpm.engine.impl.persistence.entity.Nameable;
...
public class BatchEntity implements Batch, DbEntity, HasDbReferences, Nameable, HasDbRevision {
  ...
  public static final com.finture.bpm.engine.impl.batch.BatchSeedJobDeclaration BATCH_SEED_JOB_DECLARATION = new BatchSeedJobDeclaration();
  public static final com.finture.bpm.engine.impl.batch.BatchMonitorJobDeclaration BATCH_MONITOR_JOB_DECLARATION = new BatchMonitorJobDeclaration();
  ...
  protected com.finture.bpm.engine.impl.batch.BatchJobHandler<?> batchJobHandler;
