...
import static com.finture.bpm.engine.authorization.Permissions.READ_HISTORY;
import static com.finture.bpm.engine.authorization.Permissions.READ_INSTANCE;
import static com.finture.bpm.engine.authorization.Permissions.READ_TASK;
import static com.finture.bpm.engine.authorization.Permissions.UPDATE;
import static com.finture.bpm.engine.authorization.Permissions.UPDATE_INSTANCE;
import static com.finture.bpm.engine.authorization.ProcessDefinitionPermissions.READ_INSTANCE_VARIABLE;
import static com.finture.bpm.engine.authorization.Resources.AUTHORIZATION;
import static com.finture.bpm.engine.authorization.Resources.BATCH;
import static com.finture.bpm.engine.authorization.Resources.DECISION_DEFINITION;
import static com.finture.bpm.engine.authorization.Resources.DECISION_REQUIREMENTS_DEFINITION;
import static com.finture.bpm.engine.authorization.Resources.DEPLOYMENT;
import static com.finture.bpm.engine.authorization.Resources.HISTORIC_PROCESS_INSTANCE;
import static com.finture.bpm.engine.authorization.Resources.HISTORIC_TASK;
import static com.finture.bpm.engine.authorization.Resources.PROCESS_DEFINITION;
import static com.finture.bpm.engine.authorization.Resources.PROCESS_INSTANCE;
import static com.finture.bpm.engine.authorization.Resources.TASK;
import static com.finture.bpm.engine.authorization.TaskPermissions.READ_VARIABLE;
...
import com.finture.bpm.engine.authorization.HistoricProcessInstancePermissions;
import com.finture.bpm.engine.authorization.HistoricTaskPermissions;
import com.finture.bpm.engine.authorization.MissingAuthorization;
...
import com.finture.bpm.engine.impl.ActivityStatisticsQueryImpl;
import com.finture.bpm.engine.impl.AuthorizationQueryImpl;
import com.finture.bpm.engine.impl.DeploymentQueryImpl;
import com.finture.bpm.engine.impl.DeploymentStatisticsQueryImpl;
import com.finture.bpm.engine.impl.EventSubscriptionQueryImpl;
import com.finture.bpm.engine.impl.ExternalTaskQueryImpl;
import com.finture.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import com.finture.bpm.engine.impl.HistoricDecisionInstanceQueryImpl;
import com.finture.bpm.engine.impl.HistoricDetailQueryImpl;
import com.finture.bpm.engine.impl.HistoricExternalTaskLogQueryImpl;
...
import com.finture.bpm.engine.impl.HistoricJobLogQueryImpl;
import com.finture.bpm.engine.impl.HistoricProcessInstanceQueryImpl;
...
import com.finture.bpm.engine.impl.IncidentQueryImpl;
import com.finture.bpm.engine.impl.JobDefinitionQueryImpl;
import com.finture.bpm.engine.impl.JobQueryImpl;
import com.finture.bpm.engine.impl.ProcessDefinitionQueryImpl;
import com.finture.bpm.engine.impl.ProcessDefinitionStatisticsQueryImpl;
...
import com.finture.bpm.engine.impl.VariableInstanceQueryImpl;
import com.finture.bpm.engine.impl.batch.BatchQueryImpl;
import com.finture.bpm.engine.impl.batch.BatchStatisticsQueryImpl;
...
import com.finture.bpm.engine.impl.db.AuthorizationCheck;
import com.finture.bpm.engine.impl.db.CompositePermissionCheck;
import com.finture.bpm.engine.impl.db.DbEntity;
...
import com.finture.bpm.engine.impl.db.PermissionCheckBuilder;
...
import com.finture.bpm.engine.impl.persistence.entity.util.AuthManagerUtil;
import com.finture.bpm.engine.impl.persistence.entity.util.AuthManagerUtil.VariablePermissions;
import com.finture.bpm.engine.impl.util.ResourceTypeUtil;
...
public class AuthorizationManager extends AbstractManager {
  ...
  public Authorization createNewAuthorization(int type) {
    ...
    return new com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity(type);
  }
  ...
  public com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity findAuthorizationByUserIdAndResourceId(int type, String userId, Resource resource, String resourceId) {
    return findAuthorization(type, userId, null, resource, resourceId);
  }

  public com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity findAuthorizationByGroupIdAndResourceId(int type, String groupId, Resource resource, String resourceId) {
    return findAuthorization(type, null, groupId, resource, resourceId);
  }

  public com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity findAuthorization(int type, String userId, String groupId, Resource resource, String resourceId) {
    ...
    return (com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity) getDbEntityManager().selectOne("selectAuthorizationByParameters", params);
  }

  public void update(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity authorization) {
  ...
  public void validateResourceCompatibility(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity authorization) {
  ...
  public void deleteAuthorizationsByResourceId(Resource resource, String resourceId) {
    ...
    if(isAuthorizationEnabled()) {
      ...
      getDbEntityManager().delete(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity.class, "deleteAuthorizationsForResourceId", deleteParams);
    }
  ...
  public void deleteAuthorizationsByResourceIdAndUserId(Resource resource, String resourceId, String userId) {
    ...
    if(isAuthorizationEnabled()) {
      ...
      getDbEntityManager().delete(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity.class, "deleteAuthorizationsForResourceIdAndUserId", deleteParams);
    }
  ...
  public void deleteAuthorizationsByResourceIdAndGroupId(Resource resource, String resourceId, String groupId) {
    ...
    if(isAuthorizationEnabled()) {
      ...
      getDbEntityManager().delete(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity.class, "deleteAuthorizationsForResourceIdAndGroupId", deleteParams);
    }
  ...
  public DbOperation addRemovalTimeToAuthorizationsByRootProcessInstanceId(String rootProcessInstanceId,
    ...
    return getDbEntityManager()
        .updatePreserveOrder(com.finture.bpm.engine.impl.persistence.entity.AuthorizationEntity.class,
