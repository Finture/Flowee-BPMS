...
import com.finture.bpm.engine.impl.Validator;
...
public class QueryValidators {
  ...
  public static class AdhocQueryValidator<T extends com.finture.bpm.engine.impl.AbstractQuery<?, ?>> implements com.finture.bpm.engine.impl.Validator<T> {
    ...
    public static <T extends com.finture.bpm.engine.impl.AbstractQuery<?, ?>> AdhocQueryValidator<T> get() {
      return (AdhocQueryValidator<T>) INSTANCE;
    }

  }

  public static class StoredQueryValidator<T extends com.finture.bpm.engine.impl.AbstractQuery<?, ?>> implements Validator<T> {
