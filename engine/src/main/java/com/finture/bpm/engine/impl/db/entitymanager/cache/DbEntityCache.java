 ...
 */
package com.finture.bpm.engine.impl.db.entitymanager.cache;
...
public class DbEntityCache {
  ...
  /**
   * Put a new, {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#TRANSIENT} object into the cache.
   *
  ...
  /**
   * Put a {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#PERSISTENT} object into the cache.
   *
   * @param e the object to put into the cache
   */
  ...
  /**
   * Put a {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#MERGED} object into the cache.
   *
   * @param e the object to put into the cache
   */
  ...
  /**
   * Allows checking whether the provided entity is present in the cache
   * and is {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#PERSISTENT}.
   *
   * @param dbEntity the entity to check
   * @return true if the provided entity is present in the cache and is
   * {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#PERSISTENT}.
   */
  ...
  /**
   * Allows checking whether the provided entity is present in the cache
   * and is {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#TRANSIENT}.
   *
   * @param dbEntity the entity to check
   * @return true if the provided entity is present in the cache and is
   * {@link com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState#TRANSIENT}.
   */
  ...
  public void undoDelete(DbEntity dbEntity) {
    CachedDbEntity cachedEntity = getCachedEntity(dbEntity);
    if (cachedEntity.getEntityState() == com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT) {
      cachedEntity.setEntityState(com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT);
    }
    else {
