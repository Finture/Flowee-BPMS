 ...
 * through the
 * {@link com.finture.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl#setDeploymentHandlerFactory(DeploymentHandlerFactory)}
 * method.</p>
 *
 * <p>See {@link com.finture.bpm.engine.impl.repository.DefaultDeploymentHandler} for the default
...
public interface DeploymentHandler {
   ...
   * {@link com.finture.bpm.engine.impl.repository.DefaultDeploymentHandler#shouldDeployResource(Resource, Resource)}.</p>
   *
   ...
   * {@link com.finture.bpm.engine.impl.jobexecutor.JobExecutor} and registered with the newly
