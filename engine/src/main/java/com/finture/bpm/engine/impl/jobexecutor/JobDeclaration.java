...
public abstract class JobDeclaration<S, T extends JobEntity> implements Serializable {
  ...
  protected com.finture.bpm.engine.impl.jobexecutor.JobHandlerConfiguration jobHandlerConfiguration;
  ...
  protected com.finture.bpm.engine.impl.jobexecutor.JobHandler resolveJobHandler() {
