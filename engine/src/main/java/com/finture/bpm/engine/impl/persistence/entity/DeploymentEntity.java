...
public class DeploymentEntity implements Serializable, DeploymentWithDefinitions, DbEntity {
  ...
  protected Map<String, com.finture.bpm.engine.impl.persistence.entity.ResourceEntity> resources;
  ...
  public com.finture.bpm.engine.impl.persistence.entity.ResourceEntity getResource(String resourceName) {
    return getResources().get(resourceName);
  }

  public void addResource(com.finture.bpm.engine.impl.persistence.entity.ResourceEntity resource) {
    if (resources==null) {
  ...
  // lazy loading /////////////////////////////////////////////////////////////
  public Map<String, com.finture.bpm.engine.impl.persistence.entity.ResourceEntity> getResources() {
    if (resources==null && id!=null) {
      List<com.finture.bpm.engine.impl.persistence.entity.ResourceEntity> resourcesList = Context
        .getCommandContext()
        .getResourceManager()
        .findResourcesByDeploymentId(id);
      resources = new HashMap<>();
      for (com.finture.bpm.engine.impl.persistence.entity.ResourceEntity resource: resourcesList) {
        resources.put(resource.getName(), resource);
      }
    }
    return resources;
