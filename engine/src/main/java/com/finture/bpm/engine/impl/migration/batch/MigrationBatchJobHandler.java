...
import com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration;
 ...
 */
public class MigrationBatchJobHandler extends AbstractBatchJobHandler<com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration> {
  ...
  @Override
  protected com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration createJobConfiguration(com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration configuration, List<String> processIdsForJob) {
    return new com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration(
        processIdsForJob,
  ...
  @Override
  protected void postProcessJob(com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration configuration, JobEntity job, com.finture.bpm.engine.impl.migration.batch.MigrationBatchConfiguration jobConfiguration) {
