...
public class AttachmentManager extends AbstractHistoricManager {
  ...
  public DbOperation addRemovalTimeToAttachmentsByRootProcessInstanceId(String rootProcessInstanceId, Date removalTime, Integer batchSize) {
    ...
    return getDbEntityManager()
      .updatePreserveOrder(com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity.class, "updateAttachmentsByRootProcessInstanceId", parameters);
  }
  ...
  public DbOperation addRemovalTimeToAttachmentsByProcessInstanceId(String processInstanceId, Date removalTime, Integer batchSize) {
    ...
    return getDbEntityManager()
      .updatePreserveOrder(com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity.class, "updateAttachmentsByProcessInstanceId", parameters);
  ...
  public void deleteAttachmentsByTaskId(String taskId) {
    checkHistoryEnabled();
    List<com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity> attachments = getDbEntityManager().selectList("selectAttachmentsByTaskId", taskId);
    for (com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity attachment: attachments) {
  ...
  protected void deleteAttachments(Map<String, Object> parameters) {
    ...
    getDbEntityManager().deletePreserveOrder(com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity.class, "deleteAttachmentByIds", parameters);
  }
  ...
  public Attachment findAttachmentByTaskIdAndAttachmentId(String taskId, String attachmentId) {
    ...
    return (com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity) getDbEntityManager().selectOne("selectAttachmentByTaskIdAndAttachmentId", parameters);
  }
