 ...
 */
package com.finture.bpm.engine.impl.application;
...
import com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration;
...
public class ProcessApplicationManager {
  ...
  protected Map<String, com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration> registrationsByDeploymentId = new HashMap<String, com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration>();

  public ProcessApplicationReference getProcessApplicationForDeployment(String deploymentId) {
    com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration registration = registrationsByDeploymentId.get(deploymentId);
  ...
  public synchronized ProcessApplicationRegistration registerProcessApplicationForDeployments(Set<String> deploymentsToRegister, ProcessApplicationReference reference) {
    ...
    com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration registration = createProcessApplicationRegistration(deploymentsToRegister, reference);
  ...
  protected com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration createProcessApplicationRegistration(Set<String> deploymentsToRegister, ProcessApplicationReference reference) {
    final String processEngineName = Context.getProcessEngineConfiguration().getProcessEngineName();

    com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration registration = new com.finture.bpm.engine.impl.application.DefaultProcessApplicationRegistration(reference, deploymentsToRegister, processEngineName);
