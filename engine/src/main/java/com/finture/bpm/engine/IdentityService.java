...
public interface IdentityService {
   ...
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#USER}.
   */
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when {@link com.finture.bpm.engine.ProcessEngineConfiguration#enablePasswordPolicy}
   *                                is {@code true} and password violates password policy
   * @throws com.finture.bpm.engine.ProcessEngineException when user id violates:
   *         <ul>
   *           <li>{@link com.finture.bpm.engine.ProcessEngineConfiguration#generalResourceWhitelistPattern} OR</li>
   *           <li>{@link com.finture.bpm.engine.ProcessEngineConfiguration#userResourceWhitelistPattern}</li>
   *         </ul>
   * @throws RuntimeException when a user with the same name already exists.
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#UPDATE} permissions on {@link Resources#USER} (update existing user)
   ...
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#DELETE} permissions on {@link Resources#USER}.
   */
   ...
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#GROUP}.
   */
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when group id violates:
   *         <ul>
   *           <li>{@link com.finture.bpm.engine.ProcessEngineConfiguration#generalResourceWhitelistPattern} OR</li>
   *           <li>{@link com.finture.bpm.engine.ProcessEngineConfiguration#groupResourceWhitelistPattern}</li>
   *         </ul>
   * @throws RuntimeException when a group with the same name already exists.
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#UPDATE} permissions on {@link Resources#GROUP} (update existing group)
   ...
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#DELETE} permissions on {@link Resources#GROUP}.
   */
   ...
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#GROUP_MEMBERSHIP}.
   */
   ...
   * @throws UnsupportedOperationException if identity service implementation is read only. See {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#DELETE} permissions on {@link Resources#GROUP_MEMBERSHIP}.
   */
   ...
   *           {@link #isReadOnly()}
   * @throws com.finture.bpm.engine.AuthorizationException
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when tenant id violates:
   *         <ul>
   *           <li>{@link com.finture.bpm.engine.ProcessEngineConfiguration#generalResourceWhitelistPattern} OR</li>
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException if the user doesn't exist.
