...
import com.finture.bpm.engine.impl.SchemaOperationProcessEngineClose;
...
import com.finture.bpm.engine.impl.util.CompositeCondition;
...
public class ProcessEngineImpl implements ProcessEngine {
  ...
  private final static com.finture.bpm.engine.impl.ProcessEngineLogger LOG = ProcessEngineLogger.INSTANCE;
  ...
  public void close() {
    ...
    commandExecutorSchemaOperations.execute(new com.finture.bpm.engine.impl.SchemaOperationProcessEngineClose());
