...
import com.finture.bpm.engine.impl.cmd.UnlockJobCmd;
...
public class ExecuteJobsRunnable implements Runnable {
  ...
  public void run() {
    final com.finture.bpm.engine.impl.jobexecutor.JobExecutorContext jobExecutorContext = new JobExecutorContext();
   ...
   * com.finture.bpm.container.impl.threading.ra.inflow.JcaInflowExecuteJobsRunnable.executeJob(String, CommandExecutor)
   */
   ...
   * com.finture.bpm.container.impl.threading.ra.inflow.JcaInflowExecuteJobsRunnable#switchClassLoader()
