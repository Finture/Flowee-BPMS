...
public interface BatchQueryProperty {
  ...
  QueryProperty ID = new com.finture.bpm.engine.impl.QueryPropertyImpl("ID_");

  QueryProperty TENANT_ID = new com.finture.bpm.engine.impl.QueryPropertyImpl("TENANT_ID_");
