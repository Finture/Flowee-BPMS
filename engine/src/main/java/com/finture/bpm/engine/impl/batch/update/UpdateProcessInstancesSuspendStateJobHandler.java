 ...
 */
package com.finture.bpm.engine.impl.batch.update;
...
import com.finture.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateBatchConfiguration;
import com.finture.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateBatchConfigurationJsonConverter;
import com.finture.bpm.engine.impl.cmd.UpdateProcessInstancesSuspendStateCmd;
...
public class UpdateProcessInstancesSuspendStateJobHandler extends AbstractBatchJobHandler<UpdateProcessInstancesSuspendStateBatchConfiguration> {
  ...
  protected com.finture.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateBatchConfigurationJsonConverter getJsonConverterInstance() {
