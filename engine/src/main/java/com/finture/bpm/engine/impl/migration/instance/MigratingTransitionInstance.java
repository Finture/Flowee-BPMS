...
import com.finture.bpm.engine.impl.migration.instance.*;
 ...
 *
 */
public class MigratingTransitionInstance extends MigratingProcessElementInstance implements com.finture.bpm.engine.impl.migration.instance.MigratingInstance {
  ...
  public void detachState() {
    ...
    for (com.finture.bpm.engine.impl.migration.instance.MigratingInstance dependentInstance : migratingDependentInstances) {
  ...
  public void addMigratingDependentInstance(com.finture.bpm.engine.impl.migration.instance.MigratingInstance migratingInstance) {
    migratingDependentInstances.add(migratingInstance);
  }

  public List<com.finture.bpm.engine.impl.migration.instance.MigratingInstance> getMigratingDependentInstances() {
