 ...
 */
package com.finture.bpm.engine.impl.variable.serializer;
 ...
 * {@link ValueType} to provided {@link com.finture.bpm.engine.impl.variable.serializer.ValueFields}.
 *<p>
...
public interface TypedValueSerializer<T extends TypedValue> {
  ...
  /**
   * Serialize a {@link TypedValue} to the {@link com.finture.bpm.engine.impl.variable.serializer.ValueFields}.
   *
   * @param value the {@link TypedValue} to persist
   * @param valueFields the {@link com.finture.bpm.engine.impl.variable.serializer.ValueFields} to which the value should be persisted
   */
  void writeValue(T value, com.finture.bpm.engine.impl.variable.serializer.ValueFields valueFields);

  /**
   * Retrieve a {@link TypedValue} from the provided {@link com.finture.bpm.engine.impl.variable.serializer.ValueFields}.
   *
   * @param valueFields the {@link com.finture.bpm.engine.impl.variable.serializer.ValueFields} to retrieve the value from
