...
public abstract class AbstractProcessEngineTestCase extends PvmTestCase {
  ...
  public void runBare() throws Throwable {
    ...
    try {
      ...
      boolean hasRequiredHistoryLevel = com.finture.bpm.engine.impl.test.TestHelper.annotationRequiredHistoryLevelCheck(processEngine, getClass(), getName());
      boolean runsWithRequiredDatabase = com.finture.bpm.engine.impl.test.TestHelper.annotationRequiredDatabaseCheck(processEngine, getClass(), getName());
      ...
      if (hasRequiredHistoryLevel && runsWithRequiredDatabase) {
        ...
        deploymentId = com.finture.bpm.engine.impl.test.TestHelper.annotationDeploymentSetUp(processEngine, getClass(), getName());
      ...
      com.finture.bpm.engine.impl.test.TestHelper.assertAndEnsureCleanDbAndCache(processEngine, exception == null);
      com.finture.bpm.engine.impl.test.TestHelper.resetIdGenerator(processEngineConfiguration);
      ClockUtil.reset();
