...
public interface CmmnTransformListener {
  ...
  /**
   * @deprecated use {@link #transformCasePlanModel(com.finture.bpm.model.cmmn.instance.CasePlanModel, CmmnActivity)}
   */
  @Deprecated
  void transformCasePlanModel(com.finture.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity);
