...
import com.finture.bpm.engine.impl.RestartProcessInstancesBatchConfiguration;
import com.finture.bpm.engine.impl.batch.AbstractBatchConfigurationObjectConverter;
import com.finture.bpm.engine.impl.batch.DeploymentMappingJsonConverter;
import com.finture.bpm.engine.impl.batch.DeploymentMappings;
import com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand;
import com.finture.bpm.engine.impl.json.ModificationCmdJsonConverter;
...
public class RestartProcessInstancesBatchConfigurationJsonConverter
    extends AbstractBatchConfigurationObjectConverter<com.finture.bpm.engine.impl.RestartProcessInstancesBatchConfiguration> {
  ...
  @Override
  public JsonObject writeConfiguration(com.finture.bpm.engine.impl.RestartProcessInstancesBatchConfiguration configuration) {
  ...
  @Override
  public com.finture.bpm.engine.impl.RestartProcessInstancesBatchConfiguration readConfiguration(JsonObject json) {
