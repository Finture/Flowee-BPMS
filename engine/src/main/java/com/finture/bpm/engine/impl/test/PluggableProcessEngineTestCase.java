...
import com.finture.bpm.engine.impl.test.AbstractProcessEngineTestCase;
 ...
 * on the test support classes that we offer as part of our api (in com.finture.bpm.engine.test).
 *
 * @author Tom Baeyens
 * @author Joram Barrez
 */
