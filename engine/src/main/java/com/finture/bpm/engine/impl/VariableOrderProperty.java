...
import com.finture.bpm.engine.impl.VariableInstanceQueryProperty;
 ...
 *
 */
public class VariableOrderProperty extends com.finture.bpm.engine.impl.QueryOrderingProperty {
  ...
  public VariableOrderProperty(String name, ValueType valueType) {
    ...
    this.relationConditions = new ArrayList<com.finture.bpm.engine.impl.QueryEntityRelationCondition>();
    relationConditions.add(new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.VARIABLE_NAME, name));

    // works only for primitive types
    relationConditions.add(new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.VARIABLE_TYPE, valueType.getName()));
  }
  ...
  public static VariableOrderProperty forProcessInstanceVariable(String variableName, ValueType valueType) {
    ...
    orderingProperty.relationConditions.add(
        new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.EXECUTION_ID, com.finture.bpm.engine.impl.TaskQueryProperty.PROCESS_INSTANCE_ID));
  ...
  public static VariableOrderProperty forExecutionVariable(String variableName, ValueType valueType) {
    VariableOrderProperty orderingProperty = new VariableOrderProperty(variableName, valueType);
    orderingProperty.relationConditions.add(
        new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.EXECUTION_ID, com.finture.bpm.engine.impl.TaskQueryProperty.EXECUTION_ID));
  ...
  public static VariableOrderProperty forTaskVariable(String variableName, ValueType valueType) {
    VariableOrderProperty orderingProperty = new VariableOrderProperty(variableName, valueType);
    orderingProperty.relationConditions.add(
        new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.TASK_ID, com.finture.bpm.engine.impl.TaskQueryProperty.TASK_ID));
  ...
  public static VariableOrderProperty forCaseInstanceVariable(String variableName, ValueType valueType) {
    VariableOrderProperty orderingProperty = new VariableOrderProperty(variableName, valueType);
    orderingProperty.relationConditions.add(
        new com.finture.bpm.engine.impl.QueryEntityRelationCondition(VariableInstanceQueryProperty.CASE_EXECUTION_ID, com.finture.bpm.engine.impl.TaskQueryProperty.CASE_INSTANCE_ID));
