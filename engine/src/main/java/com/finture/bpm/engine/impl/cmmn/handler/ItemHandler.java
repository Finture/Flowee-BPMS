 ...
 */
package com.finture.bpm.engine.impl.cmmn.handler;

import static com.finture.bpm.engine.delegate.CaseExecutionListener.COMPLETE;
import static com.finture.bpm.engine.delegate.CaseExecutionListener.TERMINATE;
...
import com.finture.bpm.engine.impl.bpmn.helper.CmmnProperties;
import com.finture.bpm.engine.impl.bpmn.parser.FieldDeclaration;
import com.finture.bpm.engine.impl.cmmn.CaseControlRule;
import com.finture.bpm.engine.impl.cmmn.behavior.CaseControlRuleImpl;
import com.finture.bpm.engine.impl.cmmn.behavior.CmmnActivityBehavior;
import com.finture.bpm.engine.impl.cmmn.listener.ClassDelegateCaseExecutionListener;
import com.finture.bpm.engine.impl.cmmn.listener.DelegateExpressionCaseExecutionListener;
import com.finture.bpm.engine.impl.cmmn.listener.ExpressionCaseExecutionListener;
import com.finture.bpm.engine.impl.cmmn.listener.ScriptCaseExecutionListener;
...
import com.finture.bpm.engine.impl.variable.listener.ClassDelegateCaseVariableListener;
import com.finture.bpm.engine.impl.variable.listener.DelegateExpressionCaseVariableListener;
import com.finture.bpm.engine.impl.variable.listener.ExpressionCaseVariableListener;
import com.finture.bpm.engine.impl.variable.listener.ScriptCaseVariableListener;
import com.finture.bpm.model.cmmn.Query;
import com.finture.bpm.model.cmmn.instance.CmmnElement;
import com.finture.bpm.model.cmmn.instance.ConditionExpression;
import com.finture.bpm.model.cmmn.instance.DiscretionaryItem;
import com.finture.bpm.model.cmmn.instance.Documentation;
import com.finture.bpm.model.cmmn.instance.ExtensionElements;
import com.finture.bpm.model.cmmn.instance.ManualActivationRule;
import com.finture.bpm.model.cmmn.instance.PlanItem;
import com.finture.bpm.model.cmmn.instance.PlanItemControl;
import com.finture.bpm.model.cmmn.instance.PlanItemDefinition;
import com.finture.bpm.model.cmmn.instance.RepetitionRule;
import com.finture.bpm.model.cmmn.instance.RequiredRule;
import com.finture.bpm.model.cmmn.instance.Sentry;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaCaseExecutionListener;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaExpression;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaField;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaScript;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaString;
import com.finture.bpm.model.cmmn.instance.camunda.CamundaVariableListener;
