...
import com.finture.bpm.engine.impl.cmd.AddCommentCmd;
import com.finture.bpm.engine.impl.cmd.AddGroupIdentityLinkCmd;
import com.finture.bpm.engine.impl.cmd.AddUserIdentityLinkCmd;
import com.finture.bpm.engine.impl.cmd.AssignTaskCmd;
import com.finture.bpm.engine.impl.cmd.ClaimTaskCmd;
import com.finture.bpm.engine.impl.cmd.CompleteTaskCmd;
import com.finture.bpm.engine.impl.cmd.CreateAttachmentCmd;
import com.finture.bpm.engine.impl.cmd.CreateTaskCmd;
import com.finture.bpm.engine.impl.cmd.DelegateTaskCmd;
import com.finture.bpm.engine.impl.cmd.DeleteAttachmentCmd;
import com.finture.bpm.engine.impl.cmd.DeleteGroupIdentityLinkCmd;
import com.finture.bpm.engine.impl.cmd.DeleteProcessInstanceCommentCmd;
import com.finture.bpm.engine.impl.cmd.DeleteTaskCmd;
import com.finture.bpm.engine.impl.cmd.DeleteTaskCommentCmd;
import com.finture.bpm.engine.impl.cmd.DeleteUserIdentityLinkCmd;
import com.finture.bpm.engine.impl.cmd.GetAttachmentCmd;
import com.finture.bpm.engine.impl.cmd.GetAttachmentContentCmd;
import com.finture.bpm.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import com.finture.bpm.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import com.finture.bpm.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import com.finture.bpm.engine.impl.cmd.GetSubTasksCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskAttachmentCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskAttachmentContentCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskAttachmentsCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskCommentCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskCommentsCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskEventsCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskVariableCmd;
import com.finture.bpm.engine.impl.cmd.GetTaskVariableCmdTyped;
import com.finture.bpm.engine.impl.cmd.GetTaskVariablesCmd;
import com.finture.bpm.engine.impl.cmd.HandleTaskBpmnErrorCmd;
import com.finture.bpm.engine.impl.cmd.HandleTaskEscalationCmd;
import com.finture.bpm.engine.impl.cmd.PatchTaskVariablesCmd;
import com.finture.bpm.engine.impl.cmd.RemoveTaskVariablesCmd;
import com.finture.bpm.engine.impl.cmd.ResolveTaskCmd;
import com.finture.bpm.engine.impl.cmd.SaveAttachmentCmd;
import com.finture.bpm.engine.impl.cmd.SaveTaskCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskDescriptionCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskDueDateCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskFollowUpDateCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskNameCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskOwnerCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskPriorityCmd;
import com.finture.bpm.engine.impl.cmd.SetTaskVariablesCmd;
import com.finture.bpm.engine.impl.cmd.UpdateCommentCmd;
import com.finture.bpm.engine.impl.util.ExceptionUtil;
import com.finture.bpm.engine.task.Attachment;
import com.finture.bpm.engine.task.Comment;
import com.finture.bpm.engine.task.Event;
import com.finture.bpm.engine.task.IdentityLink;
import com.finture.bpm.engine.task.IdentityLinkType;
import com.finture.bpm.engine.task.NativeTaskQuery;
import com.finture.bpm.engine.task.Task;
import com.finture.bpm.engine.task.TaskQuery;
import com.finture.bpm.engine.task.TaskReport;
