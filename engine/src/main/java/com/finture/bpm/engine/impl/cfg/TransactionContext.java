...
public interface TransactionContext {
  ...
  /**
   * Add a {@link com.finture.bpm.engine.impl.cfg.TransactionListener} to the current transaction.
   *
   * @param transactionState the transaction state for which the {@link com.finture.bpm.engine.impl.cfg.TransactionListener} should be added.
   * @param transactionListener the {@link com.finture.bpm.engine.impl.cfg.TransactionListener} to add.
   */
