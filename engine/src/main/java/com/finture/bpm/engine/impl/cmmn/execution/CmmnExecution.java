...
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.ACTIVE;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.AVAILABLE;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.CLOSED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.COMPLETED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.DISABLED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.ENABLED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.FAILED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.NEW;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_PARENT_SUSPENSION;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.SUSPENDING_ON_SUSPENSION;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATED;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_EXIT;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_PARENT_TERMINATION;
import static com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState.TERMINATING_ON_TERMINATION;
import static com.finture.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.IF_PART;
import static com.finture.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.PLAN_ITEM_ON_PART;
import static com.finture.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration.VARIABLE_ON_PART;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_COMPLETE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_CREATE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DELETE_CASCADE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_DISABLE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_ENABLE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_EXIT;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_ENTRY_CRITERIA;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_FIRE_EXIT_CRITERIA;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_COMPLETE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_MANUAL_START;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_OCCUR;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_RESUME;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_SUSPEND;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_PARENT_TERMINATE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RESUME;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ACTIVATE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_RE_ENABLE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_START;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPEND;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_PARENT_SUSPENSION;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_SUSPENDING_ON_SUSPENSION;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_EXIT;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_PARENT_TERMINATION;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_EXECUTION_TERMINATING_ON_TERMINATION;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CLOSE;
import static com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation.CASE_INSTANCE_CREATE;
import static com.finture.bpm.engine.impl.util.EnsureUtil.ensureInstanceOf;
...
import com.finture.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionEntity;
import com.finture.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartEntity;
import com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState;
import com.finture.bpm.engine.impl.cmmn.execution.CmmnCaseInstance;
...
import com.finture.bpm.engine.impl.cmmn.model.CmmnIfPartDeclaration;
import com.finture.bpm.engine.impl.cmmn.model.CmmnOnPartDeclaration;
import com.finture.bpm.engine.impl.cmmn.model.CmmnSentryDeclaration;
import com.finture.bpm.engine.impl.cmmn.model.CmmnVariableOnPartDeclaration;
import com.finture.bpm.engine.impl.cmmn.operation.CmmnAtomicOperation;
import com.finture.bpm.engine.impl.context.Context;
import com.finture.bpm.engine.impl.core.instance.CoreExecution;
import com.finture.bpm.engine.impl.core.variable.event.VariableEvent;
...
import com.finture.bpm.engine.impl.pvm.PvmException;
...
import com.finture.bpm.engine.impl.variable.listener.CaseVariableListenerInvocation;
import com.finture.bpm.engine.impl.variable.listener.DelegateCaseVariableInstanceImpl;
...
public abstract class CmmnExecution extends CoreExecution implements CmmnCaseInstance {
  ...
  protected abstract com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart newSentryPart();

  protected abstract void addSentryPart(com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart);
    ...
    if (sentries != null && !sentries.isEmpty()) {
      ...
      for (CmmnSentryDeclaration sentryDeclaration : sentries) {
        ...
        if (ifPartDeclaration != null) {
          com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart ifPart = createIfPart(sentryDeclaration, ifPartDeclaration);
        ...
        for (CmmnOnPartDeclaration onPartDeclaration : onPartDeclarations) {
          com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart onPart = createOnPart(sentryDeclaration, onPartDeclaration);
        ...
        for(CmmnVariableOnPartDeclaration variableOnPartDeclaration: variableOnPartDeclarations) {
          com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart variableOnPart = createVariableOnPart(sentryDeclaration, variableOnPartDeclaration);
  ...
  protected com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart createOnPart(CmmnSentryDeclaration sentryDeclaration, CmmnOnPartDeclaration onPartDeclaration) {
    com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart = createSentryPart(sentryDeclaration, PLAN_ITEM_ON_PART);
  ...
  protected com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart createIfPart(CmmnSentryDeclaration sentryDeclaration, CmmnIfPartDeclaration ifPartDeclaration) {
    return createSentryPart(sentryDeclaration, IF_PART);
  }

  protected com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart createVariableOnPart(CmmnSentryDeclaration sentryDeclaration, CmmnVariableOnPartDeclaration variableOnPartDeclaration) {
    com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart = createSentryPart(sentryDeclaration, VARIABLE_ON_PART);
  ...
  protected com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart createSentryPart(CmmnSentryDeclaration sentryDeclaration, String type) {
    com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart newSentryPart = newSentryPart();
  ...
  public void fireIfOnlySentryParts() {
    ...
    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = collectSentryParts(getSentries());
    for (com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart : sentryParts) {
  ...
  public void handleVariableTransition(String variableName, String transition) {
    Map<String, List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> sentries = collectAllSentries();

    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = collectSentryParts(sentries);

    List<String> affectedSentries = collectAffectedSentriesWithVariableOnParts(variableName, transition, sentryParts);

    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> affectedSentryParts = getAffectedSentryParts(sentries,affectedSentries);
    ...
    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> satisfiedSentryParts = getAffectedSentryParts(sentries, satisfiedSentries);
  ...
  protected List<String> collectAffectedSentries(CmmnExecution child, String transition) {
    List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = getCaseSentryParts();
  ...
  protected boolean isNotSatisfiedIfPartOnly(com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart) {
    return IF_PART.equals(sentryPart.getType())
        && getSentries().get(sentryPart.getSentryId()).size() == 1
        && !sentryPart.isSatisfied();
  }

  protected void addIdIfNotSatisfied(List<String> affectedSentries, com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart) {
  ...
  protected List<String> collectAffectedSentriesWithVariableOnParts(String variableName, String variableEvent, List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts) {
  ...
  protected Map<String,List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> collectAllSentries() {
  ...
  protected List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> getAffectedSentryParts(Map<String,List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> allSentries, List<String> affectedSentries) {
    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> affectedSentryParts = new ArrayList<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>();
  ...
  protected List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> collectSentryParts(Map<String,List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> sentries) {
    List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = new ArrayList<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>();
  ...
  protected void forceUpdateOnCaseSentryParts(List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts) {
   ...
   * sentry is satisfied.
   */
  protected List<String> getSatisfiedSentriesInExecutionTree(List<String> sentryIds, Map<String, List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> allSentries) {
    List<String> result = new ArrayList<String>();

    if (sentryIds != null) {

      for (String sentryId : sentryIds) {
        List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = allSentries.get(sentryId);
  ...
  protected void forceUpdateOnSentries(List<String> sentryIds) {
    for (String sentryId : sentryIds) {
      List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = findSentry(sentryId);
      // set for each case sentry part forceUpdate flag to true to provoke
      // an OptimisticLockingException if different case sentry parts of the
      // same sentry has been satisfied concurrently.
      for (com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart sentryPart : sentryParts) {
  ...
  protected void resetSentries(List<String> sentries) {
    for (String sentry : sentries) {
      List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> parts = getSentries().get(sentry);
      for (com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart part : parts) {
        part.setSatisfied(false);
      }
    }
  }

  protected void resetSentryParts(List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> parts) {
    for (com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart part : parts) {
      part.setSatisfied(false);
    }
  }
  ...
  public abstract List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> getCaseSentryParts();

  protected abstract List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> findSentry(String sentryId);

  protected abstract Map<String, List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> getSentries();
  ...
  protected boolean isSentryPartsSatisfied(String sentryId, List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts) {
    // if part will be evaluated in the end
    com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart ifPart = null;
  ...
  protected boolean containsIfPartAndExecutionActive(String sentryId, Map<String,List<com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart>> sentries) {
    List<? extends com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart> sentryParts = sentries.get(sentryId);
