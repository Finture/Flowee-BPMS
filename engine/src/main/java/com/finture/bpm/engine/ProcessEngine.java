 ...
 * <ul>
 * <li>
 * <b>{@link com.finture.bpm.engine.RuntimeService}: </b> Allows the creation of
 * {@link com.finture.bpm.engine.repository.Deployment}s and the starting of and searching on
 * {@link com.finture.bpm.engine.runtime.ProcessInstance}s.</li>
 * <li>
 * <b>{@link com.finture.bpm.engine.TaskService}: </b> Exposes operations to manage human
 * (standalone) {@link com.finture.bpm.engine.task.Task}s, such as claiming, completing and
 * assigning tasks</li>
 * <li>
 * <b>{@link com.finture.bpm.engine.IdentityService}: </b> Used for managing
 * {@link com.finture.bpm.engine.identity.User}s, {@link com.finture.bpm.engine.identity.Group}s and
 * the relations between them<</li>
 * <li>
 * <b>{@link com.finture.bpm.engine.ManagementService}: </b> Exposes engine admin and
 * maintenance operations</li>
 *  <li>
 * <b>{@link com.finture.bpm.engine.HistoryService}: </b> Service exposing information about
 * ongoing and past process instances.</li>
 *
 * <li><b>{@link com.finture.bpm.engine.AuthorizationService}:</b> Service allowing
