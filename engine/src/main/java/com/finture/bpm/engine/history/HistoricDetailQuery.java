 ...
 */
package com.finture.bpm.engine.history;

import java.util.Date;

import com.finture.bpm.engine.history.*;
...
/**
 * Programmatic querying for {@link com.finture.bpm.engine.history.HistoricDetail}s.
 *
 * @author Tom Baeyens
 */
public interface HistoricDetailQuery extends Query<HistoricDetailQuery, com.finture.bpm.engine.history.HistoricDetail> {
  ...
  /** Only select historic variable updates associated to the given {@link com.finture.bpm.engine.history.HistoricActivityInstance activity instance}.
  ...
  /** Only select {@link com.finture.bpm.engine.history.HistoricFormField}s. */
  ...
  /** Exclude all task-related {@link com.finture.bpm.engine.history.HistoricDetail}s, so only items which have no
  ...
  /**
   * <p>Sort the {@link com.finture.bpm.engine.history.HistoricDetail historic detail events} in the order in which
