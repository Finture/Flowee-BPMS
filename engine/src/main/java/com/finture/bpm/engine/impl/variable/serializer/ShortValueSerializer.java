...
import com.finture.bpm.engine.impl.variable.serializer.PrimitiveValueSerializer;
...
public class ShortValueSerializer extends PrimitiveValueSerializer<ShortValue> {
  ...
  public ShortValue readValue(com.finture.bpm.engine.impl.variable.serializer.ValueFields valueFields, boolean asTransientValue) {
