 ...
 */
package com.finture.bpm.engine.impl.oplog;
...
public class UserOperationLogContextEntryBuilder {
  ...
  protected com.finture.bpm.engine.impl.oplog.UserOperationLogContextEntry entry;
  ...
  public static UserOperationLogContextEntryBuilder entry(String operationType, String entityType) {
    ...
    builder.entry = new com.finture.bpm.engine.impl.oplog.UserOperationLogContextEntry(operationType, entityType);
    return builder;
  }
