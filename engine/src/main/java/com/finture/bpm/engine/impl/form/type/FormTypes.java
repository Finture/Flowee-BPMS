 ...
 */
package com.finture.bpm.engine.impl.form.type;
...
import com.finture.bpm.engine.impl.form.handler.DefaultFormHandler;
...
public class FormTypes {
  ...
  protected Map<String, com.finture.bpm.engine.impl.form.type.AbstractFormFieldType> formTypes = new HashMap<String, com.finture.bpm.engine.impl.form.type.AbstractFormFieldType>();

  public void addFormType(com.finture.bpm.engine.impl.form.type.AbstractFormFieldType formType) {
    formTypes.put(formType.getName(), formType);
  }

  public com.finture.bpm.engine.impl.form.type.AbstractFormFieldType parseFormPropertyType(Element formFieldElement, BpmnParse bpmnParse) {
    com.finture.bpm.engine.impl.form.type.AbstractFormFieldType formType = null;
