...
import com.finture.bpm.engine.impl.persistence.entity.IdentityLinkEntity;
...
import com.finture.bpm.engine.impl.repository.ResourceDefinitionEntity;
...
public class ProcessDefinitionEntity extends ProcessDefinitionImpl implements ProcessDefinition, ResourceDefinitionEntity<ProcessDefinitionEntity>, DbEntity, HasDbRevision {
  ...
  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity createProcessInstance() {
    return (com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) super.createProcessInstance();
  }

  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity createProcessInstance(String businessKey) {
    return (com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) super.createProcessInstance(businessKey);
  }

  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity createProcessInstance(String businessKey, String caseInstanceId) {
    return (com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) super.createProcessInstance(businessKey, caseInstanceId);
  }

  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity createProcessInstance(String businessKey, ActivityImpl initial) {
    return (com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) super.createProcessInstance(businessKey, initial);
  }

  @Override
  protected PvmExecutionImpl newProcessInstance() {
    com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity newExecution = com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity.createNewExecution();
  ...
  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity createProcessInstance(String businessKey, String caseInstanceId, ActivityImpl initial) {
    ensureNotSuspended();

    com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity processInstance = (ExecutionEntity) createProcessInstanceForInitial(initial);
