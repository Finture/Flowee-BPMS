...
import com.finture.bpm.engine.impl.util.ModificationUtil;
...
public class ModifyProcessInstanceCmd implements Command<Void> {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    List<com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand> instructions = builder.getModificationOperations();

    checkCancellation(commandContext);
    for (int i = 0; i < instructions.size(); i++) {

      com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand instruction = instructions.get(i);
