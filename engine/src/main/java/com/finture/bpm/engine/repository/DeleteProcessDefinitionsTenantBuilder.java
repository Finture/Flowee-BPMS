 ...
 */
public interface DeleteProcessDefinitionsTenantBuilder extends com.finture.bpm.engine.repository.DeleteProcessDefinitionsBuilder {
   ...
   * @return the builder
   */
  com.finture.bpm.engine.repository.DeleteProcessDefinitionsBuilder withoutTenantId();
