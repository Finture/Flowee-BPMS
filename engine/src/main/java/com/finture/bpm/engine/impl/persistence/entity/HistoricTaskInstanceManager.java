...
public class HistoricTaskInstanceManager extends AbstractHistoricManager {
  ...
  public void updateHistoricTaskInstance(final com.finture.bpm.engine.impl.persistence.entity.TaskEntity taskEntity) {
  ...
  public void markTaskInstanceEnded(String taskId, final String deleteReason) {
    ...
    final com.finture.bpm.engine.impl.persistence.entity.TaskEntity taskEntity = Context.getCommandContext()
        .getDbEntityManager()
        .selectById(com.finture.bpm.engine.impl.persistence.entity.TaskEntity.class, taskId);
