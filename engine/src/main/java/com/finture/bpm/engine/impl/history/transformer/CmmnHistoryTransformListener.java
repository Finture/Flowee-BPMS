 ...
 */
package com.finture.bpm.engine.impl.history.transformer;
...
import com.finture.bpm.engine.impl.history.transformer.*;
...
public class CmmnHistoryTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(com.finture.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity caseActivity) {
    transformCasePlanModel((com.finture.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, caseActivity);
  }
