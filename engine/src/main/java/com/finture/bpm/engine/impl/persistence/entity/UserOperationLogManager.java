...
import com.finture.bpm.engine.impl.identity.IdentityOperationResult;
...
import com.finture.bpm.engine.impl.oplog.UserOperationLogContextEntryBuilder;
...
import com.finture.bpm.engine.impl.util.PermissionConverter;
...
public class UserOperationLogManager extends AbstractHistoricManager {
  ...
  public void logTaskOperations(String operation, com.finture.bpm.engine.impl.persistence.entity.TaskEntity task, List<PropertyChange> propertyChanges) {
    if (isUserOperationLogEnabled()) {
      UserOperationLogContext context = new UserOperationLogContext();
      UserOperationLogContextEntryBuilder entryBuilder =
  ...
  public void logLinkOperation(String operation, com.finture.bpm.engine.impl.persistence.entity.TaskEntity task, PropertyChange propertyChange) {
    if (isUserOperationLogEnabled()) {
      UserOperationLogContext context = new UserOperationLogContext();
      UserOperationLogContextEntryBuilder entryBuilder =
  ...
  public void logProcessInstanceOperation(String operation, String processInstanceId, String processDefinitionId, String processDefinitionKey, List<PropertyChange> propertyChanges, String annotation) {
    if (isUserOperationLogEnabled()) {
      ...
      if(processInstanceId != null) {
        com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity instance = getProcessInstanceManager().findExecutionById(processInstanceId);
        ...
        com.finture.bpm.engine.impl.persistence.entity.ProcessDefinitionEntity definition = getProcessDefinitionManager().findLatestProcessDefinitionById(processDefinitionId);
        if (definition != null) {
  ...
  public void logJobOperation(String operation, String jobId, String jobDefinitionId, String processInstanceId,
    ...
    if (isUserOperationLogEnabled()) {
      ...
      if(jobDefinitionId != null) {
        ...
        com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity processInstance = getProcessInstanceManager().findExecutionById(processInstanceId);
        // Backward compatibility
  ...
  public void logAttachmentOperation(String operation, com.finture.bpm.engine.impl.persistence.entity.TaskEntity task, PropertyChange propertyChange) {
    if (isUserOperationLogEnabled()) {
      UserOperationLogContext context = new UserOperationLogContext();
  ...
  public void logAttachmentOperation(String operation, com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity processInstance, PropertyChange propertyChange) {
    if (isUserOperationLogEnabled()) {
      UserOperationLogContext context = new UserOperationLogContext();
  ...
  public void logVariableOperation(String operation, String executionId, String taskId, PropertyChange propertyChange) {
    if(isUserOperationLogEnabled()) {
      ...
      if (executionId != null) {
        com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity execution = getProcessInstanceManager().findExecutionById(executionId);
