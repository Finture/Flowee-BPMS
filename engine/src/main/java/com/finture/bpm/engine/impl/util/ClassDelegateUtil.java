...
public class ClassDelegateUtil {
  ...
  public static Object instantiateDelegate(String className, List<FieldDeclaration> fieldDeclarations) {
    ...
    try {
      Class<?> clazz = com.finture.bpm.engine.impl.util.ReflectUtil.loadClass(className);
  ...
  public static void applyFieldDeclaration(FieldDeclaration declaration, Object target) {
    Method setterMethod = com.finture.bpm.engine.impl.util.ReflectUtil.getSetter(declaration.getName(),
    ...
    if(setterMethod != null) {
      ...
      Field field = com.finture.bpm.engine.impl.util.ReflectUtil.getField(declaration.getName(), target);
