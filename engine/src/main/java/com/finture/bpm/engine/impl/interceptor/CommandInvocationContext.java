...
import com.finture.bpm.engine.impl.interceptor.BpmnStackTrace;
...
public class CommandInvocationContext {
  ...
  protected List<com.finture.bpm.engine.impl.interceptor.AtomicOperationInvocation> queuedInvocations = new ArrayList<>();
  protected com.finture.bpm.engine.impl.interceptor.BpmnStackTrace bpmnStackTrace = new BpmnStackTrace();
  ...
  public void performOperation(final AtomicOperation executionOperation, final ExecutionEntity execution, final boolean performAsync) {
    com.finture.bpm.engine.impl.interceptor.AtomicOperationInvocation invocation = new com.finture.bpm.engine.impl.interceptor.AtomicOperationInvocation(executionOperation, execution, performAsync);
    queuedInvocations.add(0, invocation);
    performNext();
  }

  protected void performNext() {
    com.finture.bpm.engine.impl.interceptor.AtomicOperationInvocation nextInvocation = queuedInvocations.get(0);
