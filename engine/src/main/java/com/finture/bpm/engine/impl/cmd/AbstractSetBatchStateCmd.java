...
public abstract class AbstractSetBatchStateCmd implements Command<Void> {
  ...
  protected com.finture.bpm.engine.impl.cmd.AbstractSetJobDefinitionStateCmd createSetJobDefinitionStateCommand(String jobDefinitionId) {
    com.finture.bpm.engine.impl.cmd.AbstractSetJobDefinitionStateCmd suspendJobDefinitionCmd = createSetJobDefinitionStateCommand(new UpdateJobDefinitionSuspensionStateBuilderImpl()
