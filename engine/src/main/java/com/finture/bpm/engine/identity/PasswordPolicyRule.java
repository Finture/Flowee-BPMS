...
/**
 * Describes a rule of a {@link com.finture.bpm.engine.identity.PasswordPolicy}. All rules attached to a
...
public interface PasswordPolicyRule {
   ...
   * {@link PasswordPolicyRule#execute(String, com.finture.bpm.engine.identity.User)} is implemented.</p>
   * 
