...
public interface AuthorizationService {
   ...
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#AUTHORIZATION}.
   */
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException in case an internal error occurs
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no
