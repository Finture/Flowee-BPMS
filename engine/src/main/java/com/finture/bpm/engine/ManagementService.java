...
import com.finture.bpm.engine.authorization.BatchPermissions;
...
import com.finture.bpm.engine.management.TablePage;
import com.finture.bpm.engine.management.TablePageQuery;
import com.finture.bpm.engine.management.UpdateJobDefinitionSuspensionStateBuilder;
import com.finture.bpm.engine.management.UpdateJobDefinitionSuspensionStateSelectBuilder;
import com.finture.bpm.engine.management.UpdateJobSuspensionStateBuilder;
...
public interface ManagementService {
   ...
   *
   * @throws com.finture.bpm.engine.ProcessEngineException
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException
   *          If the job definition id is equal null.
   * @throws com.finture.bpm.engine.AuthorizationException thrown if the current user does not possess
   *   <ul>
   ...
   *
   * @throws com.finture.bpm.engine.AuthorizationException thrown if the current user does not possess any of the following permissions
   *   <ul>
