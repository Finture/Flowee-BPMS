...
import com.finture.bpm.engine.impl.form.FormDataImpl;
import com.finture.bpm.engine.impl.form.FormDefinition;
import com.finture.bpm.engine.impl.form.handler.FormFieldHandler;
import com.finture.bpm.engine.impl.form.handler.FormFieldValidationConstraintHandler;
import com.finture.bpm.engine.impl.form.handler.FormHandler;
import com.finture.bpm.engine.impl.form.handler.FormPropertyHandler;
...
public class DefaultFormHandler implements FormHandler {
  ...
  protected List<com.finture.bpm.engine.impl.form.handler.FormPropertyHandler> formPropertyHandlers = new ArrayList<>();

  protected List<com.finture.bpm.engine.impl.form.handler.FormFieldHandler> formFieldHandlers = new ArrayList<>();
  ...
  protected void parseFormField(Element formField, BpmnParse bpmnParse, ExpressionManager expressionManager) {
    ...
    com.finture.bpm.engine.impl.form.handler.FormFieldHandler formFieldHandler = new com.finture.bpm.engine.impl.form.handler.FormFieldHandler();
  ...
  protected void parseProperties(Element formField, com.finture.bpm.engine.impl.form.handler.FormFieldHandler formFieldHandler, BpmnParse bpmnParse, ExpressionManager expressionManager) {
  ...
  protected void parseValidation(Element formField, com.finture.bpm.engine.impl.form.handler.FormFieldHandler formFieldHandler, BpmnParse bpmnParse, ExpressionManager expressionManager) {
    ...
    if(validationElement != null) {
      ...
      for (Element property : constraintElements) {
         ...
         if(validator != null) {
           com.finture.bpm.engine.impl.form.handler.FormFieldValidationConstraintHandler handler = new FormFieldValidationConstraintHandler();
  ...
  protected void parseFormProperties(BpmnParse bpmnParse, ExpressionManager expressionManager, Element extensionElement) {
    ...
    for (Element formPropertyElement : formPropertyElements) {
      com.finture.bpm.engine.impl.form.handler.FormPropertyHandler formPropertyHandler = new com.finture.bpm.engine.impl.form.handler.FormPropertyHandler();
  ...
  protected void initializeFormProperties(FormDataImpl formData, ExecutionEntity execution) {
    ...
    for (com.finture.bpm.engine.impl.form.handler.FormPropertyHandler formPropertyHandler: formPropertyHandlers) {
  ...
  protected void initializeFormFields(FormDataImpl taskFormData, ExecutionEntity execution) {
    ...
    for (com.finture.bpm.engine.impl.form.handler.FormFieldHandler formFieldHandler : formFieldHandlers) {
  ...
  public List<com.finture.bpm.engine.impl.form.handler.FormPropertyHandler> getFormPropertyHandlers() {
