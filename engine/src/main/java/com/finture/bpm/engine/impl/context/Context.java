 ...
 */
package com.finture.bpm.engine.impl.context;
...
import com.finture.bpm.engine.impl.context.BpmnExecutionContext;
import com.finture.bpm.engine.impl.context.CaseExecutionContext;
import com.finture.bpm.engine.impl.context.CoreExecutionContext;
import com.finture.bpm.engine.impl.context.ExecutionContext;
import com.finture.bpm.engine.impl.context.ProcessApplicationClassloaderInterceptor;
...
public class Context {
  ...
  protected static ThreadLocal<Deque<com.finture.bpm.engine.impl.context.CoreExecutionContext<? extends CoreExecution>>> executionContextStackThreadLocal = new ThreadLocal<Deque<com.finture.bpm.engine.impl.context.CoreExecutionContext<? extends CoreExecution>>>();
  ...
  public static com.finture.bpm.engine.impl.context.BpmnExecutionContext getBpmnExecutionContext() {
    return (com.finture.bpm.engine.impl.context.BpmnExecutionContext) getCoreExecutionContext();
  }
  ...
  public static com.finture.bpm.engine.impl.context.CoreExecutionContext<? extends CoreExecution> getCoreExecutionContext() {
  ...
  public static <T> T executeWithinProcessApplication(Callable<T> callback, ProcessApplicationReference processApplicationReference, InvocationContext invocationContext) {
    ...
    try {
      ...
      try {
        // wrap callback
        com.finture.bpm.engine.impl.context.ProcessApplicationClassloaderInterceptor<T> wrappedCallback = new ProcessApplicationClassloaderInterceptor<T>(callback);
