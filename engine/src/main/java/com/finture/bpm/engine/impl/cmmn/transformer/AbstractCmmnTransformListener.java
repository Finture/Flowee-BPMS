...
public class AbstractCmmnTransformListener implements CmmnTransformListener {
  ...
  public void transformCasePlanModel(com.finture.bpm.model.cmmn.impl.instance.CasePlanModel casePlanModel, CmmnActivity activity) {
    transformCasePlanModel((com.finture.bpm.model.cmmn.instance.CasePlanModel) casePlanModel, activity);
  }
