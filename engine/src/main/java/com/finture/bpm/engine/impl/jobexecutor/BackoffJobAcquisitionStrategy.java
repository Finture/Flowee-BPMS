...
public class BackoffJobAcquisitionStrategy implements JobAcquisitionStrategy {
  ...
  @Override
  public void reconfigure(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext context) {
   ...
   */
  protected boolean allSubmittedJobsRejected(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext context) {
  ...
  protected void reconfigureIdleLevel(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext context) {
  ...
  protected void reconfigureBackoffLevel(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext context) {
