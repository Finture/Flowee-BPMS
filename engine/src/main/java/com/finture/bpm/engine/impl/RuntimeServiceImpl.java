...
import com.finture.bpm.engine.form.FormData;
import com.finture.bpm.engine.history.HistoricProcessInstanceQuery;
import com.finture.bpm.engine.impl.cmd.CreateIncidentCmd;
import com.finture.bpm.engine.impl.cmd.DeleteProcessInstanceCmd;
import com.finture.bpm.engine.impl.cmd.DeleteProcessInstancesCmd;
import com.finture.bpm.engine.impl.cmd.FindActiveActivityIdsCmd;
import com.finture.bpm.engine.impl.cmd.GetActivityInstanceCmd;
import com.finture.bpm.engine.impl.cmd.GetExecutionVariableCmd;
import com.finture.bpm.engine.impl.cmd.GetExecutionVariableTypedCmd;
import com.finture.bpm.engine.impl.cmd.GetExecutionVariablesCmd;
import com.finture.bpm.engine.impl.cmd.GetStartFormCmd;
import com.finture.bpm.engine.impl.cmd.MessageEventReceivedCmd;
import com.finture.bpm.engine.impl.cmd.PatchExecutionVariablesCmd;
import com.finture.bpm.engine.impl.cmd.RemoveExecutionVariablesCmd;
import com.finture.bpm.engine.impl.cmd.ResolveIncidentCmd;
import com.finture.bpm.engine.impl.cmd.SetAnnotationForIncidentCmd;
import com.finture.bpm.engine.impl.cmd.SetExecutionVariablesCmd;
import com.finture.bpm.engine.impl.cmd.SignalCmd;
import com.finture.bpm.engine.impl.cmd.batch.DeleteProcessInstanceBatchCmd;
import com.finture.bpm.engine.impl.cmd.batch.variables.SetVariablesToProcessInstancesBatchCmd;
import com.finture.bpm.engine.impl.migration.MigrationPlanBuilderImpl;
import com.finture.bpm.engine.impl.migration.MigrationPlanExecutionBuilderImpl;
import com.finture.bpm.engine.impl.runtime.UpdateProcessInstanceSuspensionStateBuilderImpl;
...
import com.finture.bpm.engine.runtime.ConditionEvaluationBuilder;
...
import com.finture.bpm.engine.runtime.ModificationBuilder;
import com.finture.bpm.engine.runtime.NativeExecutionQuery;
import com.finture.bpm.engine.runtime.NativeProcessInstanceQuery;
...
import com.finture.bpm.engine.runtime.RestartProcessInstanceBuilder;
import com.finture.bpm.engine.runtime.SignalEventReceivedBuilder;
