 ...
 */
package com.finture.bpm.engine.impl.history.producer;

import static com.finture.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_END;
import static com.finture.bpm.engine.ProcessEngineConfiguration.HISTORY_REMOVAL_TIME_STRATEGY_START;
import static com.finture.bpm.engine.impl.util.ExceptionUtil.createJobExceptionByteArray;
import static com.finture.bpm.engine.impl.util.ExceptionUtil.getExceptionStacktrace;
import static com.finture.bpm.engine.impl.util.StringUtil.toByteArray;
...
import com.finture.bpm.engine.history.ExternalTaskState;
import com.finture.bpm.engine.history.HistoricProcessInstance;
import com.finture.bpm.engine.history.IncidentState;
import com.finture.bpm.engine.history.JobState;
import com.finture.bpm.engine.impl.ProcessEngineLogger;
import com.finture.bpm.engine.impl.batch.BatchEntity;
import com.finture.bpm.engine.impl.batch.history.HistoricBatchEntity;
...
import com.finture.bpm.engine.impl.history.event.HistoricActivityInstanceEventEntity;
import com.finture.bpm.engine.impl.history.event.HistoricExternalTaskLogEntity;
import com.finture.bpm.engine.impl.history.event.HistoricFormPropertyEventEntity;
import com.finture.bpm.engine.impl.history.event.HistoricIdentityLinkLogEventEntity;
import com.finture.bpm.engine.impl.history.event.HistoricIncidentEventEntity;
import com.finture.bpm.engine.impl.history.event.HistoricProcessInstanceEventEntity;
import com.finture.bpm.engine.impl.history.event.HistoricTaskInstanceEventEntity;
...
import com.finture.bpm.engine.impl.history.event.HistoryEventType;
...
import com.finture.bpm.engine.impl.oplog.UserOperationLogContext;
import com.finture.bpm.engine.impl.oplog.UserOperationLogContextEntry;
...
import com.finture.bpm.engine.impl.persistence.entity.ExternalTaskEntity;
import com.finture.bpm.engine.impl.persistence.entity.HistoricJobLogEventEntity;
import com.finture.bpm.engine.impl.persistence.entity.IncidentEntity;
