...
public interface FilterService {
   ...
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#FILTER}.
   */
   ...
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#CREATE} permissions on {@link Resources#FILTER} (save new filter)
   ...
   * @return the filter
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#READ} permissions on {@link Resources#FILTER}.
   */
   ...
   *
   * @param filterId the id of the filter
   * @throws com.finture.bpm.engine.AuthorizationException if the user has no {@link Permissions#DELETE} permissions on {@link Resources#FILTER}.
   */
