...
import com.finture.bpm.engine.impl.jobexecutor.JobHandlerConfiguration;
...
import com.finture.bpm.engine.impl.persistence.entity.TimerEntity;
...
public abstract class JobEntity extends AcquirableJobEntity
  ...
  protected int suspensionState = com.finture.bpm.engine.impl.persistence.entity.SuspensionState.ACTIVE.getStateCode();
