...
import com.finture.bpm.engine.impl.AbstractQueryVariableValueCondition;
import com.finture.bpm.engine.impl.QueryVariableValue;
import com.finture.bpm.engine.impl.SingleQueryVariableValueCondition;
...
public class CompositeQueryVariableValueCondition extends AbstractQueryVariableValueCondition {
  ...
  protected List<com.finture.bpm.engine.impl.SingleQueryVariableValueCondition> aggregatedValues = new ArrayList<>();
  ...
  public void initializeValue(VariableSerializers serializers, String dbType) {
    ...
    for (ValueType type : concreteTypes) {
      if (type.canConvertFromTypedValue(typedValue)) {
        ...
        com.finture.bpm.engine.impl.SingleQueryVariableValueCondition aggregatedValue = new com.finture.bpm.engine.impl.SingleQueryVariableValueCondition(wrappedQueryValue);
