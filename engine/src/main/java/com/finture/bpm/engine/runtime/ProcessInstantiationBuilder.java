...
import com.finture.bpm.engine.runtime.ActivityInstantiationBuilder;
...
public interface ProcessInstantiationBuilder
   ...
   */
  com.finture.bpm.engine.runtime.ProcessInstance execute();
   ...
   *           {@link Resources#PROCESS_DEFINITION}.
   */
  com.finture.bpm.engine.runtime.ProcessInstanceWithVariables executeWithVariablesInReturn();
