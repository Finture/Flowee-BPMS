 ...
 */
package com.finture.bpm.engine.form;
...
public interface FormData {
   ...
   *
   * A form can be referenced either through a form key or through a {@link com.finture.bpm.engine.form.CamundaFormRef}.
   *
   */
  String getFormKey();

  /**
   * User-defined reference to a form. A {@link com.finture.bpm.engine.form.CamundaFormRef} can specify any
