...
import static com.finture.bpm.engine.impl.util.EnsureUtil.ensureNotContainsEmptyString;
import static com.finture.bpm.engine.impl.util.EnsureUtil.ensureNotContainsNull;
...
import static com.finture.bpm.engine.impl.util.EnsureUtil.ensureNull;
...
import com.finture.bpm.engine.impl.AbstractVariableQueryImpl;
import com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty;
...
public class HistoricProcessInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricProcessInstanceQuery, HistoricProcessInstance> implements HistoricProcessInstanceQuery {
  ...
  protected Map<String, Set<com.finture.bpm.engine.impl.QueryVariableValue>> queryVariableNameToValuesMap = new HashMap<>();
  ...
  protected boolean hasExcludingConditions() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.BUSINESS_KEY);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessInstanceDuration() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.DURATION);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessInstanceStartTime() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.START_TIME);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessInstanceEndTime() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.END_TIME);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessDefinitionId() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.PROCESS_DEFINITION_ID);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessDefinitionKey() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.PROCESS_DEFINITION_KEY);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessDefinitionName() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.PROCESS_DEFINITION_NAME);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessDefinitionVersion() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.PROCESS_DEFINITION_VERSION);
  }
  ...
  public HistoricProcessInstanceQuery orderByProcessInstanceId() {
    ...
    return orderBy(com.finture.bpm.engine.impl.HistoricProcessInstanceQueryProperty.PROCESS_INSTANCE_ID_);
  }
  ...
  public List<com.finture.bpm.engine.impl.QueryVariableValue> getQueryVariableValues() {
  ...
  public Map<String, Set<com.finture.bpm.engine.impl.QueryVariableValue>> getQueryVariableNameToValuesMap() {
  ...
  protected void ensureVariablesInitialized() {
    ...
    if (!queries.isEmpty()) {
      ...
      for (HistoricProcessInstanceQueryImpl orQuery: queries) {
        for (com.finture.bpm.engine.impl.QueryVariableValue var : orQuery.getQueryVariableValues()) {
  ...
  protected void addVariable(String name, Object value, QueryOperator operator, boolean processInstanceScope) {
    com.finture.bpm.engine.impl.QueryVariableValue queryVariableValue = createQueryVariableValue(name, value, operator, processInstanceScope);
