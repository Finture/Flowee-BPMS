 ...
 */
package com.finture.bpm.engine.impl.db.entitymanager;

import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_MERGED;
import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_PERSISTENT;
import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.DELETED_TRANSIENT;
import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.MERGED;
import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.PERSISTENT;
import static com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState.TRANSIENT;
import static com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE;
import static com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType.DELETE_BULK;
import static com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType.INSERT;
import static com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE;
import static com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType.UPDATE_BULK;
...
import com.finture.bpm.engine.impl.GroupQueryImpl;
...
import com.finture.bpm.engine.impl.UserQueryImpl;
...
import com.finture.bpm.engine.impl.db.DbEntityLifecycleAware;
import com.finture.bpm.engine.impl.db.EnginePersistenceLogger;
import com.finture.bpm.engine.impl.db.EntityLoadListener;
import com.finture.bpm.engine.impl.db.FlushResult;
import com.finture.bpm.engine.impl.db.HistoricEntity;
import com.finture.bpm.engine.impl.db.ListQueryParameterObject;
import com.finture.bpm.engine.impl.db.PersistenceSession;
import com.finture.bpm.engine.impl.db.entitymanager.cache.CachedDbEntity;
import com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityCache;
import com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityState;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbBulkOperation;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbEntityOperation;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperation;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperation.State;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationManager;
import com.finture.bpm.engine.impl.db.entitymanager.operation.DbOperationType;
import com.finture.bpm.engine.impl.identity.db.DbGroupQueryImpl;
import com.finture.bpm.engine.impl.identity.db.DbUserQueryImpl;
import com.finture.bpm.engine.impl.interceptor.Session;
import com.finture.bpm.engine.impl.jobexecutor.JobExecutorContext;
...
import com.finture.bpm.engine.repository.ResourceTypes;
