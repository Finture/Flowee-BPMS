...
import com.finture.bpm.engine.impl.ModificationBuilderImpl;
import com.finture.bpm.engine.impl.ProcessEngineLogger;
import com.finture.bpm.engine.impl.ProcessInstanceModificationBuilderImpl;
import com.finture.bpm.engine.impl.cmd.*;
import com.finture.bpm.engine.impl.cmd.AbstractModificationCmd;
import com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand;
import com.finture.bpm.engine.impl.cmd.ActivityCancellationCmd;
...
public class ProcessInstanceModificationCmd extends AbstractModificationCmd<Void> {
  ...
  public Void execute(final CommandContext commandContext) {
    List<com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand> instructions = builder.getInstructions();
  ...
  protected ProcessInstanceModificationBuilderImpl createProcessInstanceModificationBuilder(
    ...
    List<com.finture.bpm.engine.impl.cmd.AbstractProcessInstanceModificationCommand> operations =
    ...
    for (AbstractProcessInstanceModificationCommand instruction : builder.getInstructions()) {
      ...
      if (!(instruction instanceof com.finture.bpm.engine.impl.cmd.ActivityCancellationCmd) ||
          !((com.finture.bpm.engine.impl.cmd.ActivityCancellationCmd)instruction).isCancelCurrentActiveActivityInstances()) {
        ...
        com.finture.bpm.engine.impl.cmd.ActivityCancellationCmd cancellationInstruction = (ActivityCancellationCmd) instruction;
