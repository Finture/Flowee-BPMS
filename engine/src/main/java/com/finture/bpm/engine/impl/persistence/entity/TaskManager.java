...
public class TaskManager extends AbstractManager {
  ...
  public void insertTask(com.finture.bpm.engine.impl.persistence.entity.TaskEntity task) {
  ...
  public void deleteTasksByProcessInstanceId(String processInstanceId, String deleteReason, boolean cascade, boolean skipCustomListeners) {
    List<com.finture.bpm.engine.impl.persistence.entity.TaskEntity> tasks = (List) getDbEntityManager()
      .createTaskQuery()
      .processInstanceId(processInstanceId)
      .list();

    String reason = (deleteReason == null || deleteReason.length() == 0) ? com.finture.bpm.engine.impl.persistence.entity.TaskEntity.DELETE_REASON_DELETED : deleteReason;

    for (com.finture.bpm.engine.impl.persistence.entity.TaskEntity task: tasks) {
  ...
  public void deleteTask(com.finture.bpm.engine.impl.persistence.entity.TaskEntity task, String deleteReason, boolean cascade, boolean skipCustomListeners) {
    if (!task.isDeleted()) {
      ...
      for (Task subTask: subTasks) {
        ((com.finture.bpm.engine.impl.persistence.entity.TaskEntity) subTask).delete(deleteReason, cascade, skipCustomListeners);
      }
  ...
  public com.finture.bpm.engine.impl.persistence.entity.TaskEntity findTaskById(String id) {
    ensureNotNull("Invalid task id", "id", id);
    return getDbEntityManager().selectById(com.finture.bpm.engine.impl.persistence.entity.TaskEntity.class, id);
  }

  @SuppressWarnings("unchecked")
  public List<com.finture.bpm.engine.impl.persistence.entity.TaskEntity> findTasksByExecutionId(String executionId) {
    return getDbEntityManager().selectList("selectTasksByExecutionId", executionId);
  }

  public com.finture.bpm.engine.impl.persistence.entity.TaskEntity findTaskByCaseExecutionId(String caseExecutionId) {
    return (com.finture.bpm.engine.impl.persistence.entity.TaskEntity) getDbEntityManager().selectOne("selectTaskByCaseExecutionId", caseExecutionId);
  }

  @SuppressWarnings("unchecked")
  public List<com.finture.bpm.engine.impl.persistence.entity.TaskEntity> findTasksByProcessInstanceId(String processInstanceId) {
  ...
  public void updateTaskSuspensionStateByProcessDefinitionId(String processDefinitionId, com.finture.bpm.engine.impl.persistence.entity.SuspensionState suspensionState) {
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("processDefinitionId", processDefinitionId);
    parameters.put("suspensionState", suspensionState.getStateCode());
    getDbEntityManager().update(com.finture.bpm.engine.impl.persistence.entity.TaskEntity.class, "updateTaskSuspensionStateByParameters", configureParameterizedQuery(parameters));
  }

  public void updateTaskSuspensionStateByProcessInstanceId(String processInstanceId, com.finture.bpm.engine.impl.persistence.entity.SuspensionState suspensionState) {
    Map<String, Object> parameters = new HashMap<String, Object>();
  ...
  public void updateTaskSuspensionStateByProcessDefinitionKey(String processDefinitionKey, com.finture.bpm.engine.impl.persistence.entity.SuspensionState suspensionState) {
    Map<String, Object> parameters = new HashMap<String, Object>();
  ...
  public void updateTaskSuspensionStateByProcessDefinitionKeyAndTenantId(String processDefinitionKey, String processDefinitionTenantId, com.finture.bpm.engine.impl.persistence.entity.SuspensionState suspensionState) {
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("processDefinitionKey", processDefinitionKey);
