 ...
 */
package com.finture.bpm.engine.authorization;
 ...
 * resource in a specific way. See {@link com.finture.bpm.engine.authorization.Permissions} for a set of built-in
 * permissions and {@link com.finture.bpm.engine.authorization.Authorization} for general overview on authorizations.</p>
 *  
 ...
 * all can be found in {@link com.finture.bpm.engine.authorization authorization} package).
 ...
 * {@link com.finture.bpm.engine.authorization.Resource}.</p>
 * 
 * 
 * @author Daniel Meyer
 * @since 7.0
