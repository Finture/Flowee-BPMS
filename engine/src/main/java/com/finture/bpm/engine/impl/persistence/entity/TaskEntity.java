...
import static com.finture.bpm.engine.delegate.TaskListener.EVENTNAME_DELETE;
import static com.finture.bpm.engine.impl.form.handler.DefaultFormHandler.FORM_REF_BINDING_VERSION;
...
import com.finture.bpm.engine.impl.bpmn.helper.BpmnExceptionHandler;
import com.finture.bpm.engine.impl.bpmn.helper.ErrorPropagationException;
import com.finture.bpm.engine.impl.bpmn.helper.EscalationHandler;
...
import com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionEntity;
...
import com.finture.bpm.engine.impl.core.variable.scope.VariableStore.VariablesProvider;
import com.finture.bpm.engine.impl.db.DbEntity;
import com.finture.bpm.engine.impl.db.EnginePersistenceLogger;
import com.finture.bpm.engine.impl.db.HasDbReferences;
import com.finture.bpm.engine.impl.db.HasDbRevision;
...
import com.finture.bpm.engine.impl.interceptor.CommandContextListener;
import com.finture.bpm.engine.impl.interceptor.CommandInvocationContext;
import com.finture.bpm.engine.impl.persistence.entity.*;
...
import com.finture.bpm.engine.impl.persistence.entity.VariableInstanceEntityFactory;
...
import com.finture.bpm.engine.impl.task.delegate.TaskListenerInvocation;
...
public class TaskEntity extends AbstractVariableScope implements Task, DelegateTask, Serializable, DbEntity, HasDbRevision, HasDbReferences, CommandContextListener, VariablesProvider<VariableInstanceEntity> {
  ...
  protected transient com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity execution;

  protected String processInstanceId;
  protected transient com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity processInstance;
   ...
   */
  public TaskEntity(com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity execution) {
    this(TaskState.STATE_INIT);
  ...
  protected void propagateExecutionTenantId(com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity execution) {
    if(execution != null) {
      setTenantId(execution.getTenantId());
    }
  }
  ...
  public void complete() {
    ...
    if (shouldDeleteTask)
    {
      ...
      // execution.
      if (executionId !=null) {
        com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity execution = getExecution();
  ...
  @Override
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity getExecution() {
  ...
  public void setExecution(PvmExecutionImpl execution) {
    if (execution!=null) {
      ...
      this.execution = (com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) execution;
      ...
      com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity instance = this.execution.getProcessInstance();
      if (instance != null) {
  ...
  protected boolean invokeListener(String taskEventName, TaskListener taskListener) {
    ...
    if (execution == null) {
      ...
      if (commandInvocationContext != null) {
        popProcessDataContext = commandInvocationContext.getProcessDataContext().pushSection((com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity) execution);
      }
    }
    if (execution != null) {
  ...
  public TaskDefinition getTaskDefinition() {
    if (taskDefinition==null && taskDefinitionKey!=null) {
      ...
      if (processDefinitionId != null) {
        com.finture.bpm.engine.impl.persistence.entity.ProcessDefinitionEntity processDefinition = Context
            .getProcessEngineConfiguration()
            .getDeploymentCache()
  ...
  public com.finture.bpm.engine.impl.persistence.entity.ProcessDefinitionEntity getProcessDefinition() {
    if (processDefinitionId != null) {
      return Context
          .getProcessEngineConfiguration()
          .getDeploymentCache()
  ...
  public com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity getProcessInstance() {
  ...
  public void setProcessInstance(com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity processInstance) {
  ...
  public Map<String, Class> getReferencedEntitiesIdAndClass() {
    ...
    if (processInstanceId != null) {
      referenceIdAndClass.put(processInstanceId, com.finture.bpm.engine.impl.persistence.entity.ExecutionEntity.class);
    }
    if (executionId != null) {
