...
import com.finture.bpm.engine.impl.json.ModificationBatchConfigurationJsonConverter;
...
public class ModificationBatchJobHandler extends AbstractBatchJobHandler<ModificationBatchConfiguration>{
  ...
  public void executeHandler(ModificationBatchConfiguration batchConfiguration,
    ...
    com.finture.bpm.engine.impl.ModificationBuilderImpl executionBuilder = (ModificationBuilderImpl) commandContext.getProcessEngineConfiguration()
        .getRuntimeService()
