...
import com.finture.bpm.engine.impl.pvm.PvmProcessElement;
...
public interface PvmScope extends PvmProcessElement {
   ...
   * the {@link com.finture.bpm.engine.impl.pvm.PvmActivity#getFlowScope() flow scope}.
   *
   * @return the list of flow activities for this scope.
   */
  List<? extends com.finture.bpm.engine.impl.pvm.PvmActivity> getActivities();
   ...
   */
  com.finture.bpm.engine.impl.pvm.PvmActivity findActivity(String activityId);
