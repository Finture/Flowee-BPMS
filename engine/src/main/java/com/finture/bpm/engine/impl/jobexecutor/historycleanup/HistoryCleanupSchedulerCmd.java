 ...
 */
package com.finture.bpm.engine.impl.jobexecutor.historycleanup;
...
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.BatchWindow;
...
public class HistoryCleanupSchedulerCmd implements Command<Void> {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    if (isRescheduleNow) {
      ...
      if (com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper.isWithinBatchWindow(ClockUtil.getCurrentTime(), commandContext.getProcessEngineConfiguration())) {
        Date nextRunDate = configuration.getNextRunWithDelay(ClockUtil.getCurrentTime());
        if (com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper.isWithinBatchWindow(nextRunDate, commandContext.getProcessEngineConfiguration())) {
