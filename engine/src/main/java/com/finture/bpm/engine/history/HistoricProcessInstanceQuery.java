...
/**
 * Allows programmatic querying of {@link com.finture.bpm.engine.history.HistoricProcessInstance}s.
 *
 * @author Tom Baeyens
 * @author Joram Barrez
 * @author Falko Menge
 */
public interface HistoricProcessInstanceQuery extends Query<HistoricProcessInstanceQuery, com.finture.bpm.engine.history.HistoricProcessInstance> {

  /**
   * Only select historic process instances with the given process instance.
   * {@link ProcessInstance) ids and {@link com.finture.bpm.engine.history.HistoricProcessInstance } ids match.
   */
