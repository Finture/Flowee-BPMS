 ...
 */
package com.finture.bpm.engine.impl.variable.listener;
...
public class ScriptCaseVariableListener implements CaseVariableListener {
  ...
  public void notify(DelegateCaseVariableInstance variableInstance) throws Exception {
    com.finture.bpm.engine.impl.variable.listener.DelegateCaseVariableInstanceImpl variableInstanceImpl = (DelegateCaseVariableInstanceImpl) variableInstance;
