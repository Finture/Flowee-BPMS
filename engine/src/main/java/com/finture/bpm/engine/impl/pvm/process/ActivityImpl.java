...
public class ActivityImpl extends ScopeImpl implements PvmActivity, HasDIBounds {
  ...
  protected List<com.finture.bpm.engine.impl.pvm.process.TransitionImpl> outgoingTransitions = new ArrayList<com.finture.bpm.engine.impl.pvm.process.TransitionImpl>();
  protected Map<String, com.finture.bpm.engine.impl.pvm.process.TransitionImpl> namedOutgoingTransitions = new HashMap<String, com.finture.bpm.engine.impl.pvm.process.TransitionImpl>();
  protected List<com.finture.bpm.engine.impl.pvm.process.TransitionImpl> incomingTransitions = new ArrayList<com.finture.bpm.engine.impl.pvm.process.TransitionImpl>();
  ...
  public com.finture.bpm.engine.impl.pvm.process.TransitionImpl createOutgoingTransition() {
    return createOutgoingTransition(null);
  }

  public com.finture.bpm.engine.impl.pvm.process.TransitionImpl createOutgoingTransition(String transitionId) {
    com.finture.bpm.engine.impl.pvm.process.TransitionImpl transition = new com.finture.bpm.engine.impl.pvm.process.TransitionImpl(transitionId, processDefinition);
  ...
  public com.finture.bpm.engine.impl.pvm.process.TransitionImpl findOutgoingTransition(String transitionId) {
  ...
  protected void setOutgoingTransitions(List<com.finture.bpm.engine.impl.pvm.process.TransitionImpl> outgoingTransitions) {
