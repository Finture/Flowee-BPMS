 ...
 */
package com.finture.bpm.engine.impl.form.engine;

import com.finture.bpm.engine.form.FormData;
import com.finture.bpm.engine.form.FormField;
import com.finture.bpm.engine.form.FormFieldValidationConstraint;
import com.finture.bpm.engine.form.FormProperty;
import com.finture.bpm.engine.impl.form.engine.FormPropertyAdapter;
import com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder;
import com.finture.bpm.engine.impl.form.engine.HtmlElementWriter;
...
import com.finture.bpm.engine.impl.form.type.EnumFormType;
...
public abstract class AbstractRenderFormDelegate {
  ...
  protected String renderFormData(FormData formData) {
    ...
    if(formData == null
      ...
      com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder = new com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder(formElement);
  ...
  protected void renderFormField(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
    // start group
  ...
  protected void renderDatePicker(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
  ...
  protected void renderInputField(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
    HtmlElementWriter inputField = new HtmlElementWriter(INPUT_ELEMENT, true);
    addCommonFormFieldAttributes(formField, inputField);
  ...
  protected void renderSelectBox(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
  ...
  protected void renderSelectOptions(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
  ...
  protected void renderInvalidMessageElement(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
    HtmlElementWriter divElement = new HtmlElementWriter(DIV_ELEMENT);
  ...
  protected void renderInvalidValueMessage(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
    HtmlElementWriter divElement = new HtmlElementWriter(DIV_ELEMENT);
  ...
  protected void renderInvalidTypeMessage(FormField formField, com.finture.bpm.engine.impl.form.engine.HtmlDocumentBuilder documentBuilder) {
    HtmlElementWriter divElement = new HtmlElementWriter(DIV_ELEMENT);
