 ...
 */
package com.finture.bpm.engine.externaltask;
...
public interface FetchAndLockBuilder {
  ...
  /**
   * Returns the {@link com.finture.bpm.engine.externaltask.ExternalTaskQueryTopicBuilder} to handle all the configuration that applies per topic.
   *
   * @return the builder
   */
