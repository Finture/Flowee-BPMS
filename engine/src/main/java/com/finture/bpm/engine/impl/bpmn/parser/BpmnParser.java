...
import com.finture.bpm.engine.impl.cfg.BpmnParseFactory;
 ...
 * This {@link Parser} creates {@link com.finture.bpm.engine.impl.bpmn.parser.BpmnParse} instances that
...
public class BpmnParser extends Parser {
   ...
   */
  public static final String BPMN_20_SCHEMA_LOCATION = "com/finture/bpm/engine/impl/bpmn/parser/BPMN20.xsd";
  ...
  protected List<com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener> parseListeners = new ArrayList<com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener>();
  ...
  /**
   * Creates a new {@link com.finture.bpm.engine.impl.bpmn.parser.BpmnParse} instance that can be used
  ...
  public List<com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener> getParseListeners() {
