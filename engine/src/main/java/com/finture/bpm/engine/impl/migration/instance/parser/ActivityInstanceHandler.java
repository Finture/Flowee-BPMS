...
public class ActivityInstanceHandler implements MigratingInstanceParseHandler<ActivityInstance> {
  ...
  @Override
  public void handle(com.finture.bpm.engine.impl.migration.instance.parser.MigratingInstanceParseContext parseContext, ActivityInstance element) {
  ...
  public void parseTransitionInstances(com.finture.bpm.engine.impl.migration.instance.parser.MigratingInstanceParseContext parseContext, MigratingActivityInstance migratingInstance) {
