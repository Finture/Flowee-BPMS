...
import com.finture.bpm.engine.exception.cmmn.CaseIllegalStateTransitionException;
...
import com.finture.bpm.engine.impl.pvm.PvmProcessInstance;
...
import com.finture.bpm.model.cmmn.instance.CaseTask;
import com.finture.bpm.model.cmmn.instance.EventListener;
import com.finture.bpm.model.cmmn.instance.HumanTask;
import com.finture.bpm.model.cmmn.instance.IfPart;
import com.finture.bpm.model.cmmn.instance.Milestone;
import com.finture.bpm.model.cmmn.instance.PlanItemOnPart;
import com.finture.bpm.model.cmmn.instance.ProcessTask;
import com.finture.bpm.model.cmmn.instance.Sentry;
import com.finture.bpm.model.cmmn.instance.Stage;
import com.finture.bpm.model.cmmn.instance.Task;
import com.finture.bpm.model.cmmn.instance.UserEventListener;
...
public interface CmmnActivityExecution extends DelegateCaseExecution {
  ...
  /**
   * <p>Returns the {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState current state} of <code>this</code>
   * case execution.</p>
   *
   * @return the {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState current state}
   */
  com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState getCurrentState();

  /**
   * <p>Sets the given {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState state} as the
   * current state of <code>this</code> case execution.</p>
   *
   * @param currentState the current state to set
   */
  void setCurrentState(com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState currentState);

  /**
   * <p>Returns the {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState previous state} of <code>this</code>
   * case execution.</p>
   *
   * @return the {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState previous state}
   */
  com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState getPreviousState();

  /**
   * <p>Returns <code>true</code> iff:<br>
   *  <code>{@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW}</code>
   * </p>
   *
   * @return whether <code>this</code> case execution has as current state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW}
   */
  boolean isNew();

  /**
   * <p>Returns <code>true</code> iff:<br>
   *  <code>{@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_TERMINATION}
   *        || {@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_PARENT_TERMINATION}
   *        || {@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_EXIT}</code>
   * </p>
   *
   * @return whether <code>this</code> case execution has as current state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_TERMINATION},
   *         {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_PARENT_TERMINATION} or {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_EXIT}
   */
  boolean isTerminating();

  /**
   * <p>Returns <code>true</code> iff:<br>
   *  <code>{@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_SUSPENSION}
   *        || {@link #getCurrentState()} == {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_PARENT_SUSPENSION}</code>
   * </p>
   *
   * @return whether <code>this</code> case execution has as current state
   *        {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_SUSPENSION} or {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_PARENT_SUSPENSION}
   */
   ...
   */
  List<com.finture.bpm.engine.impl.cmmn.execution.CmmnExecution> createChildExecutions(List<CmmnActivity> activities);
   ...
   *
   * @param children a collection of {@link com.finture.bpm.engine.impl.cmmn.execution.CmmnExecution case execution} to
   *                 trigger for each given case execution the lifecycle
   */
  void triggerChildExecutionsLifecycle(List<com.finture.bpm.engine.impl.cmmn.execution.CmmnExecution> children);

  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED} state.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE}
   ...
   *         is not {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE}.
   ...
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED}
   * state to be able to do this transition.</p>
   *
   ...
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED}.
   * @throws ProcessEngineException when an internal exception happens during the execution
   *     of the command.
   */
  void disable();
   ...
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED} state.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED}
   * state to be able to do this transition.</p>
   *
   ...
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED}.
   * @throws ProcessEngineException when an internal exception happens during the execution
   *     of the command.
   */
  void reenable();
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE} state.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED}
   * state to be able to do this transition.</p>
   *
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#COMPLETED} state.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE}
   * state to be able to do this transition.</p>
   *
   ...
   * <ul>
   *  <li>there are no children in the state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE} or {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW}</li>
   ...
   *        <ul>
   *          <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED}</li>
   *          <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#COMPLETED}</li>
   *          <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATED}</li>
   *          <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#FAILED}</li>
   *        </ul>
   *      </li>
   *    </ul>
   *  </li>
   ...
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE} or when the case execution cannot be
   *         completed.
   * @throws ProcessEngineException when an internal exception happens during the execution
   *     of the command.
   */
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_TERMINATION} state.</p>
   *
   * <p>If <code>this</code> case execution is associated with a {@link Stage} or
   * {@link Task}, then <code>this</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE}
   ...
   * {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE} state to be able to do this transition.</p>
   *
   ...
   * {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATED}.</p>
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATED} state.</p>
   *
   * <p>If <code>this</code> case execution has a parent case execution, that parent
   * case execution will be notified that <code>this</code> case execution has been
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_PARENT_TERMINATION} state.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE}
   * or {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED} state to be able to do this transition.</p>
   *
   ...
   * the transition into the state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATED}.</p>
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not in the expected state.
   * @throws ProcessEngineException when an internal exception happens during the execution
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATING_ON_EXIT} state.</p>
   *
   * <p><code>This</code> case execution must be in one of the following state to
   * be able to do this transition:
   * <ul>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED} or</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#FAILED}</li>
   * </ul>
   *
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_SUSPENSION} state.</p>
   *
   * <p>If <code>this</code> case execution is associated with a {@link Stage} or
   * {@link Task}, then <code>this</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE}
   * state to be able to do this transition.<br>
   ...
   * the transition into the state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED}.</p>
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not in the expected state.
   * @throws ProcessEngineException when an internal exception happens during the execution
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED} state.</p>
   *
   * @throws CaseIllegalStateTransitionException will be thrown, if <code>this</code> case execution
   *         is not in the expected state.
   * @throws ProcessEngineException when an internal exception happens during the execution
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDING_ON_PARENT_SUSPENSION} state.</p>
   *
   * <p><code>This</code> case execution must be in one of the following state to
   * be able to do this transition:
   * <ul>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED} or</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE}</li>
   * </ul>
   *
  ...
  /**
   * <p>Transition to either to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE} state, if <code>this</code>
   * case execution is associated with a {@link Stage} or {@link Task}, or to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABE},
   * if <code>this</code> case execution is associated with a {@link EventListener} or {@link Milestone}.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED}
   * state to be able to do this transition.</p>
   *
  ...
  /**
   * <p>Transition to the previous state ({@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#AVAILABLE},
   * {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ENABLED}, {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#DISABLED} or
   * {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#ACTIVE}) when the parent {@link Stage} transitions
   * out of {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED}.</p>
   *
   * <p><code>This</code> case execution must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED}
   * state to be able to do this transition.</p>
   *
   ...
   * must be in {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#FAILED} state to be able to do this transition.<br>
   ...
   * <ul>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#COMPLETED},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED},</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#TERMINATED} or</li>
   *   <li>{@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#FAILED}</li>
   * </ul>
   * </p>
   *
   * <p>In case of a case instance the transition out of {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#SUSPENDED} state
  ...
  /**
   * <p>Transition to {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#CLOSED} state when no further
   ...
   */
   com.finture.bpm.engine.task.Task createTask(TaskDecorator taskDecorator);
   ...
   * the specified {@link Sentry Sentries} a {@link com.finture.bpm.engine.impl.cmmn.execution.CmmnSentryPart}.</p>
   */
   ...
   * stays in state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW}.</p>
   *
   * <p>For example:</p>
   *
   * <p>There exists:</p>
   ...
   * will be created for task A and task B. Both tasks are in the state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW}.
   ...
   * <p>But task B is still in the state {@link com.finture.bpm.engine.impl.cmmn.execution.CaseExecutionState#NEW} and will not be
