...
import com.finture.bpm.engine.impl.jobexecutor.*;
import com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext;
import com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionStrategy;
 ...
 *   exceptions during acquisition, etc.) are collected in an instance of {@link com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext}.
 *   The context is then handed to a {@link com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionStrategy} that
...
public class SequentialJobAcquisitionRunnable extends AcquireJobsRunnable {
  ...
  protected com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext acquisitionContext;
  ...
  public synchronized void run() {
    ...
    com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionStrategy acquisitionStrategy = initializeAcquisitionStrategy();
  ...
  protected com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext initializeAcquisitionContext() {
    return new com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext();
  }
   ...
   */
  protected void configureNextAcquisitionCycle(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext acquisitionContext, com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionStrategy acquisitionStrategy) {
    acquisitionStrategy.reconfigure(acquisitionContext);
  }

  protected com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionStrategy initializeAcquisitionStrategy() {
    return new BackoffJobAcquisitionStrategy(jobExecutor);
  }

  public com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext getAcquisitionContext() {
    return acquisitionContext;

  }

  protected void executeJobs(com.finture.bpm.engine.impl.jobexecutor.JobAcquisitionContext context, ProcessEngineImpl currentProcessEngine, AcquiredJobs acquiredJobs) {
