 ...
 */
package com.finture.bpm.engine.impl.metrics.parser;
...
import com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener;
...
public class MetricsBpmnParseListener extends AbstractBpmnParseListener {
  ...
  public static com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener ROOT_PROCESS_INSTANCE_START_COUNTER =
      new com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener(Metrics.ROOT_PROCESS_INSTANCE_START,
                                   delegateExecution -> (delegateExecution.getId().equals(
                                           ((ExecutionEntity) delegateExecution)
                                               .getRootProcessInstanceId())));
  public static com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener ACTIVITY_INSTANCE_START_COUNTER =
      new com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener(Metrics.ACTIVTY_INSTANCE_START);
  public static com.finture.bpm.engine.impl.metrics.parser.MetricsExecutionListener ACTIVITY_INSTANCE_END_COUNTER =
