...
import com.finture.bpm.engine.impl.DeploymentQueryProperty;
...
public class DeploymentQueryImpl extends AbstractQuery<DeploymentQuery, Deployment> implements DeploymentQuery, Serializable {
  ...
  public DeploymentQuery orderByDeploymentId() {
    return orderBy(com.finture.bpm.engine.impl.DeploymentQueryProperty.DEPLOYMENT_ID);
  }

  public DeploymentQuery orderByDeploymenTime() {
    return orderBy(com.finture.bpm.engine.impl.DeploymentQueryProperty.DEPLOY_TIME);
  }
  ...
  public DeploymentQuery orderByDeploymentName() {
    return orderBy(com.finture.bpm.engine.impl.DeploymentQueryProperty.DEPLOYMENT_NAME);
  }
