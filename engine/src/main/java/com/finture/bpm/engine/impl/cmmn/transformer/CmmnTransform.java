 ...
 */
package com.finture.bpm.engine.impl.cmmn.transformer;
...
import com.finture.bpm.engine.impl.cmmn.handler.CmmnElementHandler;
import com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext;
import com.finture.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import com.finture.bpm.engine.impl.cmmn.handler.ItemHandler;
...
import com.finture.bpm.engine.impl.core.transformer.Transform;
...
import com.finture.bpm.model.cmmn.CmmnModelException;
...
import com.finture.bpm.model.cmmn.instance.Definitions;
...
public class CmmnTransform implements Transform<CaseDefinitionEntity> {
  ...
  protected void transformCasePlanModel(CasePlanModel casePlanModel) {
    ...
    for (CmmnTransformListener transformListener : transformListeners) {
      transformListener.transformCasePlanModel((com.finture.bpm.model.cmmn.impl.instance.CasePlanModel) casePlanModel, newActivity);
    }
  }
