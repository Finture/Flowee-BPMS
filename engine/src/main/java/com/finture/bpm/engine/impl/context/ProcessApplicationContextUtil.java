...
public class ProcessApplicationContextUtil {
  ...
  public static ProcessApplicationReference getTargetProcessApplication(String deploymentId) {
    ProcessEngineConfigurationImpl processEngineConfiguration = com.finture.bpm.engine.impl.context.Context.getProcessEngineConfiguration();
  ...
  private static void loggContextSwitchDetails(ExecutionEntity execution) {
    ...
    final com.finture.bpm.engine.impl.context.CoreExecutionContext<? extends CoreExecution> executionContext = com.finture.bpm.engine.impl.context.Context.getCoreExecutionContext();
    // only log for first atomic op:
    if(executionContext == null ||( executionContext.getExecution() != execution) ) {
      ProcessApplicationManager processApplicationManager = com.finture.bpm.engine.impl.context.Context.getProcessEngineConfiguration().getProcessApplicationManager();
  ...
  private static void loggContextSwitchDetails(CaseExecutionEntity execution) {
    ...
    final CoreExecutionContext<? extends CoreExecution> executionContext = com.finture.bpm.engine.impl.context.Context.getCoreExecutionContext();
    // only log for first atomic op:
    if(executionContext == null ||( executionContext.getExecution() != execution) ) {
      ProcessApplicationManager processApplicationManager = com.finture.bpm.engine.impl.context.Context.getProcessEngineConfiguration().getProcessApplicationManager();
  ...
  public static boolean requiresContextSwitch(ProcessApplicationReference processApplicationReference) {
    ...
    final ProcessApplicationReference currentProcessApplication = com.finture.bpm.engine.impl.context.Context.getCurrentProcessApplication();
