 ...
 */
package com.finture.bpm.engine.impl.pvm.process;
...
import com.finture.bpm.engine.delegate.BaseDelegateExecution;
import com.finture.bpm.engine.impl.core.delegate.CoreActivityBehavior;
 ...
 * @author Daniel Meyer
 */
public class ProcessDefinitionImpl extends com.finture.bpm.engine.impl.pvm.process.ScopeImpl implements PvmProcessDefinition {

  private static final long serialVersionUID = 1L;

  protected String name;
  protected String description;
  protected com.finture.bpm.engine.impl.pvm.process.ActivityImpl initial;
  protected Map<com.finture.bpm.engine.impl.pvm.process.ActivityImpl, List<com.finture.bpm.engine.impl.pvm.process.ActivityImpl>> initialActivityStacks = new HashMap<com.finture.bpm.engine.impl.pvm.process.ActivityImpl, List<com.finture.bpm.engine.impl.pvm.process.ActivityImpl>>();
  ...
  public PvmProcessInstance createProcessInstance(String businessKey, com.finture.bpm.engine.impl.pvm.process.ActivityImpl initial) {
    return createProcessInstance(businessKey, null, initial);
  }

  public PvmProcessInstance createProcessInstance(String businessKey, String caseInstanceId, com.finture.bpm.engine.impl.pvm.process.ActivityImpl initial) {
  ...
  public PvmProcessInstance createProcessInstanceForInitial(com.finture.bpm.engine.impl.pvm.process.ActivityImpl initial) {
  ...
  public List<com.finture.bpm.engine.impl.pvm.process.ActivityImpl> getInitialActivityStack() {
    return getInitialActivityStack(initial);
  }

  public synchronized List<com.finture.bpm.engine.impl.pvm.process.ActivityImpl> getInitialActivityStack(com.finture.bpm.engine.impl.pvm.process.ActivityImpl startActivity) {
    List<com.finture.bpm.engine.impl.pvm.process.ActivityImpl> initialActivityStack = initialActivityStacks.get(startActivity);
    if(initialActivityStack == null) {
      initialActivityStack = new ArrayList<com.finture.bpm.engine.impl.pvm.process.ActivityImpl>();
      com.finture.bpm.engine.impl.pvm.process.ActivityImpl activity = startActivity;
      while (activity!=null) {
  ...
  public com.finture.bpm.engine.impl.pvm.process.Lane getLaneForId(String id) {
  ...
  public com.finture.bpm.engine.impl.pvm.process.ActivityImpl getInitial() {
    return initial;
  }
