 ...
 */
package com.finture.bpm.engine.impl.cmmn.model;
...
public class CaseDefinitionBuilder {
  ...
  protected com.finture.bpm.engine.impl.cmmn.model.CmmnCaseDefinition caseDefinition;
  protected com.finture.bpm.engine.impl.cmmn.model.CmmnActivity casePlanModel;
  protected Deque<com.finture.bpm.engine.impl.cmmn.model.CmmnActivity> activityStack = new ArrayDeque<>();
  ...
  public CaseDefinitionBuilder(String caseDefinitionId) {
    ...
    caseDefinition = new com.finture.bpm.engine.impl.cmmn.model.CmmnCaseDefinition(caseDefinitionId);
  ...
  public CaseDefinitionBuilder createActivity(String id) {
    com.finture.bpm.engine.impl.cmmn.model.CmmnActivity activity = activityStack.peek().createActivity(id);
