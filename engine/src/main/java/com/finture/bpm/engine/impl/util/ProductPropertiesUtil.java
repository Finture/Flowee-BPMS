...
public class ProductPropertiesUtil {
  ...
  protected static final String PROPERTIES_FILE_PATH = "/com/finture/bpm/engine/product-info.properties";
  protected static final String VERSION_PROPERTY = "flowee-bpms.version";
