 ...
 *   <dt>direction</dt>
 *     <dd>The ordering direction, refer to {@link com.finture.bpm.engine.impl.Direction}</dd>
 ...
 *     is <code>null</code>. Contains instances of {@link com.finture.bpm.engine.impl.QueryEntityRelationCondition}.</dd>
 * <dl>
 * </p>
 *
...
public class QueryOrderingProperty implements Serializable {
  ...
  protected com.finture.bpm.engine.impl.Direction direction;
  protected List<com.finture.bpm.engine.impl.QueryEntityRelationCondition> relationConditions;

  public QueryOrderingProperty() {
  }

  public QueryOrderingProperty(QueryProperty queryProperty, com.finture.bpm.engine.impl.Direction direction) {
  ...
  public void setDirection(com.finture.bpm.engine.impl.Direction direction) {
    this.direction = direction;
  }
  ...
  public List<com.finture.bpm.engine.impl.QueryEntityRelationCondition> getRelationConditions() {
