...
import com.finture.bpm.engine.impl.db.TenantCheck;
...
public class ListQueryParameterObject implements Serializable {
  ...
  protected com.finture.bpm.engine.impl.db.AuthorizationCheck authCheck = new com.finture.bpm.engine.impl.db.AuthorizationCheck();

  protected com.finture.bpm.engine.impl.db.TenantCheck tenantCheck = new com.finture.bpm.engine.impl.db.TenantCheck();
  ...
  public com.finture.bpm.engine.impl.db.AuthorizationCheck getAuthCheck() {
    return authCheck;
  }
  ...
  public com.finture.bpm.engine.impl.db.TenantCheck getTenantCheck() {
    return tenantCheck;
  }
