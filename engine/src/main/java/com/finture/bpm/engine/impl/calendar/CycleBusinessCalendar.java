...
import com.finture.bpm.engine.impl.calendar.CronExpression;
  ...
  public Date resolveDuedate(String duedateDescription, Date startDate, long repeatOffset) {
    try {
      if (duedateDescription.startsWith("R")) {
        ...
        com.finture.bpm.engine.impl.calendar.CronExpression ce = new CronExpression(duedateDescription);
