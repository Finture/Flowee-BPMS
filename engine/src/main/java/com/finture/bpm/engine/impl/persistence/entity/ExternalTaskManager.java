...
import static com.finture.bpm.engine.impl.db.sql.DbSqlSessionFactory.POSTGRES;
import static com.finture.bpm.engine.impl.util.DatabaseUtil.checkDatabaseType;
