...
import com.finture.bpm.engine.identity.PasswordPolicyResult;
import com.finture.bpm.engine.identity.Group;
import com.finture.bpm.engine.identity.GroupQuery;
import com.finture.bpm.engine.identity.NativeUserQuery;
import com.finture.bpm.engine.identity.PasswordPolicy;
import com.finture.bpm.engine.identity.PasswordPolicyRule;
import com.finture.bpm.engine.identity.Picture;
import com.finture.bpm.engine.identity.Tenant;
import com.finture.bpm.engine.identity.TenantQuery;
import com.finture.bpm.engine.identity.User;
import com.finture.bpm.engine.identity.UserQuery;
import com.finture.bpm.engine.impl.cmd.CheckPassword;
import com.finture.bpm.engine.impl.cmd.GetPasswordPolicyCmd;
import com.finture.bpm.engine.impl.cmd.CreateGroupCmd;
import com.finture.bpm.engine.impl.cmd.CreateGroupQueryCmd;
import com.finture.bpm.engine.impl.cmd.CreateMembershipCmd;
import com.finture.bpm.engine.impl.cmd.CreateNativeUserQueryCmd;
import com.finture.bpm.engine.impl.cmd.CreateTenantCmd;
import com.finture.bpm.engine.impl.cmd.CreateTenantGroupMembershipCmd;
import com.finture.bpm.engine.impl.cmd.CreateTenantQueryCmd;
import com.finture.bpm.engine.impl.cmd.CreateTenantUserMembershipCmd;
import com.finture.bpm.engine.impl.cmd.CreateUserCmd;
import com.finture.bpm.engine.impl.cmd.CreateUserQueryCmd;
import com.finture.bpm.engine.impl.cmd.DeleteGroupCmd;
import com.finture.bpm.engine.impl.cmd.DeleteMembershipCmd;
import com.finture.bpm.engine.impl.cmd.DeleteTenantCmd;
import com.finture.bpm.engine.impl.cmd.DeleteTenantGroupMembershipCmd;
import com.finture.bpm.engine.impl.cmd.DeleteTenantUserMembershipCmd;
import com.finture.bpm.engine.impl.cmd.DeleteUserCmd;
import com.finture.bpm.engine.impl.cmd.DeleteUserInfoCmd;
import com.finture.bpm.engine.impl.cmd.DeleteUserPictureCmd;
import com.finture.bpm.engine.impl.cmd.GetUserAccountCmd;
import com.finture.bpm.engine.impl.cmd.GetUserInfoCmd;
import com.finture.bpm.engine.impl.cmd.GetUserInfoKeysCmd;
import com.finture.bpm.engine.impl.cmd.GetUserPictureCmd;
import com.finture.bpm.engine.impl.cmd.IsIdentityServiceReadOnlyCmd;
import com.finture.bpm.engine.impl.cmd.SaveGroupCmd;
import com.finture.bpm.engine.impl.cmd.SaveTenantCmd;
import com.finture.bpm.engine.impl.cmd.SaveUserCmd;
import com.finture.bpm.engine.impl.cmd.SetUserInfoCmd;
import com.finture.bpm.engine.impl.cmd.SetUserPictureCmd;
import com.finture.bpm.engine.impl.cmd.UnlockUserCmd;
import com.finture.bpm.engine.impl.identity.Account;
import com.finture.bpm.engine.impl.identity.Authentication;
import com.finture.bpm.engine.impl.identity.PasswordPolicyResultImpl;
import com.finture.bpm.engine.impl.persistence.entity.IdentityInfoEntity;
