...
import static com.finture.bpm.engine.impl.util.DecisionEvaluationUtil.getDecisionResultMapperForName;
...
import com.finture.bpm.engine.impl.cmmn.handler.CallingTaskItemHandler;
...
public class DecisionTaskItemHandler extends CallingTaskItemHandler {
  ...
  protected void initializeActivity(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
  ...
  protected void initializeResultVariable(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
  ...
  protected void initializeDecisionTableResultMapper(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
    DecisionTask decisionTask = getDefinition(element);
    DmnDecisionTaskActivityBehavior behavior = getActivityBehavior(activity);
  ...
  protected String getDefinitionKey(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
  ...
  protected String getBinding(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
    DecisionTask definition = getDefinition(element);
    return definition.getCamundaDecisionBinding();
  }

  protected String getVersion(CmmnElement element, CmmnActivity activity, com.finture.bpm.engine.impl.cmmn.handler.CmmnHandlerContext context) {
    DecisionTask definition = getDefinition(element);
