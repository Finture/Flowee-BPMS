 ...
 */
package com.finture.bpm.engine.impl.cmmn.entity.repository;
...
import com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty;
...
public class CaseDefinitionQueryImpl extends AbstractQuery<CaseDefinitionQuery, CaseDefinition> implements CaseDefinitionQuery {
  ...
  public CaseDefinitionQuery orderByCaseDefinitionCategory() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.CASE_DEFINITION_CATEGORY);
    return this;
  }

  public CaseDefinitionQuery orderByCaseDefinitionKey() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.CASE_DEFINITION_KEY);
    return this;
  }

  public CaseDefinitionQuery orderByCaseDefinitionId() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.CASE_DEFINITION_ID);
    return this;
  }

  public CaseDefinitionQuery orderByCaseDefinitionVersion() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.CASE_DEFINITION_VERSION);
    return this;
  }

  public CaseDefinitionQuery orderByCaseDefinitionName() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.CASE_DEFINITION_NAME);
    return this;
  }

  public CaseDefinitionQuery orderByDeploymentId() {
    orderBy(com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionQueryProperty.DEPLOYMENT_ID);
    return this;
  }
