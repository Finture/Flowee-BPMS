 ...
 */
package com.finture.bpm.engine.impl.persistence.entity.util;
...
import com.finture.bpm.engine.impl.variable.serializer.ValueFieldsImpl;
...
public class TypedValueField implements DbEntityLifecycleAware, CommandContextListener {
  ...
  protected List<com.finture.bpm.engine.impl.persistence.entity.util.TypedValueUpdateListener> updateListeners;
  ...
  public void notifyImplicitValueUpdateIfEnabled() {
    if (isImplicitVariableUpdateDetectionEnabled() && isValuedImplicitlyUpdated()) {
      for (com.finture.bpm.engine.impl.persistence.entity.util.TypedValueUpdateListener typedValueImplicitUpdateListener : updateListeners) {
