 ...
 */
package com.finture.bpm.engine.impl.cfg.auth;
...
import static com.finture.bpm.engine.authorization.Permissions.CREATE_INSTANCE;
...
import static com.finture.bpm.engine.authorization.Permissions.DELETE_INSTANCE;
...
import static com.finture.bpm.engine.authorization.Permissions.TASK_ASSIGN;
import static com.finture.bpm.engine.authorization.Permissions.TASK_WORK;
...
import static com.finture.bpm.engine.authorization.Permissions.UPDATE_TASK;
...
import com.finture.bpm.engine.authorization.ProcessInstancePermissions;
import com.finture.bpm.engine.authorization.Resources;
import com.finture.bpm.engine.authorization.SystemPermissions;
import com.finture.bpm.engine.authorization.TaskPermissions;
import com.finture.bpm.engine.authorization.UserOperationLogCategoryPermissions;
...
import com.finture.bpm.engine.impl.persistence.entity.HistoricProcessInstanceEntity;
import com.finture.bpm.engine.impl.persistence.entity.HistoricTaskInstanceEntity;
