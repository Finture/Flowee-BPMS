 ...
 */
package com.finture.bpm.engine.impl.identity;
...
import com.finture.bpm.engine.impl.identity.IdentityProviderException;
...
public interface WritableIdentityProvider extends Session {
   ...
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult saveUser(User user);
   ...
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult deleteUser(String userId);
   ...
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult unlockUser(String userId);
   ...
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult saveGroup(Group group);
   ...
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult deleteGroup(String groupId);
   ...
   * @return the operation result object.
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException
   *           in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult saveTenant(Tenant tenant);
   ...
   *           in case an internal error occurs
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult deleteTenant(String tenantId);
   ...
   * @throws com.finture.bpm.engine.impl.identity.IdentityProviderException
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult createMembership(String userId, String groupId);
   ...
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult deleteMembership(String userId, String groupId);
   ...
   * @return the operation result object.
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult createTenantUserMembership(String tenantId, String userId);
   ...
   * @return the operation result object.
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult createTenantGroupMembership(String tenantId, String groupId);
   ...
   * @return the operation result object
   */
  public com.finture.bpm.engine.impl.identity.IdentityOperationResult deleteTenantUserMembership(String tenantId, String userId);
