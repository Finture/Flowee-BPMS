 ...
 */
package com.finture.bpm.engine.impl.tree;
...
import com.finture.bpm.engine.impl.tree.ActivityExecutionTuple;
import com.finture.bpm.engine.impl.tree.ReferenceWalker;
import com.finture.bpm.engine.impl.tree.SingleReferenceWalker;
 ...
 *
 */
public class ActivityExecutionHierarchyWalker extends SingleReferenceWalker<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> {
  ...
  @Override
  protected com.finture.bpm.engine.impl.tree.ActivityExecutionTuple nextElement() {
    com.finture.bpm.engine.impl.tree.ActivityExecutionTuple currentElement = getCurrentElement();
    ...
    if (!currentExecution.isScope()) {
      ...
      return new com.finture.bpm.engine.impl.tree.ActivityExecutionTuple(currentScope, currentExecution);
    } else if (flowScope != null) {
      // walk to parent scope
      PvmExecutionImpl execution = activityExecutionMapping.get(flowScope);
      return new com.finture.bpm.engine.impl.tree.ActivityExecutionTuple(flowScope, execution);
    } else {
  ...
  protected static com.finture.bpm.engine.impl.tree.ActivityExecutionTuple createTuple(ActivityExecution execution) {
  ...
  public ReferenceWalker<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> addScopePreVisitor(TreeVisitor<PvmScope> visitor) {
    return addPreVisitor(new ScopeVisitorWrapper(visitor));
  }

  public ReferenceWalker<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> addScopePostVisitor(TreeVisitor<PvmScope> visitor) {
    return addPostVisitor(new ScopeVisitorWrapper(visitor));
  }

  public ReferenceWalker<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> addExecutionPreVisitor(TreeVisitor<ActivityExecution> visitor) {
    return addPreVisitor(new ExecutionVisitorWrapper(visitor));
  }

  public ReferenceWalker<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> addExecutionPostVisitor(TreeVisitor<ActivityExecution> visitor) {
    return addPostVisitor(new ExecutionVisitorWrapper(visitor));
  }

  private class ExecutionVisitorWrapper implements TreeVisitor<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> {
    ...
    @Override
    public void visit(com.finture.bpm.engine.impl.tree.ActivityExecutionTuple tuple) {
      collector.visit(tuple.getExecution());
    }
  }

  private class ScopeVisitorWrapper implements TreeVisitor<com.finture.bpm.engine.impl.tree.ActivityExecutionTuple> {
