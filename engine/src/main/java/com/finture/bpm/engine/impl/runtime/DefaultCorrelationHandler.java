...
public class DefaultCorrelationHandler implements CorrelationHandler {
  ...
  public com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult correlateMessage(CommandContext commandContext, String messageName, CorrelationSet correlationSet) {
    ...
    List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> correlations = correlateMessageToExecutions(commandContext, messageName, correlationSet);
  ...
  public List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> correlateMessages(CommandContext commandContext, String messageName, CorrelationSet correlationSet) {
    List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> results = new ArrayList<>();
  ...
  protected List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> correlateMessageToExecutions(CommandContext commandContext, String messageName, CorrelationSet correlationSet) {
    ...
    List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> result = new ArrayList<>(matchingExecutions.size());

    for (Execution matchingExecution : matchingExecutions) {
      com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult correlationResult = com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult.matchedExecution((ExecutionEntity) matchingExecution);
  ...
  @Override
  public List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> correlateStartMessages(CommandContext commandContext, String messageName, CorrelationSet correlationSet) {
    if (messageName == null) {
    ...
    if (correlationSet.getProcessDefinitionId() == null) {
      ...
      com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult correlationResult = correlateStartMessageByProcessDefinitionId(commandContext, messageName, correlationSet.getProcessDefinitionId());
  ...
  protected List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> correlateStartMessageByEventSubscription(CommandContext commandContext, String messageName, CorrelationSet correlationSet) {
    List<com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult> results = new ArrayList<>();
    ...
    for (EventSubscriptionEntity messageEventSubscription : messageEventSubscriptions) {
      ...
      if (messageEventSubscription.getConfiguration() != null) {
        ...
        if (processDefinition != null && !processDefinition.isSuspended()) {
          com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult result = com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult.matchedProcessDefinition(processDefinition, messageEventSubscription.getActivityId());
          results.add(result);
  ...
  protected com.finture.bpm.engine.impl.runtime.CorrelationHandlerResult correlateStartMessageByProcessDefinitionId(CommandContext commandContext, String messageName, String processDefinitionId) {
    DeploymentCache deploymentCache = commandContext.getProcessEngineConfiguration().getDeploymentCache();
    ProcessDefinitionEntity processDefinition = deploymentCache.findDeployedProcessDefinitionById(processDefinitionId);
    // only an active process definition will be returned
    if (processDefinition != null && !processDefinition.isSuspended()) {
