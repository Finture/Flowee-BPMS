...
import com.finture.bpm.engine.impl.cmd.StartProcessInstanceAtActivitiesCmd;
import com.finture.bpm.engine.impl.cmd.StartProcessInstanceCmd;
...
public class ProcessInstantiationBuilderImpl implements ProcessInstantiationBuilder {
  ...
  protected com.finture.bpm.engine.impl.ProcessInstanceModificationBuilderImpl modificationBuilder;

  protected ProcessInstantiationBuilderImpl(CommandExecutor commandExecutor) {
    modificationBuilder = new com.finture.bpm.engine.impl.ProcessInstanceModificationBuilderImpl();
  ...
  public com.finture.bpm.engine.impl.ProcessInstanceModificationBuilderImpl getModificationBuilder() {
