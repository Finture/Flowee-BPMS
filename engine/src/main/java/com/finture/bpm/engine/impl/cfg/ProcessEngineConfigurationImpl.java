 ...
 */
package com.finture.bpm.engine.impl.cfg;


import static com.finture.bpm.engine.impl.cmd.HistoryCleanupCmd.MAX_THREADS_NUMBER;
...
import com.finture.bpm.dmn.engine.DmnEngine;
import com.finture.bpm.dmn.engine.DmnEngineConfiguration;
import com.finture.bpm.dmn.engine.impl.DefaultDmnEngineConfiguration;
import com.finture.bpm.dmn.engine.impl.spi.el.ElProvider;
import com.finture.bpm.dmn.feel.impl.scala.function.FeelCustomFunctionProvider;
import com.finture.bpm.engine.ArtifactFactory;
...
import com.finture.bpm.engine.impl.AuthorizationServiceImpl;
import com.finture.bpm.engine.impl.DecisionServiceImpl;
import com.finture.bpm.engine.impl.DefaultArtifactFactory;
import com.finture.bpm.engine.impl.ExternalTaskServiceImpl;
import com.finture.bpm.engine.impl.FilterServiceImpl;
import com.finture.bpm.engine.impl.FormServiceImpl;
import com.finture.bpm.engine.impl.HistoryServiceImpl;
import com.finture.bpm.engine.impl.IdentityServiceImpl;
import com.finture.bpm.engine.impl.ManagementServiceImpl;
import com.finture.bpm.engine.impl.ModificationBatchJobHandler;
import com.finture.bpm.engine.impl.OptimizeService;
import com.finture.bpm.engine.impl.PriorityProvider;
import com.finture.bpm.engine.impl.ProcessEngineImpl;
import com.finture.bpm.engine.impl.ProcessEngineLogger;
import com.finture.bpm.engine.impl.RepositoryServiceImpl;
import com.finture.bpm.engine.impl.RestartProcessInstancesJobHandler;
import com.finture.bpm.engine.impl.RuntimeServiceImpl;
import com.finture.bpm.engine.impl.ServiceImpl;
import com.finture.bpm.engine.impl.TaskServiceImpl;
import com.finture.bpm.engine.impl.application.ProcessApplicationManager;
import com.finture.bpm.engine.impl.batch.BatchJobHandler;
import com.finture.bpm.engine.impl.batch.BatchMonitorJobHandler;
import com.finture.bpm.engine.impl.batch.BatchSeedJobHandler;
import com.finture.bpm.engine.impl.batch.deletion.DeleteHistoricProcessInstancesJobHandler;
import com.finture.bpm.engine.impl.batch.deletion.DeleteProcessInstancesJobHandler;
import com.finture.bpm.engine.impl.batch.externaltask.SetExternalTaskRetriesJobHandler;
import com.finture.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import com.finture.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import com.finture.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import com.finture.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import com.finture.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import com.finture.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import com.finture.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
import com.finture.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import com.finture.bpm.engine.impl.bpmn.deployer.BpmnDeployer;
import com.finture.bpm.engine.impl.bpmn.parser.BpmnParseListener;
import com.finture.bpm.engine.impl.bpmn.parser.BpmnParser;
import com.finture.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener;
import com.finture.bpm.engine.impl.calendar.BusinessCalendarManager;
import com.finture.bpm.engine.impl.calendar.CycleBusinessCalendar;
import com.finture.bpm.engine.impl.calendar.DueDateBusinessCalendar;
import com.finture.bpm.engine.impl.calendar.DurationBusinessCalendar;
import com.finture.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import com.finture.bpm.engine.impl.cfg.*;
import com.finture.bpm.engine.impl.cfg.CommandChecker;
import com.finture.bpm.engine.impl.cfg.ConfigurationLogger;
import com.finture.bpm.engine.impl.cfg.ProcessEnginePlugin;
import com.finture.bpm.engine.impl.cfg.TransactionContextFactory;
import com.finture.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
import com.finture.bpm.engine.impl.cfg.auth.DefaultAuthorizationProvider;
import com.finture.bpm.engine.impl.cfg.auth.DefaultPermissionProvider;
import com.finture.bpm.engine.impl.cfg.auth.PermissionProvider;
import com.finture.bpm.engine.impl.cfg.auth.ResourceAuthorizationProvider;
import com.finture.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
import com.finture.bpm.engine.impl.cfg.multitenancy.TenantIdProvider;
import com.finture.bpm.engine.impl.cfg.standalone.StandaloneTransactionContextFactory;
import com.finture.bpm.engine.impl.cmd.HistoryCleanupCmd;
import com.finture.bpm.engine.impl.cmmn.CaseServiceImpl;
import com.finture.bpm.engine.impl.cmmn.deployer.CmmnDeployer;
import com.finture.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionManager;
import com.finture.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionManager;
import com.finture.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartManager;
import com.finture.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import com.finture.bpm.engine.impl.cmmn.transformer.CmmnTransformFactory;
import com.finture.bpm.engine.impl.cmmn.transformer.CmmnTransformListener;
import com.finture.bpm.engine.impl.cmmn.transformer.CmmnTransformer;
import com.finture.bpm.engine.impl.cmmn.transformer.DefaultCmmnTransformFactory;
import com.finture.bpm.engine.impl.db.DbIdGenerator;
import com.finture.bpm.engine.impl.db.entitymanager.DbEntityManagerFactory;
import com.finture.bpm.engine.impl.db.entitymanager.cache.DbEntityCacheKeyMapping;
import com.finture.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import com.finture.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import com.finture.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import com.finture.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import com.finture.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import com.finture.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import com.finture.bpm.engine.impl.digest.PasswordEncryptor;
import com.finture.bpm.engine.impl.digest.PasswordManager;
import com.finture.bpm.engine.impl.digest.SaltGenerator;
import com.finture.bpm.engine.impl.digest.Sha512HashDigest;
import com.finture.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import com.finture.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import com.finture.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import com.finture.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
import com.finture.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionManager;
import com.finture.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionManager;
import com.finture.bpm.engine.impl.el.CommandContextFunctions;
import com.finture.bpm.engine.impl.el.DateTimeFunctions;
import com.finture.bpm.engine.impl.el.ElProviderCompatible;
import com.finture.bpm.engine.impl.el.ExpressionManager;
import com.finture.bpm.engine.impl.el.JuelExpressionManager;
import com.finture.bpm.engine.impl.errorcode.ExceptionCodeProvider;
import com.finture.bpm.engine.impl.event.CompensationEventHandler;
import com.finture.bpm.engine.impl.event.ConditionalEventHandler;
import com.finture.bpm.engine.impl.event.EventHandler;
import com.finture.bpm.engine.impl.event.EventHandlerImpl;
import com.finture.bpm.engine.impl.event.EventType;
import com.finture.bpm.engine.impl.event.SignalEventHandler;
import com.finture.bpm.engine.impl.externaltask.DefaultExternalTaskPriorityProvider;
import com.finture.bpm.engine.impl.form.deployer.CamundaFormDefinitionDeployer;
import com.finture.bpm.engine.impl.form.engine.FormEngine;
import com.finture.bpm.engine.impl.form.engine.HtmlFormEngine;
import com.finture.bpm.engine.impl.form.engine.JuelFormEngine;
import com.finture.bpm.engine.impl.form.entity.CamundaFormDefinitionManager;
import com.finture.bpm.engine.impl.form.type.AbstractFormFieldType;
import com.finture.bpm.engine.impl.form.type.BooleanFormType;
import com.finture.bpm.engine.impl.form.type.DateFormType;
import com.finture.bpm.engine.impl.form.type.FormTypes;
import com.finture.bpm.engine.impl.form.type.LongFormType;
import com.finture.bpm.engine.impl.form.type.StringFormType;
import com.finture.bpm.engine.impl.form.validator.FormFieldValidator;
import com.finture.bpm.engine.impl.form.validator.FormValidators;
import com.finture.bpm.engine.impl.form.validator.MaxLengthValidator;
import com.finture.bpm.engine.impl.form.validator.MaxValidator;
import com.finture.bpm.engine.impl.form.validator.MinLengthValidator;
import com.finture.bpm.engine.impl.form.validator.MinValidator;
import com.finture.bpm.engine.impl.form.validator.ReadOnlyValidator;
import com.finture.bpm.engine.impl.form.validator.RequiredValidator;
import com.finture.bpm.engine.impl.history.DefaultHistoryRemovalTimeProvider;
import com.finture.bpm.engine.impl.history.HistoryLevel;
import com.finture.bpm.engine.impl.history.HistoryRemovalTimeProvider;
import com.finture.bpm.engine.impl.history.event.HistoricDecisionInstanceManager;
import com.finture.bpm.engine.impl.history.event.HostnameProvider;
import com.finture.bpm.engine.impl.history.event.SimpleIpBasedProvider;
import com.finture.bpm.engine.impl.history.handler.CompositeDbHistoryEventHandler;
import com.finture.bpm.engine.impl.history.handler.CompositeHistoryEventHandler;
import com.finture.bpm.engine.impl.history.handler.DbHistoryEventHandler;
import com.finture.bpm.engine.impl.history.handler.HistoryEventHandler;
import com.finture.bpm.engine.impl.history.parser.HistoryParseListener;
import com.finture.bpm.engine.impl.history.producer.CacheAwareCmmnHistoryEventProducer;
import com.finture.bpm.engine.impl.history.producer.CacheAwareHistoryEventProducer;
import com.finture.bpm.engine.impl.history.producer.CmmnHistoryEventProducer;
import com.finture.bpm.engine.impl.history.producer.DefaultDmnHistoryEventProducer;
import com.finture.bpm.engine.impl.history.producer.DmnHistoryEventProducer;
import com.finture.bpm.engine.impl.history.producer.HistoryEventProducer;
import com.finture.bpm.engine.impl.history.transformer.CmmnHistoryTransformListener;
import com.finture.bpm.engine.impl.identity.DefaultPasswordPolicyImpl;
import com.finture.bpm.engine.impl.identity.ReadOnlyIdentityProvider;
import com.finture.bpm.engine.impl.identity.WritableIdentityProvider;
import com.finture.bpm.engine.impl.identity.db.DbIdentityServiceProvider;
import com.finture.bpm.engine.impl.incident.CompositeIncidentHandler;
import com.finture.bpm.engine.impl.incident.DefaultIncidentHandler;
import com.finture.bpm.engine.impl.incident.IncidentHandler;
import com.finture.bpm.engine.impl.interceptor.CommandContextFactory;
import com.finture.bpm.engine.impl.interceptor.CommandExecutor;
import com.finture.bpm.engine.impl.interceptor.CommandExecutorImpl;
import com.finture.bpm.engine.impl.interceptor.CommandInterceptor;
import com.finture.bpm.engine.impl.interceptor.DelegateInterceptor;
import com.finture.bpm.engine.impl.interceptor.ExceptionCodeInterceptor;
import com.finture.bpm.engine.impl.interceptor.SessionFactory;
import com.finture.bpm.engine.impl.jobexecutor.AsyncContinuationJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.DefaultFailedJobCommandFactory;
import com.finture.bpm.engine.impl.jobexecutor.DefaultJobExecutor;
import com.finture.bpm.engine.impl.jobexecutor.DefaultJobPriorityProvider;
import com.finture.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
import com.finture.bpm.engine.impl.jobexecutor.JobDeclaration;
import com.finture.bpm.engine.impl.jobexecutor.JobExecutor;
import com.finture.bpm.engine.impl.jobexecutor.JobHandler;
import com.finture.bpm.engine.impl.jobexecutor.NotifyAcquisitionRejectedJobsHandler;
import com.finture.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerCatchIntermediateEventJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerExecuteNestedActivityJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerStartEventJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerStartEventSubprocessJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerSuspendJobDefinitionHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
import com.finture.bpm.engine.impl.jobexecutor.TimerTaskListenerJobHandler;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.BatchWindowManager;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.DefaultBatchWindowManager;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobHandler;
import com.finture.bpm.engine.impl.metrics.MetricsRegistry;
import com.finture.bpm.engine.impl.metrics.MetricsReporterIdProvider;
import com.finture.bpm.engine.impl.metrics.parser.MetricsBpmnParseListener;
import com.finture.bpm.engine.impl.metrics.parser.MetricsCmmnTransformListener;
import com.finture.bpm.engine.impl.metrics.reporter.DbMetricsReporter;
import com.finture.bpm.engine.impl.migration.DefaultMigrationActivityMatcher;
import com.finture.bpm.engine.impl.migration.DefaultMigrationInstructionGenerator;
import com.finture.bpm.engine.impl.migration.MigrationActivityMatcher;
import com.finture.bpm.engine.impl.migration.MigrationInstructionGenerator;
import com.finture.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import com.finture.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.MigratingActivityInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.MigratingCompensationInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.MigratingTransitionInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.NoUnmappedCompensationStartEventValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.NoUnmappedLeafInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.SupportedActivityInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instance.VariableConflictActivityInstanceValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.AdditionalFlowScopeInstructionValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceInnerActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.CannotRemoveMultiInstanceInnerActivityValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.GatewayMappingValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.MigrationInstructionValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.OnlyOnceMappedActivityInstructionValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.SameBehaviorInstructionValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.SameEventScopeInstructionValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.SameEventTypeValidator;
import com.finture.bpm.engine.impl.migration.validation.instruction.UpdateEventTriggersValidator;
import com.finture.bpm.engine.impl.optimize.OptimizeManager;
import com.finture.bpm.engine.impl.persistence.GenericManagerFactory;
import com.finture.bpm.engine.impl.persistence.deploy.Deployer;
import com.finture.bpm.engine.impl.persistence.deploy.cache.CacheFactory;
import com.finture.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
import com.finture.bpm.engine.impl.persistence.deploy.cache.DeploymentCache;
import com.finture.bpm.engine.impl.persistence.entity.AttachmentManager;
import com.finture.bpm.engine.impl.persistence.entity.AuthorizationManager;
import com.finture.bpm.engine.impl.persistence.entity.BatchManager;
import com.finture.bpm.engine.impl.persistence.entity.ByteArrayManager;
import com.finture.bpm.engine.impl.persistence.entity.CommentManager;
import com.finture.bpm.engine.impl.persistence.entity.DeploymentManager;
import com.finture.bpm.engine.impl.persistence.entity.EventSubscriptionManager;
import com.finture.bpm.engine.impl.persistence.entity.ExecutionManager;
import com.finture.bpm.engine.impl.persistence.entity.ExternalTaskManager;
import com.finture.bpm.engine.impl.persistence.entity.FilterManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricActivityInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricBatchManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricCaseActivityInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricCaseInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricDetailManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricExternalTaskLogManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricIdentityLinkLogManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricIncidentManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricJobLogManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricProcessInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricTaskInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.HistoricVariableInstanceManager;
import com.finture.bpm.engine.impl.persistence.entity.IdentityInfoManager;
import com.finture.bpm.engine.impl.persistence.entity.IdentityLinkManager;
import com.finture.bpm.engine.impl.persistence.entity.IncidentManager;
import com.finture.bpm.engine.impl.persistence.entity.JobDefinitionManager;
import com.finture.bpm.engine.impl.persistence.entity.JobManager;
import com.finture.bpm.engine.impl.persistence.entity.MeterLogManager;
import com.finture.bpm.engine.impl.persistence.entity.ProcessDefinitionManager;
import com.finture.bpm.engine.impl.persistence.entity.PropertyManager;
import com.finture.bpm.engine.impl.persistence.entity.ReportManager;
import com.finture.bpm.engine.impl.persistence.entity.ResourceManager;
import com.finture.bpm.engine.impl.persistence.entity.SchemaLogManager;
import com.finture.bpm.engine.impl.persistence.entity.StatisticsManager;
import com.finture.bpm.engine.impl.persistence.entity.TableDataManager;
import com.finture.bpm.engine.impl.persistence.entity.TaskManager;
import com.finture.bpm.engine.impl.persistence.entity.TaskReportManager;
import com.finture.bpm.engine.impl.persistence.entity.TenantManager;
import com.finture.bpm.engine.impl.persistence.entity.UserOperationLogManager;
import com.finture.bpm.engine.impl.persistence.entity.VariableInstanceManager;
import com.finture.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import com.finture.bpm.engine.impl.runtime.ConditionHandler;
import com.finture.bpm.engine.impl.runtime.CorrelationHandler;
import com.finture.bpm.engine.impl.runtime.DefaultConditionHandler;
import com.finture.bpm.engine.impl.runtime.DefaultCorrelationHandler;
import com.finture.bpm.engine.impl.runtime.DefaultDeserializationTypeValidator;
import com.finture.bpm.engine.impl.scripting.ScriptFactory;
import com.finture.bpm.engine.impl.scripting.engine.BeansResolverFactory;
...
import com.finture.bpm.engine.impl.scripting.engine.ScriptEngineResolver;
import com.finture.bpm.engine.impl.scripting.engine.ScriptingEngines;
import com.finture.bpm.engine.impl.scripting.engine.VariableScopeResolverFactory;
import com.finture.bpm.engine.impl.scripting.env.ScriptEnvResolver;
import com.finture.bpm.engine.impl.scripting.env.ScriptingEnvironment;
import com.finture.bpm.engine.impl.telemetry.dto.DatabaseImpl;
import com.finture.bpm.engine.impl.telemetry.dto.InternalsImpl;
import com.finture.bpm.engine.impl.telemetry.dto.JdkImpl;
import com.finture.bpm.engine.impl.telemetry.dto.ProductImpl;
...
import com.finture.bpm.engine.impl.util.ParseUtil;
import com.finture.bpm.engine.impl.util.ProcessEngineDetails;
import com.finture.bpm.engine.impl.util.ReflectUtil;
import com.finture.bpm.engine.impl.variable.ValueTypeResolverImpl;
import com.finture.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.DateValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import com.finture.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.FileValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import com.finture.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import com.finture.bpm.engine.impl.variable.serializer.NullValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.StringValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.TypedValueSerializer;
import com.finture.bpm.engine.impl.variable.serializer.VariableSerializerFactory;
import com.finture.bpm.engine.impl.variable.serializer.VariableSerializers;
...
import com.finture.bpm.engine.repository.DeploymentHandlerFactory;
import com.finture.bpm.engine.runtime.Incident;
import com.finture.bpm.engine.runtime.WhitelistingDeserializationTypeValidator;
import com.finture.bpm.engine.task.TaskQuery;
import com.finture.bpm.engine.test.mock.MocksResolverFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  protected static com.finture.bpm.engine.impl.cfg.ConfigurationLogger LOG = ConfigurationLogger.CONFIG_LOGGER;
  ...
  public static final String DEFAULT_WS_SYNC_FACTORY = "com.finture.bpm.engine.impl.webservice.CxfWebServiceClientFactory";

  public static final String DEFAULT_MYBATIS_MAPPING_FILE = "com/finture/bpm/engine/impl/mapping/mappings.xml";
  ...
  protected com.finture.bpm.engine.impl.cfg.TransactionContextFactory transactionContextFactory;
  ...
  protected List<com.finture.bpm.engine.impl.cfg.ProcessEnginePlugin> processEnginePlugins = new ArrayList<>();
  ...
  protected List<com.finture.bpm.engine.impl.cfg.CommandChecker> commandCheckers = null;
  ...
  protected void invokePreInit() {
    for (com.finture.bpm.engine.impl.cfg.ProcessEnginePlugin plugin : processEnginePlugins) {
    ...
    synchronized (ProcessEngineConfigurationImpl.class) {
      ...
      if (sqlSessionFactory == null) {
        ...
        try {
          ...
          if (isUseSharedSqlSessionFactory) {
            properties.put("prefix", "${@com.finture.bpm.engine.impl.context.Context@getProcessEngineConfiguration().databaseTablePrefix}");
          } else {
  ...
  public com.finture.bpm.engine.impl.cfg.TransactionContextFactory getTransactionContextFactory() {
  ...
  public List<com.finture.bpm.engine.impl.cfg.ProcessEnginePlugin> getProcessEnginePlugins() {
  ...
  public List<com.finture.bpm.engine.impl.cfg.CommandChecker> getCommandCheckers() {
