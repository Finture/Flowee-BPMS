 ...
 */
package com.finture.bpm.engine.repository;
 ...
 *
 * <p>A builder instance can be obtained through {@link com.finture.bpm.engine.RepositoryService#createDeployment()}.</p>
 *
...
public interface DeploymentBuilder {
   ...
   *
   *
   * <p> The returned {@link com.finture.bpm.engine.repository.Deployment} instance has no information about the definitions, which are deployed
   * with that deployment. To access this information you can use the {@link #deployWithResult()} method.
   * This method will return an instance of {@link com.finture.bpm.engine.repository.DeploymentWithDefinitions}, which contains the information
