...
import com.finture.bpm.engine.repository.DeleteProcessDefinitionsSelectBuilder;
...
import com.finture.bpm.engine.repository.UpdateProcessDefinitionSuspensionStateBuilder;
import com.finture.bpm.engine.repository.UpdateProcessDefinitionSuspensionStateSelectBuilder;
...
public interface RepositoryService {
   ...
   *           </ul>
   *
   * @see com.finture.bpm.engine.RuntimeService#suspendProcessInstanceById(String)
   */
   ...
   *           </ul>
   *
   * @see com.finture.bpm.engine.RuntimeService#activateProcessInstanceById(String)
   */
   ...
   * @param historyTimeToLive    the value of history time to live to update
   * @throws com.finture.bpm.engine.AuthorizationException If the user has no {@link Permissions#UPDATE} permission on {@link Resources#DECISION_DEFINITION}.
   * @throws NotAllowedException    in case feature flag {@code enforceHistoryTimeToLive} is set to {@code true} and the given historyTimeToLive value is {@code null}.
   */
   ...
   *     case definition id
   * @throws com.finture.bpm.engine.ProcessEngineException when an internal exception happens during the execution
   *     of the command.
   */
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when an internal exception happens during the execution of the command.
   * @throws com.finture.bpm.engine.AuthorizationException
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when the process diagram doesn't exist.
   */
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when the decision diagram doesn't exist.
   * @throws com.finture.bpm.engine.AuthorizationException
   *          If the user has no {@link Permissions#READ} permission on {@link Resources#DECISION_DEFINITION}.
   */
