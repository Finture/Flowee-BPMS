...
public interface HistoryService {
   ...
   * {@link com.finture.bpm.engine.TaskService#newTask() dynamically created} and then {@link TaskService#complete(String) completed}.
   ...
   * @throws com.finture.bpm.engine.ProcessEngineException when no historic job log exists with the given id.
   *
   * @throws com.finture.bpm.engine.AuthorizationException
   ...
   *
   * <p>Subsequent builder methods throw {@link com.finture.bpm.engine.AuthorizationException} when the user has no
  ...
  /**
   * Creates a query to search for {@link com.finture.bpm.engine.batch.history.HistoricBatch} instances.
   *
   * @since 7.5
   */
