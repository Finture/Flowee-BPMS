 ...
 */
package com.finture.bpm.application;

import java.util.Map;
import java.util.concurrent.Callable;

import com.finture.bpm.ProcessApplicationService;
import com.finture.bpm.application.*;
 ...
 *  <li> com.finture.bpm.engine.spring.application.SpringProcessApplication: To be used for bootstrapping the process application from a Spring Application Context.</li>
 * </ul>
 * </li>
...
public interface ProcessApplicationInterface {
   ...
   */
  public <T> T execute(Callable<T> callable) throws com.finture.bpm.application.ProcessApplicationExecutionException;
