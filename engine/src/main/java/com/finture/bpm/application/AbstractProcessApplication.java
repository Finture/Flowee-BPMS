...
import com.finture.bpm.application.impl.DefaultElResolverLookup;
import com.finture.bpm.application.impl.ProcessApplicationLogger;
import com.finture.bpm.application.impl.ProcessApplicationScriptEnvironment;
...
public abstract class AbstractProcessApplication implements ProcessApplicationInterface {
   ...
   * <code>META-INF/com.finture.bpm.application.ProcessApplicationElResolver</code> inside your application
