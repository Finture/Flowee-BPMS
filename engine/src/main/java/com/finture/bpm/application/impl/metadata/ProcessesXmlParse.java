 ...
 */
package com.finture.bpm.application.impl.metadata;

import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.NAME;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS_ARCHIVE;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.PROCESS_ENGINE;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.PROPERTIES;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.RESOURCE;
import static com.finture.bpm.container.impl.metadata.DeploymentMetadataConstants.TENANT_ID;
...
import com.finture.bpm.container.impl.metadata.DeploymentMetadataParse;
import com.finture.bpm.container.impl.metadata.spi.ProcessEngineXml;
import com.finture.bpm.engine.impl.util.xml.Element;
import com.finture.bpm.engine.impl.util.xml.Parse;
import com.finture.bpm.engine.impl.util.xml.Parser;
