 ...
 */
package com.finture.bpm.container.impl.parser;
...
import com.finture.bpm.container.impl.metadata.BpmPlatformXmlParser;
...
public class BpmPlatformXmlParserTest {
  ...
  public void testParseBpmPlatformXmlNoEngine() {
    ...
    assertEquals("com.finture.bpm.engine.impl.jobexecutor.DefaultJobExecutor", jobAcquisitionXml.getJobExecutorClassName());
  ...
  public void testParseBpmPlatformXmlEnginePlugin() {
    ...
    assertEquals("com.finture.bpm.MyAwesomePlugin", plugin1.getPluginClass());
