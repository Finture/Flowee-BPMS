...
public class ProcessApplicationEventListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
          "com/finture/bpm/application/impl/event/pa.event.listener.camunda.cfg.xml");
  @Rule
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/application/impl/event/ProcessApplicationEventListenerTest.testExecutionListener.bpmn20.xml" })
