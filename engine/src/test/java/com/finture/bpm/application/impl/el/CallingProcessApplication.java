 ...
 */
package com.finture.bpm.application.impl.el;
...
import com.finture.bpm.engine.impl.el.ReadOnlyMapELResolver;
...
@ProcessApplication(
    value="calling-app",
    deploymentDescriptors={"com/finture/bpm/application/impl/el/calling-process-app.xml"}
)
