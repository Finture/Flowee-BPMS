...
import com.finture.bpm.engine.test.api.delegate.AssertingTaskListener;
import com.finture.bpm.engine.test.api.delegate.AssertingTaskListener.DelegateTaskAsserter;
...
public class MultiTenancyDelegateTaskTest extends PluggableProcessEngineTest {
  ...
  protected static final String BPMN = "com/finture/bpm/engine/test/api/multitenancy/taskListener.bpmn";
