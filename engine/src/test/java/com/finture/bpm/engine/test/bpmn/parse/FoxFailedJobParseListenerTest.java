...
import static com.finture.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener.FAILED_JOB_CONFIGURATION;
...
public class FoxFailedJobParseListenerTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testUserTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/bpmn/parse/CamundaFailedJobParseListenerTest.testUserTask.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testTimer.bpmn20.xml" })
  @Test
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/bpmn/parse/FoxFailedJobParseListenerTest.testSignal.bpmn20.xml" })
  @Test
