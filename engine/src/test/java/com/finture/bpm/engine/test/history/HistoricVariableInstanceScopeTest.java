...
public class HistoricVariableInstanceScopeTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/oneSubProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/history/HistoricVariableInstanceScopeTest.testSetVariableLocalOnTaskInsideParallelBranch.bpmn"})
  @Test
