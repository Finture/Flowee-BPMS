...
import com.finture.bpm.model.bpmn.instance.TerminateEventDefinition;
...
public class HistoricProcessInstanceStateTest {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/history/HistoricProcessInstanceStateTest.testWithCallActivity.bpmn"})
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/history/CAM-9934.bpmn"})
