...
import com.finture.bpm.engine.impl.jobexecutor.CallerRunsRejectedJobsHandler;
...
import com.finture.bpm.engine.test.jobexecutor.ControllableJobExecutor;
...
public class JobExecutorMetricsTest extends AbstractMetricsTest {
  ...
  @Deployment(resources = "com/finture/bpm/engine/test/api/mgmt/metrics/asyncServiceTaskProcess.bpmn20.xml")
  @Test
