 ...
 */
package com.finture.bpm.engine.test.api.multitenancy.tenantcheck;
 ...
 protected static final String TENANT_ONE = "tenant1";
  ...
  public void testGetStartFormWithAuthenticatedTenant() {
    ...
    testRule.deployForTenant(TENANT_ONE,
      "com/finture/bpm/engine/test/api/authorization/formKeyProcess.bpmn20.xml");
  ...
  public void testGetStartFormKeyWithAuthenticatedTenant() {
    ...
    testRule.deployForTenant(TENANT_ONE, "com/finture/bpm/engine/test/api/authorization/formKeyProcess.bpmn20.xml");
  ...
  public void testGetRenderedTaskFormWithAuthenticatedTenant() {
    ...
    // deploy tenants
    testRule.deployForTenant(TENANT_ONE,
      "com/finture/bpm/engine/test/api/form/FormsProcess.bpmn20.xml",
      "com/finture/bpm/engine/test/api/form/task.html").getId();
