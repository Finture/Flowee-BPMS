...
@Deployment(resources = "com/finture/bpm/engine/test/jobexecutor/JobExecutorAcquireJobsForPriorityRangeTest.jobPrioProcess.bpmn20.xml")
public class JobExecutorAcquireJobsForPriorityRangeTest extends AbstractJobExecutorAcquireJobsTest {
  ...
  @Test
  @WatchLogger(loggerNames = "com.finture.bpm.engine.impl.persistence.entity.JobEntity", level = "debug")
