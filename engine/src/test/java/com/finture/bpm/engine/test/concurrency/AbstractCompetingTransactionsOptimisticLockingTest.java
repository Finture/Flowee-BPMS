...
public abstract class AbstractCompetingTransactionsOptimisticLockingTest {
  ...
  @Deployment(resources = "com/finture/bpm/engine/test/concurrency/AbstractCompetingTransactionsOptimisticLockingTest.shouldDetectConcurrentDeletionOfExecutionForTaskInsert.bpmn20.xml")
  @Test
  ...
  public void shouldTreatConcurrentDeletionOfExecutionForTaskInsertAsForeignKeyException() {
    ...
    assertThat(thread1.exception)
      ...
      .extracting("code")
      .asList().contains(BuiltinExceptionCode.FOREIGN_KEY_CONSTRAINT_VIOLATION.getCode());
  }
