...
public class CompetingParentCompletionTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingParentCompletionTest.testComplete.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingParentCompletionTest.testDisable.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingParentCompletionTest.testTerminate.cmmn"})
  @Test
