...
public class CaseServiceStageTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/oneStageCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/oneTaskAndOneStageCase.cmmn"})
  @Test
