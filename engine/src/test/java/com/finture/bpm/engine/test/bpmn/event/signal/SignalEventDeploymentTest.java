...
public class SignalEventDeploymentTest extends PluggableProcessEngineTest {
  ...
  private static final String SIGNAL_START_EVENT_PROCESS = "com/finture/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent.bpmn20.xml";
  private static final String SIGNAL_START_EVENT_PROCESS_NEW_VERSION = "com/finture/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent_v2.bpmn20.xml";
  ...
  public void testAsyncSignalStartEventDeleteDeploymentWhileAsync() {
    ...
    com.finture.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("com/finture/bpm/engine/test/bpmn/event/signal/SignalEventTest.signalStartEvent.bpmn20.xml")
          .addClasspathResource("com/finture/bpm/engine/test/bpmn/event/signal/SignalEventTests.throwAlertSignalAsync.bpmn20.xml")
          .deploy();
