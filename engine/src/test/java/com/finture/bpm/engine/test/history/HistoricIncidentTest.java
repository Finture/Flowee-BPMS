...
public class HistoricIncidentTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/history/HistoricIncidentQueryTest.testQueryByCauseIncidentId.bpmn20.xml",
  "com/finture/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/history/HistoricIncidentTest.testCreateRecursiveHistoricIncidentsForNestedCallActivities.bpmn20.xml",
      "com/finture/bpm/engine/test/history/HistoricIncidentQueryTest.testQueryByCauseIncidentId.bpmn20.xml",
      "com/finture/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  @Test
