...
public class ProcessInstanceQueryByLeafInstancesTest {
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/api/runtime/superProcessWithNestedSubProcess.bpmn20.xml",
      "com/finture/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml", "com/finture/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/engine/test/api/runtime/nestedSubProcess.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/engine/test/api/runtime/subProcess.bpmn20.xml" })
