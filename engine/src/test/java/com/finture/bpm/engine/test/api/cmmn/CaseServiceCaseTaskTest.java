 ...
 */
package com.finture.bpm.engine.test.api.cmmn;
...
public class CaseServiceCaseTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "com/finture/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn",
      "com/finture/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
      })
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn"})
  @Test
