 ...
 */
package com.finture.bpm.engine.test.bpmn.external;
...
public class ExternalTaskParseTest extends PluggableProcessEngineTest {
  ...
  public void testParseExternalTaskWithoutTopic() {
    DeploymentBuilder deploymentBuilder = repositoryService
      .createDeployment()
      .addClasspathResource("com/finture/bpm/engine/test/bpmn/external/ExternalTaskParseTest.testParseExternalTaskWithoutTopic.bpmn20.xml");
