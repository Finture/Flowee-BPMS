...
public class PvmEventTest {
  ...
  public void testStartEndEvents() {
    ...
    PvmProcessDefinition processDefinition = new ProcessDefinitionBuilder("events")
      .executionListener(com.finture.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_START, eventCollector)
      .executionListener(com.finture.bpm.engine.impl.pvm.PvmEvent.EVENTNAME_END, eventCollector)
