...
import com.finture.bpm.engine.test.bpmn.tasklistener.util.CompletingTaskListener;
import com.finture.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener;
import com.finture.bpm.engine.test.bpmn.tasklistener.util.RecorderTaskListener.RecordedTaskEvent;
import com.finture.bpm.engine.test.bpmn.tasklistener.util.TaskDeleteListener;
...
public class TaskListenerTest extends AbstractTaskListenerTest {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.bpmn20.xml"})
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testScriptResourceListener.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/tasklistener/taskListener.groovy"
  })
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testTimeoutTaskListenerDuration.bpmn20.xml")
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/bpmn/tasklistener/TaskListenerTest.testRecalculateTimeoutTaskListenerDuedateCreationDateBased.bpmn20.xml")
