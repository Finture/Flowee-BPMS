 ...
 */
package com.finture.bpm.engine.test.api.multitenancy;
...
public class TenantIdProviderTest {
  ...
  protected static final String CONFIGURATION_RESOURCE = "com/finture/bpm/engine/test/api/multitenancy/TenantIdProviderTest.camunda.cfg.xml";
  ...
  protected static final BpmnModelInstance FAILING_PROCESS = Bpmn.createExecutableProcess(PROCESS_DEFINITION_KEY).startEvent()
      .serviceTask()
        .camundaClass("com.finture.bpm.engine.test.api.multitenancy.FailingDelegate")
        .camundaAsyncBefore()
      .done();

  protected static final String DMN_FILE = "com/finture/bpm/engine/test/api/multitenancy/simpleDecisionTable.dmn";

  protected static final String CMMN_FILE = "com/finture/bpm/engine/test/api/multitenancy/CaseWithCaseTask.cmmn";
  protected static final String CMMN_FILE_WITH_MANUAL_ACTIVATION = "com/finture/bpm/engine/test/api/multitenancy/CaseWithCaseTaskWithManualActivation.cmmn";
  protected static final String CMMN_VARIABLE_FILE = "com/finture/bpm/engine/test/api/multitenancy/CaseWithCaseTaskVariables.cmmn";
  protected static final String CMMN_SUBPROCESS_FILE = "com/finture/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  ...
  public void providerCalledForProcessDefinitionWithoutTenantId_ProcessTask() {
    ...
    testRule.deploy(
        ...
        "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTask.cmmn");
