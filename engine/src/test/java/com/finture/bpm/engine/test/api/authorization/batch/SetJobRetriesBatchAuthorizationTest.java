...
import com.finture.bpm.engine.test.api.authorization.util.AuthorizationScenarioWithCount;
...
public class SetJobRetriesBatchAuthorizationTest extends AbstractBatchAuthorizationTest {
  ...
  protected static final String DEFINITION_XML = "com/finture/bpm/engine/test/api/mgmt/ManagementServiceTest.testGetJobExceptionStacktrace.bpmn20.xml";
