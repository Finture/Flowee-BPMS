...
public class DeploymentAwareJobExecutorTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "com/finture/bpm/engine/test/jobexecutor/simpleAsyncProcess.bpmn20.xml")
  @Test
  public void testProcessingOfJobsWithMatchingDeployment() {
    ...
    String otherDeploymentId =
        deployAndInstantiateWithNewEngineConfiguration(
            "com/finture/bpm/engine/test/jobexecutor/simpleAsyncProcessVersion2.bpmn20.xml");
  ...
  @Deployment(resources="com/finture/bpm/engine/test/jobexecutor/processWithTimerCatch.bpmn20.xml")
  @Test
  ...
  @Deployment(resources="com/finture/bpm/engine/test/jobexecutor/processWithTimerStart.bpmn20.xml")
  @Test
