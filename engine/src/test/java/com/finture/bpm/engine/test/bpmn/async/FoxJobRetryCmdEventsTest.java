...
import static com.finture.bpm.engine.test.bpmn.async.RetryCmdDeployment.deployment;
import static com.finture.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareCompensationEventProcess;
import static com.finture.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareEscalationEventProcess;
import static com.finture.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareMessageEventProcess;
import static com.finture.bpm.engine.test.bpmn.async.RetryCmdDeployment.prepareSignalEventProcess;
