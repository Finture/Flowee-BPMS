...
public class CallActivityDelegateMappingTest {
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMapping.bpmn20.xml",
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingExpression.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingNotFound.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  public void testCallSubProcessWithDelegatedVariableMappingNotFound() {
    try {
      ...
      //Exception while instantiating class 'com.finture.bpm.engine.test.bpmn.callactivity.NotFoundMapping'
      assertEquals("ENGINE-09008 Exception while instantiating class 'com.finture.bpm.engine.test.bpmn.callactivity.NotFoundMapping': ENGINE-09017 Cannot load class 'com.finture.bpm.engine.test.bpmn.callactivity.NotFoundMapping': com.finture.bpm.engine.test.bpmn.callactivity.NotFoundMapping",
              e.getMessage());
    }
  }
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingExpressionNotFound.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  private void delegateVariableMappingThrowException() {
    ...
    try {
      ...
      Assert.assertTrue(pex.getMessage().equalsIgnoreCase("com.finture.bpm.engine.ProcessEngineException: New process engine exception.")
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingThrowException.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingExpressionThrowException.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingThrowBpmnError.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingThrowExceptionOutput.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSimpleSubProcessDelegateVarMappingThrowBpmnErrorOutput.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallFailingSubProcessWithDelegatedVariableMapping.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/failingSubProcess.bpmn20.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/bpmn/callactivity/CallActivityDelegateMappingTest.testCallSubProcessWithDelegatedVariableMappingAndAsyncServiceTask.bpmn20.xml",
    "com/finture/bpm/engine/test/bpmn/callactivity/simpleSubProcessWithAsyncService.bpmn20.xml"
  })
