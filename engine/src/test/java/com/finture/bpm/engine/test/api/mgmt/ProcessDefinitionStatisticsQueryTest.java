...
public class ProcessDefinitionStatisticsQueryTest extends PluggableProcessEngineTest {
  ...
  public void testProcessDefinitionStatisticsQueryForMultipleVersions() {
    com.finture.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("com/finture/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQueryWithFailedJobs.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsQueryPagination() {
    com.finture.bpm.engine.repository.Deployment deployment =
        repositoryService.createDeployment()
          .addClasspathResource("com/finture/bpm/engine/test/api/mgmt/StatisticsTest.testStatisticsQuery.bpmn20.xml")
          .deploy();
  ...
  public void testProcessDefinitionStatisticsProperties() {
    String resourceName = "com/finture/bpm/engine/test/api/mgmt/ProcessDefinitionStatisticsQueryTest.testProcessDefinitionStatisticsProperties.bpmn20.xml";
