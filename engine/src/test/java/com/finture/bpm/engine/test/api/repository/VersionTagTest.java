...
public class VersionTagTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/repository/versionTag.dmn"})
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/repository/noVersionTag.dmn"})
  @Test
