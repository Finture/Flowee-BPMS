 ...
 */
package com.finture.bpm.engine.test.api.history.removaltime.cleanup;
...
import static com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler.MAX_BATCH_SIZE;
...
import com.finture.bpm.engine.history.CleanableHistoricDecisionInstanceReportResult;
import com.finture.bpm.engine.history.CleanableHistoricProcessInstanceReportResult;
...
import com.finture.bpm.engine.test.api.resources.GetByteArrayCommand;
