...
import static com.finture.bpm.engine.test.standalone.deploy.TestCmmnTransformListener.numberOfRegistered;
...
public class CmmnTransformListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "com/finture/bpm/engine/test/standalone/deploy/cmmn.transform.listener.camunda.cfg.xml");
  @Rule
