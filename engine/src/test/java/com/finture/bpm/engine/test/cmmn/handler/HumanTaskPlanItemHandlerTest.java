...
import com.finture.bpm.engine.impl.cmmn.behavior.HumanTaskActivityBehavior;
import com.finture.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import com.finture.bpm.engine.impl.cmmn.handler.HumanTaskItemHandler;
...
import com.finture.bpm.model.cmmn.instance.CaseRole;
...
import com.finture.bpm.model.cmmn.instance.camunda.CamundaTaskListener;
...
public class HumanTaskPlanItemHandlerTest extends CmmnElementHandlerTest {
  ...
  public void testCreateTaskListenerByClass() {
    ...
    String className = "com.finture.bpm.test.tasklistener.ABC";
