...
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.externalTaskById;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.externalTaskByLockExpirationTime;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.externalTaskByProcessDefinitionId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.externalTaskByProcessDefinitionKey;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.externalTaskByProcessInstanceId;
...
public class ExternalTaskQueryTest extends PluggableProcessEngineTest {
  ...
  public void testQueryByProcessDefinitionId() {
    ...
    com.finture.bpm.engine.repository.Deployment secondDeployment = repositoryService
      .createDeployment()
      .addClasspathResource("com/finture/bpm/engine/test/api/externaltask/oneExternalTaskProcess.bpmn20.xml")
      .deploy();
