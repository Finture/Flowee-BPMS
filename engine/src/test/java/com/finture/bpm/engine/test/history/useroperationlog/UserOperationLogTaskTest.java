...
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_ASSIGN;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_CLAIM;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_COMPLETE;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_DELEGATE;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_DELETE;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_RESOLVE;
import static com.finture.bpm.engine.history.UserOperationLogEntry.OPERATION_TYPE_SET_OWNER;
...
import static com.finture.bpm.engine.impl.persistence.entity.TaskEntity.DELEGATION;
import static com.finture.bpm.engine.impl.persistence.entity.TaskEntity.DELETE;
import static com.finture.bpm.engine.impl.persistence.entity.TaskEntity.OWNER;
import static com.finture.bpm.engine.impl.persistence.entity.TaskEntity.PRIORITY;
