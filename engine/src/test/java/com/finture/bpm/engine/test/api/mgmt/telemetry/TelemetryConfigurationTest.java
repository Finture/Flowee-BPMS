 ...
 */
package com.finture.bpm.engine.test.api.mgmt.telemetry;
...
public class TelemetryConfigurationTest {
  ...
  @Test
  @WatchLogger(loggerNames = {"com.finture.bpm.engine.persistence"}, level = "DEBUG")
  ...
  public void shouldStartEngineWithLicenseKeyAlreadyPresent() {
    ...
    inMemoryConfiguration
        .setJdbcUrl("jdbc:h2:mem:flowee-bpms-test" + getClass().getSimpleName())
    ...
    assertThat(inMemoryConfiguration.getDiagnosticsRegistry().getLicenseKey())
        .usingRecursiveComparison().isEqualTo(new LicenseKeyDataImpl(null, null, null, null, null, "my company;unlimited"));
  }
