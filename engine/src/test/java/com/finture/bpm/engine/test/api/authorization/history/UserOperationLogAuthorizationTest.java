 ...
 */
package com.finture.bpm.engine.test.api.authorization.history;
...
import static com.finture.bpm.engine.authorization.ProcessDefinitionPermissions.UPDATE_HISTORY;
import static com.finture.bpm.engine.authorization.Resources.HISTORIC_TASK;
import static com.finture.bpm.engine.authorization.Resources.OPERATION_LOG_CATEGORY;
import static com.finture.bpm.engine.authorization.Resources.PROCESS_DEFINITION;
import static com.finture.bpm.engine.authorization.UserOperationLogCategoryPermissions.DELETE;
import static com.finture.bpm.engine.authorization.UserOperationLogCategoryPermissions.READ;
import static com.finture.bpm.engine.history.UserOperationLogEntry.CATEGORY_ADMIN;
import static com.finture.bpm.engine.history.UserOperationLogEntry.CATEGORY_OPERATOR;
import static com.finture.bpm.engine.history.UserOperationLogEntry.CATEGORY_TASK_WORKER;
...
import com.finture.bpm.engine.impl.persistence.entity.HistoricIncidentEntity;
import com.finture.bpm.engine.runtime.Job;
import com.finture.bpm.engine.test.RequiredHistoryLevel;
import com.finture.bpm.engine.test.api.authorization.AuthorizationTest;
...
public class UserOperationLogAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    deploymentId = testRule.deploy(
        ...
        "com/finture/bpm/engine/test/api/authorization/oneTaskCase.cmmn",
        "com/finture/bpm/engine/test/api/authorization/timerBoundaryEventProcess.bpmn20.xml")
            .getId();
    super.setUp();
  }
