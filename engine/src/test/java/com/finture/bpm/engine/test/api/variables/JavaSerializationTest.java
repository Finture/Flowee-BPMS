 ...
 */
package com.finture.bpm.engine.test.api.variables;

import static org.assertj.core.api.Assertions.assertThatThrownBy;
import static com.finture.bpm.engine.test.util.TypedValueAssert.assertObjectValueDeserialized;
import static com.finture.bpm.engine.test.util.TypedValueAssert.assertObjectValueDeserializedNull;
import static com.finture.bpm.engine.test.util.TypedValueAssert.assertObjectValueSerializedJava;
import static com.finture.bpm.engine.test.util.TypedValueAssert.assertObjectValueSerializedNull;
import static com.finture.bpm.engine.test.util.TypedValueAssert.assertUntypedNullValue;
...
public class JavaSerializationTest {
  ...
  protected static final String ONE_TASK_PROCESS = "com/finture/bpm/engine/test/api/variables/oneTaskProcess.bpmn20.xml";
