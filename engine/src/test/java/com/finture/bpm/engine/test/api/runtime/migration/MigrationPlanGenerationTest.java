...
import static com.finture.bpm.engine.test.api.runtime.migration.models.ConditionalModels.BOUNDARY_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITIONAL_PROCESS_KEY;
import static com.finture.bpm.engine.test.api.runtime.migration.models.ConditionalModels.CONDITION_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_START_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.EVENT_SUB_PROCESS_TASK_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.USER_TASK_ID;
import static com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels.VAR_CONDITION;
import static com.finture.bpm.engine.test.util.MigrationPlanAssert.assertThat;
import static com.finture.bpm.engine.test.util.MigrationPlanAssert.migrate;
import static org.junit.Assert.assertNotNull;

import com.finture.bpm.engine.migration.MigrationInstructionsBuilder;
...
import com.finture.bpm.engine.test.api.runtime.migration.models.EventBasedGatewayModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.EventSubProcessModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.ExternalTaskModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.GatewayModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.MessageReceiveModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.MultiInstanceProcessModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.ProcessModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.ServiceTaskModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.TransactionModels;
import com.finture.bpm.engine.test.util.MigrationPlanAssert;
