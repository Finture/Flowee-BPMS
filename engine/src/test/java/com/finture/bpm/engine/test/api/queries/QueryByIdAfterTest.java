 ...
 */
package com.finture.bpm.engine.test.api.queries;
...
public class QueryByIdAfterTest {
  ...
  @Test
  @Deployment(resources={"com/finture/bpm/engine/test/api/runtime/oneFailingServiceProcess.bpmn20.xml"})
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/history/HistoricActivityInstanceTest.testHistoricActivityInstanceNoop.bpmn20.xml")
  ...
  public void shouldProcessDefinitionApiReturnOnlyAfterGivenId() {
    // given
    deployProcessDefinitions("com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml", 10);
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/engine/test/history/HistoricVariableInstanceTest.testSimple.bpmn20.xml" })
