...
public class MultiTenancyExecutionPropagationTest extends PluggableProcessEngineTest {
  ...
  protected static final String CMMN_FILE = "com/finture/bpm/engine/test/api/cmmn/oneTaskCase.cmmn";
  protected static final String SET_VARIABLE_CMMN_FILE = "com/finture/bpm/engine/test/api/multitenancy/HumanTaskSetVariableExecutionListener.cmmn";
  ...
  public void testPropagateTenantIdToCompensationEventSubscription() {
    ...
    testRule.deployForTenant(TENANT_ID, "com/finture/bpm/engine/test/api/multitenancy/compensationBoundaryEvent.bpmn");
