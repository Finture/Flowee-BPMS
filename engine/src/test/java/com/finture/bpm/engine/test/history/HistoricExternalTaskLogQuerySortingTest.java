...
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskByTimestamp;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByActivityInstanceId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExecutionId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByExternalTaskId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByPriority;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessDefinitionKey;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByProcessInstanceId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByRetries;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByTopicName;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.historicExternalTaskLogByWorkerId;
import static com.finture.bpm.engine.test.api.runtime.TestOrderingUtil.inverted;
import static com.finture.bpm.engine.test.api.runtime.migration.models.builder.DefaultExternalTaskModelBuilder.DEFAULT_TOPIC;
import static com.finture.bpm.engine.test.api.runtime.migration.models.builder.DefaultExternalTaskModelBuilder.createDefaultExternalTaskModel;
