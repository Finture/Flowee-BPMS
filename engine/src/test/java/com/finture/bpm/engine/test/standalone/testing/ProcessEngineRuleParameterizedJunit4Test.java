 ...
 */
package com.finture.bpm.engine.test.standalone.testing;
...
public class ProcessEngineRuleParameterizedJunit4Test {
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/standalone/testing/ProcessEngineRuleParameterizedJunit4Test.ruleUsageExample.bpmn20.xml")
