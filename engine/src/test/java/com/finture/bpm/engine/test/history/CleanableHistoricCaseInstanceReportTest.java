...
public class CleanableHistoricCaseInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("com/finture/bpm/engine/test/repository/one.cmmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("com/finture/bpm/engine/test/api/cmmn/oneCaseTaskCase.cmmn", "com/finture/bpm/engine/test/api/cmmn/oneTaskCase.cmmn",
        "com/finture/bpm/engine/test/api/cmmn/oneTaskCaseWithHistoryTimeToLive.cmmn");
