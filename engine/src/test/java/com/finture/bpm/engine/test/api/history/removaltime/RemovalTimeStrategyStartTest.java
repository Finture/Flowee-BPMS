 ...
 */
package com.finture.bpm.engine.test.api.history.removaltime;
...
import com.finture.bpm.engine.authorization.AuthorizationQuery;
...
import com.finture.bpm.engine.impl.persistence.entity.AttachmentEntity;
...
import com.finture.bpm.engine.test.bpmn.async.FailingDelegate;
...
public class RemovalTimeStrategyStartTest extends AbstractRemovalTimeTest {
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml"
  })
  ...
  @Test
  @Deployment(resources = {
    "com/finture/bpm/engine/test/api/history/testDmnWithPojo.dmn11.xml"
  })
  ...
  @Test
  @Deployment( resources = {
    "com/finture/bpm/engine/test/api/history/removaltime/HistoricRootProcessInstanceTest.shouldResolveByteArray_DecisionOutputLiteralExpression.dmn"
  })
