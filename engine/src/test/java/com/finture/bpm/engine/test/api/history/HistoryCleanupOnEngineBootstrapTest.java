...
import com.finture.bpm.engine.impl.cfg.BatchWindowConfiguration;
...
import com.finture.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobHandlerConfiguration;
import com.finture.bpm.engine.impl.persistence.entity.JobEntity;
import com.finture.bpm.engine.impl.util.ClockUtil;
import com.finture.bpm.engine.impl.util.JsonUtil;
...
public class HistoryCleanupOnEngineBootstrapTest {
  ...
  public void testConsecutiveEngineBootstrapHistoryCleanupJobReconfiguration() {
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/batchwindow.camunda.cfg.xml")
      .buildProcessEngine()
      .close();
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/no-batchwindow.camunda.cfg.xml")
      .buildProcessEngine()
      .close();
  ...
  public void testDecreaseNumberOfHistoryCleanupJobs() {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-parallelism-default.camunda.cfg.xml")
      .buildProcessEngine();
    ...
    .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-parallelism-less.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testIncreaseNumberOfHistoryCleanupJobs() {
    ...
    // when
    engine = ProcessEngineConfiguration
    .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-parallelism-more.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testBatchWindowXmlConfigParsingException() throws ParseException {
    ...
    assertThatThrownBy(() -> ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-batch-window-map-wrong-values.camunda.cfg.xml")
      .buildProcessEngine())
  ...
  public void testBatchWindowMapInXmlConfig() throws ParseException {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-batch-window-map.camunda.cfg.xml")
      .buildProcessEngine();
    ...
    engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("com/finture/bpm/engine/test/history/history-cleanup-batch-window-default.camunda.cfg.xml")
      .buildProcessEngine();
  ...
  public void testHistoryCleanupJobScheduled() throws ParseException {
    ...
    standaloneInMemProcessEngineConfiguration.setJdbcUrl("jdbc:h2:mem:flowee-bpms" + getClass().getSimpleName() + "testHistoryCleanupJobScheduled");
  ...
  public void shouldCreateHistoryCleanupJobLogs() {
    ...
    standaloneInMemProcessEngineConfiguration
        .setJdbcUrl("jdbc:h2:mem:flowee-bpms" + getClass().getSimpleName() + "testHistoryCleanupJobScheduled");
  ...
  public void testBatchWindowOneDayOfWeek() throws ParseException {
    ...
    configuration.setJdbcUrl("jdbc:h2:mem:flowee-bpms" + getClass().getSimpleName() + "testBatchWindowOneDayOfWeek");
  ...
  public void testBatchWindow24Hours() throws ParseException {
    ...
    configuration.setJdbcUrl("jdbc:h2:mem:flowee-bpms" + getClass().getSimpleName() + "testBatchWindow24Hours");
