...
public class SentryCombinedEntryAndExitCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStage.cmmn"})
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStage.cmmn"})
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentResumeInsideStageDifferentPlanItemOrder.cmmn"})
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryCombinedEntryAndExitCriteriaTest.testParentSuspendInsideStageDifferentPlanItemOrder.cmmn"})
