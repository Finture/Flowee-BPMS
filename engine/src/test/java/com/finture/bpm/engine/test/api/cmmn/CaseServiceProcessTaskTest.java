...
public class CaseServiceProcessTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "com/finture/bpm/engine/test/api/cmmn/oneProcessTaskWithManualActivationAndOneHumanTaskCase.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
      })
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/oneProcessTaskWithManualActivationAndOneHumanTaskCase.cmmn"})
  @Test
