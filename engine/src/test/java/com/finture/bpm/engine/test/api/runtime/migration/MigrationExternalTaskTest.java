...
import static com.finture.bpm.engine.test.util.MigrationPlanValidationReportAssert.assertThat;
...
public class MigrationExternalTaskTest {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn"})
  public void testProcessDefinitionWithoutIdField() {
     // given

    ProcessDefinition sourceProcessDefinition = testHelper.deploy("com/finture/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("com/finture/bpm/engine/test/api/externaltask/ExternalTaskWithoutIdTest.bpmn").getDeployedProcessDefinitions().get(0);
  ...
  public void testProcessDefinitionWithIdField() {
    ...
    ProcessDefinition sourceProcessDefinition = testHelper.deploy("com/finture/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
    ProcessDefinition targetProcessDefinition = testHelper.deploy("com/finture/bpm/engine/test/api/externaltask/ExternalTaskWithIdTest.bpmn").getDeployedProcessDefinitions().get(0);
