...
public class AsyncCallActivityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = { "com/finture/bpm/engine/test/bpmn/async/AsyncCallActivityTest.asyncStartEvent.bpmn20.xml",
  "com/finture/bpm/engine/test/bpmn/async/AsyncCallActivityTest.testCallSubProcess.bpmn20.xml" })
  @Test
