...
public class HistoricIncidentAuthorizationTest extends AuthorizationTest {
  ...
  public void setUp() throws Exception {
    deploymentId = testRule.deploy(
        "com/finture/bpm/engine/test/api/authorization/timerStartEventProcess.bpmn20.xml",
        "com/finture/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml",
        "com/finture/bpm/engine/test/api/authorization/anotherOneIncidentProcess.bpmn20.xml").getId();
    super.setUp();
  }
