 ...
 */
package com.finture.bpm.engine.test.dmn.deployment;
...
import com.finture.bpm.engine.repository.DeploymentWithDefinitions;
...
import com.finture.bpm.model.dmn.Dmn;
import com.finture.bpm.model.dmn.DmnModelInstance;
import com.finture.bpm.model.dmn.HitPolicy;
import com.finture.bpm.model.dmn.impl.DmnModelConstants;
import com.finture.bpm.model.dmn.instance.Decision;
import com.finture.bpm.model.dmn.instance.DecisionTable;
import com.finture.bpm.model.dmn.instance.Definitions;
import com.finture.bpm.model.dmn.instance.Input;
import com.finture.bpm.model.dmn.instance.InputExpression;
import com.finture.bpm.model.dmn.instance.Output;
import com.finture.bpm.model.dmn.instance.Text;
...
public class DecisionDefinitionDeployerTest {
  ...
  protected static final String DMN_CHECK_ORDER_RESOURCE = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDmnDeployment.dmn11.xml";
  protected static final String DMN_CHECK_ORDER_RESOURCE_DMN_SUFFIX = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDmnDeployment.dmn";
  protected static final String DMN_SCORE_RESOURCE = "com/finture/bpm/engine/test/dmn/deployment/dmnScore.dmn11.xml";

  protected static final String DMN_DECISION_LITERAL_EXPRESSION = "com/finture/bpm/engine/test/dmn/deployment/DecisionWithLiteralExpression.dmn";

  protected static final String DRD_SCORE_RESOURCE = "com/finture/bpm/engine/test/dmn/deployment/drdScore.dmn11.xml";
  protected static final String DRD_SCORE_V2_RESOURCE = "com/finture/bpm/engine/test/dmn/deployment/drdScore_v2.dmn11.xml";
  protected static final String DRD_DISH_RESOURCE = "com/finture/bpm/engine/test/dmn/deployment/drdDish.dmn11.xml";
  ...
  public void duplicateIdInDeployment() {
    String resourceName1 = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDuplicateIdInDeployment.dmn11.xml";
    String resourceName2 = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDuplicateIdInDeployment2.dmn11.xml";
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.dmn11.xml",
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource.png"
  })
  @Test
  public void getDecisionDiagramResource() {
    String resourcePrefix = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDiagramResource";
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.dmn11.xml",
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision1.png",
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision2.png",
    "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.decision3.png"
  })
  @Test
  public void multipleDiagramResourcesProvided() {
    String resourcePrefix = "com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testMultipleDecisionDiagramResource.";
  ...
  public void testDeployDecisionDefinitionWithIntegerHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithIntegerHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithStringHistoryTimeToLive() {
    // when
    DeploymentWithDefinitions deployment = testRule.deploy("com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithStringHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithMalformedStringHistoryTimeToLive() {
    try {
      testRule.deploy("com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithMalformedHistoryTimeToLive.dmn11.xml");
  ...
  public void testDeployDecisionDefinitionWithEmptyHistoryTimeToLive() {
      DeploymentWithDefinitions deployment = testRule.deploy("com/finture/bpm/engine/test/dmn/deployment/DecisionDefinitionDeployerTest.testDecisionDefinitionWithEmptyHistoryTimeToLive.dmn11.xml");
