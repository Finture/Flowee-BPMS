 ...
 */
package com.finture.bpm.engine.test.api.cfg;
...
import com.finture.bpm.engine.impl.dmn.el.ProcessEngineJuelElProvider;
...
public class DmnEngineConfigurationTest {
  ...
  protected final static String CONFIGURATION_XML = "com/finture/bpm/engine/test/api/cfg/custom-dmn-camunda.cfg.xml";
  ...
  protected ProcessEngineConfigurationImpl createProcessEngineConfiguration() {
    return (ProcessEngineConfigurationImpl) ProcessEngineConfiguration.createStandaloneInMemProcessEngineConfiguration()
        .setJdbcUrl("jdbc:h2:mem:flowee-bpms" + getClass().getSimpleName());
  }
