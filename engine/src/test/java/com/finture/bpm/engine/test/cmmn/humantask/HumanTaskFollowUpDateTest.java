 ...
 */
package com.finture.bpm.engine.test.cmmn.humantask;
...
public class HumanTaskFollowUpDateTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/humantask/HumanTaskFollowUpDateTest.testHumanTaskFollowUpDate.cmmn"})
  @Test
