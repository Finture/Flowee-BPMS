...
import com.finture.bpm.engine.test.api.runtime.migration.models.AsyncProcessModels;
import com.finture.bpm.engine.test.api.runtime.migration.models.ProcessModels;
import com.finture.bpm.engine.test.api.runtime.util.IncrementCounterListener;
import com.finture.bpm.engine.test.bpmn.async.AsyncListener;
...
public class RestartProcessInstanceSyncTest {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/bpmn/async/AsyncStartEventTest.testAsyncStartEventListeners.bpmn20.xml"})
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/bpmn/async/AsyncStartEventTest.testCallActivity-super.bpmn20.xml",
      "com/finture/bpm/engine/test/bpmn/async/AsyncStartEventTest.testCallActivity-sub.bpmn20.xml"
  })
