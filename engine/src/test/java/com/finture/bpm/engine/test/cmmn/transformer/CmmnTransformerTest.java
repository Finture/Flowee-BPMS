 ...
 */
package com.finture.bpm.engine.test.cmmn.transformer;
...
import com.finture.bpm.engine.impl.cmmn.transformer.CmmnTransform;
...
public class CmmnTransformerTest {
  ...
  protected List<CaseDefinitionEntity> transform() {
    ...
    byte[] model = com.finture.bpm.engine.impl.util.IoUtil.readInputStream(inputStream, "model");
