...
import com.finture.bpm.engine.test.api.AbstractAsyncOperationsTest;
...
public class SetExternalTasksRetriesTest extends AbstractAsyncOperationsTest {
  ...
  protected void deployTestProcesses() {
    com.finture.bpm.engine.repository.Deployment deployment = engineRule.getRepositoryService().createDeployment()
      ...
      .addClasspathResource("com/finture/bpm/engine/test/api/externaltask/externalTaskPriorityExpression.bpmn20.xml")
      .deploy();
