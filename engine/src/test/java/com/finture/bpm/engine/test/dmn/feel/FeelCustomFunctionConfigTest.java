...
import com.finture.bpm.engine.test.dmn.feel.helper.CustomFunctionProvider;
...
public class FeelCustomFunctionConfigTest {
  ...
  @Test
  @Deployment(resources = {"com/finture/bpm/engine/test/dmn/feel/custom_function.dmn"})
