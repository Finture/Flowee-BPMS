 ...
 */
package com.finture.bpm.engine.test.cmmn.required;
...
public class RequiredRuleTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "com/finture/bpm/engine/test/cmmn/required/RequiredRuleTest.testDefaultVariableBasedRule.cmmn")
  @Test
