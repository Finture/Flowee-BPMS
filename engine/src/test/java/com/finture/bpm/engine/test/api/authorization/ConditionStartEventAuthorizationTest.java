...
public class ConditionStartEventAuthorizationTest extends AuthorizationTest {
  ...
  private static final String TRUE_CONDITIONAL_XML = "com/finture/bpm/engine/test/bpmn/event/conditional/ConditionalStartEventTest.testStartInstanceWithTrueConditionalStartEvent.bpmn20.xml";
