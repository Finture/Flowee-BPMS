 ...
 */
package com.finture.bpm.engine.test.form.deployment;
...
public class CamundaFormDefinitionDeployerTest {
  ...
  protected static final String BPMN_USER_TASK_FORM_REF_DEPLOYMENT = "com/finture/bpm/engine/test/form/deployment/CamundaFormDefinitionDeployerTest.shouldDeployProcessWithCamundaFormDefinitionBindingDeployment.bpmn";
  protected static final String BPMN_USER_TASK_FORM_REF_LATEST = "com/finture/bpm/engine/test/form/deployment/CamundaFormDefinitionDeployerTest.shouldDeployProcessWithCamundaFormDefinitionBindingLatest.bpmn";
  protected static final String BPMN_USER_TASK_FORM_REF_VERSION = "com/finture/bpm/engine/test/form/deployment/CamundaFormDefinitionDeployerTest.shouldDeployProcessWithCamundaFormDefinitionBindingVersion.bpmn";
  protected static final String SIMPLE_FORM = "com/finture/bpm/engine/test/form/deployment/CamundaFormDefinitionDeployerTest.simple_form.form";
