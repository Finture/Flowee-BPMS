...
public class CaseServiceCaseInstanceTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/oneStageCase.cmmn"})
  @Test
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/cmmn/emptyCasePlanModelCase.cmmn"})
  @Test
