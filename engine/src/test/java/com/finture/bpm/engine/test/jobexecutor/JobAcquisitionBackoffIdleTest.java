...
import com.finture.bpm.engine.test.jobexecutor.RecordingAcquireJobsRunnable.RecordedWaitEvent;
...
public class JobAcquisitionBackoffIdleTest {
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/jobexecutor/JobAcquisitionBackoffIdleTest.testShortTimerOnUserTaskWithExpression.bpmn20.xml")
