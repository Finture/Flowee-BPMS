...
import com.finture.bpm.engine.impl.bpmn.parser.AbstractBpmnParseListener;
...
public class BPMNParseListenerTest {
  ...
  public static ProcessEngineBootstrapRule bootstrapRule = new ProcessEngineBootstrapRule(
      "com/finture/bpm/engine/test/standalone/deploy/bpmn.parse.listener.camunda.cfg.xml");
  ...
  public void testAlterProcessDefinitionKeyWhenDeploying() throws Exception {
    ...
    // when
    engineTestRule.deploy("com/finture/bpm/engine/test/standalone/deploy/"
