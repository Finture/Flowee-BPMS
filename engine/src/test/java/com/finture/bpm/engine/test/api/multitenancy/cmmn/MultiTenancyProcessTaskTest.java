...
public class MultiTenancyProcessTaskTest extends PluggableProcessEngineTest {
  ...
  protected static final String CMMN_LATEST = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTask.cmmn";
  protected static final String CMMN_LATEST_WITH_MANUAL_ACTIVATION = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskWithManualActivation.cmmn";
  protected static final String CMMN_DEPLOYMENT = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskDeploymentBinding.cmmn";
  protected static final String CMMN_VERSION = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskVersionBinding.cmmn";
  protected static final String CMMN_VERSION_2 = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskVersionBinding_v2.cmmn";

  protected static final String CMMN_TENANT_CONST = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskTenantIdConst.cmmn";
  protected static final String CMMN_TENANT_EXPR = "com/finture/bpm/engine/test/api/multitenancy/CaseWithProcessTaskTenantIdExpr.cmmn";
