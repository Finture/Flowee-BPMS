...
public class ProcessDefinitionSuspensionTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={"com/finture/bpm/engine/test/api/repository/processOne.bpmn20.xml"})
  @Test
  ...
  @Deployment(resources={
          "com/finture/bpm/engine/test/api/repository/processOne.bpmn20.xml",
          "com/finture/bpm/engine/test/api/repository/processTwo.bpmn20.xml"
          })
  @Test
  ...
  public void testSuspendMultipleProcessDefinitionsByKey () {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("com/finture/bpm/engine/test/api/runtime/oneTaskProcess.bpmn20.xml").deploy();
    }
  ...
  public void testMultipleSuspendByKey_shouldSuspendJobDefinitionAndRetainJob() {
    ...
    for (int i=0; i<nrOfProcessDefinitions; i++) {
      repositoryService.createDeployment()
        .addClasspathResource("com/finture/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testWithOneAsyncServiceTask.bpmn").deploy();
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/api/repository/ProcessDefinitionSuspensionTest.testSuspendStartTimerOnProcessDefinitionSuspension.bpmn20.xml"})
  @Test
