...
public class CleanableHistoricDecisionInstanceReportTest {
  ...
  public void setUp() {
    ...
    testRule.deploy("com/finture/bpm/engine/test/repository/one.dmn");
  }
  ...
  public void testReportComplex() {
    // given
    testRule.deploy("com/finture/bpm/engine/test/repository/two.dmn", "com/finture/bpm/engine/test/api/dmn/Another_Example.dmn",
        "com/finture/bpm/engine/test/api/dmn/Example.dmn");
