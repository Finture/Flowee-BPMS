...
public class SentryInitializationTest extends CmmnTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testOnPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testVariableOnPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testIfPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testOnPartIfPartAndVariableOnPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testMultipleSentries.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryInitializationTest.testMultipleSentriesWithinStage.cmmn"})
  @Test
