 ...
 */
package com.finture.bpm.engine.test.standalone.db.entitymanager;
...
import static com.finture.bpm.engine.impl.test.TestHelper.assertAndEnsureCleanDbAndCache;
...
public class PurgeDatabaseTest {
  ...
  public void testPurgeCmmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("com/finture/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeCmmnProcess.cmmn")
      .deploy();
    VariableMap variables = Variables.createVariables();
    variables.put("key", "value");
  ...
  public void testPurgeDmnProcess() {
    ...
    engineRule.getRepositoryService()
      .createDeployment()
      .addClasspathResource("com/finture/bpm/engine/test/standalone/db/entitymanager/PurgeDatabaseTest.testPurgeDmnProcess.dmn")
      .deploy();
    VariableMap variables = Variables.createVariables()
      .putValue("key", "value")
