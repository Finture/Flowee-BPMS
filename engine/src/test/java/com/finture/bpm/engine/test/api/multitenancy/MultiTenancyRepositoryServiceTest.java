...
public class MultiTenancyRepositoryServiceTest {
  ...
  protected static final String CMMN = "com/finture/bpm/engine/test/cmmn/deployment/CmmnDeploymentTest.testSimpleDeployment.cmmn";
  protected static final String DMN = "com/finture/bpm/engine/test/api/multitenancy/simpleDecisionTable.dmn";
