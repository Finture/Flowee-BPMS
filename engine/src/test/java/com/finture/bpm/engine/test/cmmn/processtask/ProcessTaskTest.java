 ...
 */
package com.finture.bpm.engine.test.cmmn.processtask;
...
public class ProcessTaskTest extends CmmnTest {
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithDollar.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessAsExpressionStartsWithHash.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallLatestProcess.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByDeployment.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersion.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithDollar.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testCallProcessByVersionAsExpressionStartsWithHash.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputBusinessKey.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputDifferentBusinessKey.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSource.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceDifferentTarget.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputSourceExpression.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAll.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputAllLocal.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOverlapping.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSource.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceDifferentTarget.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputSourceExpression.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputOverlapping.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAllWithManualActivation.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testVariablesRoundtrip.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testInputOutputAll.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTask.cmmn",
      "com/finture/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.cmmn",
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testNonBlockingProcessTaskAndProcessInstanceCompletesInOneGo.cmmn",
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testProcessInstanceCompletesInOneGo.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.cmmn",
      "com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testStartProcessInstanceAsync.bpmn20.xml"
    })
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/api/cmmn/oneProcessTaskCaseWithManualActivation.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
      "com/finture/bpm/engine/test/cmmn/processtask/subProcessWithError.bpmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/processtask/ProcessTaskTest.testOutputAll.cmmn",
  "com/finture/bpm/engine/test/cmmn/processtask/subProcessWithThrownError.bpmn"})
  @Test
