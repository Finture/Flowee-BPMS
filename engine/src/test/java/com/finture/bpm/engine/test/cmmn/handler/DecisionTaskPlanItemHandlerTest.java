 ...
 */
package com.finture.bpm.engine.test.cmmn.handler;

import static com.finture.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_ACTIVITY_DESCRIPTION;
import static com.finture.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_ACTIVITY_TYPE;
import static com.finture.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_IS_BLOCKING;
import static com.finture.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_MANUAL_ACTIVATION_RULE;
import static com.finture.bpm.engine.impl.cmmn.handler.ItemHandler.PROPERTY_REQUIRED_RULE;
...
import com.finture.bpm.engine.impl.cmmn.behavior.DecisionTaskActivityBehavior;
import com.finture.bpm.engine.impl.cmmn.behavior.DmnDecisionTaskActivityBehavior;
import com.finture.bpm.engine.impl.cmmn.handler.CasePlanModelHandler;
import com.finture.bpm.engine.impl.cmmn.handler.DecisionTaskItemHandler;
import com.finture.bpm.engine.impl.cmmn.handler.SentryHandler;
...
import com.finture.bpm.engine.impl.dmn.result.ResultListDecisionTableResultMapper;
import com.finture.bpm.engine.impl.dmn.result.SingleResultDecisionResultMapper;
import com.finture.bpm.engine.impl.el.ElValueProvider;
import com.finture.bpm.model.cmmn.Cmmn;
import com.finture.bpm.model.cmmn.instance.Body;
import com.finture.bpm.model.cmmn.instance.ConditionExpression;
import com.finture.bpm.model.cmmn.instance.DecisionRefExpression;
import com.finture.bpm.model.cmmn.instance.DecisionTask;
import com.finture.bpm.model.cmmn.instance.DefaultControl;
import com.finture.bpm.model.cmmn.instance.Documentation;
import com.finture.bpm.model.cmmn.instance.EntryCriterion;
import com.finture.bpm.model.cmmn.instance.ExitCriterion;
import com.finture.bpm.model.cmmn.instance.IfPart;
import com.finture.bpm.model.cmmn.instance.ItemControl;
