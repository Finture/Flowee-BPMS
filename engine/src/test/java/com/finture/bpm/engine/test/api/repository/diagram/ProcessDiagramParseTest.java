 ...
 */
package com.finture.bpm.engine.test.api.repository.diagram;
...
public class ProcessDiagramParseTest {
  ...
  private static final String resourcePath = "src/test/resources/com/finture/bpm/engine/test/api/repository/diagram/testXxeParsingIsDisabled";
