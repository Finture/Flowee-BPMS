...
public class JobDefinitionPriorityTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources = "com/finture/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml")
  @Test
  ...
  public void testRedeployOverridesSetJobDefinitionPriority() {
    ...
    String secondDeploymentId = repositoryService.createDeployment().addClasspathResource("com/finture/bpm/engine/test/api/mgmt/jobPrioProcess.bpmn20.xml").deploy().getId();
