 ...
 */
package com.finture.bpm.engine.test.concurrency;
...
import com.finture.bpm.engine.impl.cmmn.cmd.StateTransitionCaseExecutionCmd;
...
public class CompetingSentrySatisfactionTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testEntryCriteriaWithAndSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testExitCriteriaWithAndSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testEntryCriteriaWithOrSentry.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.testExitCriteriaWithOrSentry.cmmn",
      "com/finture/bpm/engine/test/concurrency/CompetingSentrySatisfactionTest.oneTaskProcess.bpmn20.xml"})
  @Test
