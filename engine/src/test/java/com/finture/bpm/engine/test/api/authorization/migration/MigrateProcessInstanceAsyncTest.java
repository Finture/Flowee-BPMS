 ...
 */
package com.finture.bpm.engine.test.api.authorization.migration;
...
public class MigrateProcessInstanceAsyncTest {
  ...
  @Test
  @Deployment(resources = "com/finture/bpm/engine/test/api/authorization/oneIncidentProcess.bpmn20.xml")
