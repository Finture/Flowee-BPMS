...
public class SentryVariableOnPartExitCriteriaTest extends CmmnTest {
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryVariableOnPartExitCriteriaTest.testExitTaskWithVariableOnPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryVariableOnPartExitCriteriaTest.testExitTaskWithMultipleOnPart.cmmn"})
  @Test
  ...
  @Deployment(resources = {"com/finture/bpm/engine/test/cmmn/sentry/SentryVariableOnPartExitCriteriaTest.testExitTasksOfDifferentScopes.cmmn"})
  @Test
