...
public class JobExecutionLoggingTest {
  ...
  public ProcessEngineLoggingRule loggingRule = new ProcessEngineLoggingRule().watch(
      "com.finture.bpm.engine.jobexecutor", Level.DEBUG);
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/engine/test/jobexecutor/SimpleAsyncDelayProcess.bpmn20.xml" })
  ...
  @Test
  @Deployment(resources = { "com/finture/bpm/engine/test/jobexecutor/delegateThrowsException.bpmn20.xml" })
