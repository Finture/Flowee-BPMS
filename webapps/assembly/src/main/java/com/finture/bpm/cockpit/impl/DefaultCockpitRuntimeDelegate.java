 ...
 */
package com.finture.bpm.cockpit.impl;
...
import com.finture.bpm.cockpit.db.CommandExecutor;
import com.finture.bpm.cockpit.db.QueryService;
import com.finture.bpm.cockpit.impl.db.CommandExecutorImpl;
import com.finture.bpm.cockpit.impl.db.QueryServiceImpl;
import com.finture.bpm.cockpit.impl.plugin.DefaultPluginRegistry;
import com.finture.bpm.cockpit.plugin.PluginRegistry;
...
import com.finture.bpm.webapp.impl.AbstractAppRuntimeDelegate;

/**
 * <p>This is the default {@link CockpitRuntimeDelegate} implementation that provides
 * the Flowee BPMS Cockpit plugin services (i.e. {@link QueryService} and
