 ...
 */
package com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl;

import com.finture.bpm.engine.ProcessEngineException;
import com.finture.bpm.webapp.impl.security.filter.headersec.provider.HeaderSecurityProvider;
import com.finture.bpm.webapp.impl.util.ServletFilterUtil;

import java.util.Arrays;
import java.util.Map;

import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.DISABLED;
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.INCLUDE_SUBDOMAINS_DISABLED;
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.MAX_AGE;
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.StrictTransportSecurityProvider.Parameters.VALUE;
