 ...
 */
package com.finture.bpm.webapp.plugin.spi;

import com.finture.bpm.cockpit.plugin.resource.AbstractPluginRootResource;
import com.finture.bpm.webapp.plugin.resource.PluginResourceOverride;
import com.finture.bpm.webapp.plugin.spi.impl.AbstractAppPlugin;
...
public interface AppPlugin {
   ...
   * <p>
   *
   * Typically, a plugin publishes its API via a subclass of {@link AbstractPluginRootResource}.
   *
