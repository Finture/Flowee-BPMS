 ...
 * {@link com.finture.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin} as a base class.
 *
 * @author nico.rehwaldt
 *
 * @see com.finture.bpm.cockpit.plugin.spi.impl.AbstractCockpitPlugin
 */
public interface CockpitPlugin extends AppPlugin {
   ...
   * <p>
   *
   * Inside the plugin the queries may be executed via the {@link com.finture.bpm.cockpit.db.QueryService} that may be obtained through
   * {@link com.finture.bpm.cockpit.Cockpit#getQueryService(java.lang.String) }.
   *
