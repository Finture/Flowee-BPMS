 ...
 */
package com.finture.bpm.admin.impl;

import com.finture.bpm.admin.AdminRuntimeDelegate;
import com.finture.bpm.admin.plugin.spi.AdminPlugin;
import com.finture.bpm.webapp.db.CommandExecutor;
import com.finture.bpm.webapp.db.QueryService;
import com.finture.bpm.webapp.impl.db.CommandExecutorImpl;
import com.finture.bpm.webapp.impl.db.QueryServiceImpl;
...
public class DefaultAdminRuntimeDelegate extends AbstractAppRuntimeDelegate<AdminPlugin> implements AdminRuntimeDelegate {
  ...
  private static final List<String> MAPPING_FILES = List.of(
      "com/finture/bpm/admin/plugin/base/queries/metrics.xml"
  );
