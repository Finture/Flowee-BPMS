 ...
 */
package com.finture.bpm.engine.variable;
...
import com.finture.bpm.engine.variable.impl.context.EmptyVariableContext;
import com.finture.bpm.engine.variable.impl.value.AbstractTypedValue;
import com.finture.bpm.engine.variable.impl.value.FileValueImpl;
import com.finture.bpm.engine.variable.impl.value.NullValueImpl;
import com.finture.bpm.engine.variable.impl.value.UntypedValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BooleanValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BytesValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DateValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DoubleValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.IntegerValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.LongValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.NumberValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.ShortValueImpl;
import com.finture.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.StringValueImpl;
import com.finture.bpm.engine.variable.impl.value.builder.FileValueBuilderImpl;
import com.finture.bpm.engine.variable.impl.value.builder.ObjectVariableBuilderImpl;
import com.finture.bpm.engine.variable.impl.value.builder.SerializedObjectValueBuilderImpl;
import com.finture.bpm.engine.variable.type.ValueType;
import com.finture.bpm.engine.variable.value.BooleanValue;
import com.finture.bpm.engine.variable.value.BytesValue;
import com.finture.bpm.engine.variable.value.DateValue;
import com.finture.bpm.engine.variable.value.DoubleValue;
import com.finture.bpm.engine.variable.value.FileValue;
import com.finture.bpm.engine.variable.value.IntegerValue;
import com.finture.bpm.engine.variable.value.LongValue;
import com.finture.bpm.engine.variable.value.NumberValue;
import com.finture.bpm.engine.variable.value.ObjectValue;
import com.finture.bpm.engine.variable.value.SerializationDataFormat;
import com.finture.bpm.engine.variable.value.ShortValue;
import com.finture.bpm.engine.variable.value.StringValue;
import com.finture.bpm.engine.variable.value.TypedValue;
import com.finture.bpm.engine.variable.value.builder.FileValueBuilder;
import com.finture.bpm.engine.variable.value.builder.ObjectValueBuilder;
import com.finture.bpm.engine.variable.value.builder.SerializedObjectValueBuilder;
import com.finture.bpm.engine.variable.value.builder.TypedValueBuilder;
