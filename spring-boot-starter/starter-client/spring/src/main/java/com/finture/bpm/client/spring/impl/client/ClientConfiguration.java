...
import static com.finture.bpm.client.spring.annotation.EnableExternalTaskClient.INT_NULL_VALUE;
import static com.finture.bpm.client.spring.annotation.ExternalTaskSubscription.LONG_NULL_VALUE;

import com.finture.bpm.client.spring.annotation.EnableExternalTaskClient;
