 ...
 */
package com.finture.bpm.spring.boot.starter.webapp.filter.headersec.it;

import com.finture.bpm.spring.boot.starter.webapp.filter.util.HttpClientRule;
import com.finture.bpm.spring.boot.starter.webapp.filter.util.FilterTestApp;
...
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_DEFAULT_VALUE;
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NAME;
import static com.finture.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider.HEADER_NONCE_PLACEHOLDER;
