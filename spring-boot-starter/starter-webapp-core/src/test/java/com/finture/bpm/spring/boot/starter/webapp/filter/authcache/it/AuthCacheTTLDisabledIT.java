 ...
 */
package com.finture.bpm.spring.boot.starter.webapp.filter.authcache.it;
...
@TestPropertySource(properties = {
  "flowee-bpms.bpm.admin-user.id=demo",
  "flowee-bpms.bpm.admin-user.password=demo",
  "flowee-bpms.bpm.webapp.auth.cache.ttl-enabled=false"
})
@DirtiesContext
