 ...
 */
package com.finture.bpm.spring.boot.starter.webapp.filter.redirect;
...
@SpringBootTest(classes = { FilterTestApp.class},
    ...
    properties = {
        "flowee-bpms.bpm.webapp.application-path=/camunda",
        "flowee-bpms.bpm.webapp.index-redirect-enabled=false",
        "flowee-bpms.bpm.admin-user.id=admin" })
@DirtiesContext
