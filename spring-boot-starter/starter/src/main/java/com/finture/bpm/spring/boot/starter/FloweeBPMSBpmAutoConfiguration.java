...
import com.finture.bpm.engine.spring.ProcessEngineFactoryBean;
import com.finture.bpm.engine.spring.SpringProcessEngineServicesConfiguration;
import com.finture.bpm.spring.boot.starter.event.ProcessApplicationEventPublisher;
import com.finture.bpm.spring.boot.starter.property.FloweeBPMSBpmProperties;
import com.finture.bpm.spring.boot.starter.property.ManagementProperties;
...
@EnableConfigurationProperties({
  FloweeBPMSBpmProperties.class,
  ManagementProperties.class
})
@Import({
  FloweeBPMSBpmConfiguration.class,
...
@Configuration
@ConditionalOnProperty(prefix = FloweeBPMSBpmProperties.PREFIX, name = "enabled", matchIfMissing = true)
@AutoConfigureAfter(name = "org.springframework.boot.autoconfigure.orm.jpa.HibernateJpaAutoConfiguration")
public class FloweeBPMSBpmAutoConfiguration {
  ...
  @Bean
  public FloweeBPMSBpmVersion camundaBpmVersion() {
    return new FloweeBPMSBpmVersion();
  }
