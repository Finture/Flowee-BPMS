...
import com.finture.bpm.spring.boot.starter.plugin.ApplicationContextClassloaderSwitchPlugin;
import com.finture.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorJSR310;
import com.finture.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorJdk8;
import com.finture.bpm.spring.boot.starter.spin.CamundaJacksonFormatConfiguratorParameterNames;
...
import com.finture.connect.plugin.impl.ConnectProcessEnginePlugin;
import com.finture.spin.impl.json.jackson.format.JacksonJsonDataFormat;
import com.finture.spin.plugin.impl.SpinProcessEnginePlugin;
