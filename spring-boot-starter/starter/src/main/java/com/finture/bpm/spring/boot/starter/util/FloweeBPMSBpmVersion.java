...
import static com.finture.bpm.spring.boot.starter.property.FloweeBPMSBpmProperties.PREFIX;
 ...
 */
public class FloweeBPMSBpmVersion implements Supplier<String> {
  ...
  public FloweeBPMSBpmVersion() {
    this(ProcessEngine.class.getPackage());
  }

  FloweeBPMSBpmVersion(final Package pkg) {
