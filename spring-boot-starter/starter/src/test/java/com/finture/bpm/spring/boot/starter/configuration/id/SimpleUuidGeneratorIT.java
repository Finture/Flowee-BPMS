 ...
 */
package com.finture.bpm.spring.boot.starter.configuration.id;
...
import static com.finture.bpm.spring.boot.starter.configuration.id.IdGeneratorConfiguration.SIMPLE;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = { TestApplication.class }, properties = "flowee-bpms.bpm.id-generator=" + SIMPLE)
