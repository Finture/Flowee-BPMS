...
@TestPropertySource(properties = {
  "flowee-bpms.bpm.webapp.indexRedirectEnabled=false",
  "flowee-bpms.bpm.webapp.csrf.targetOrigin=localhost:8080",
  "flowee-bpms.bpm.webapp.csrf.denyStatus=405",
  "flowee-bpms.bpm.webapp.csrf.randomClass=java.util.Random",
  "flowee-bpms.bpm.webapp.csrf.entryPoints[0]=/api/engine/engine/default/history/task/count",
  "flowee-bpms.bpm.webapp.csrf.entryPoints[1]=/api/engine/engine/default/history/variable/count"
})
