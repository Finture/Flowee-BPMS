...
import com.finture.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.AfterStandardConfiguration;
import com.finture.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.BeforeStandardConfiguration;
...
@SpringBootTest(
  ...
  properties = { "flowee-bpms.bpm.admin-user.id=admin"}
)
