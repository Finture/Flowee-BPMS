...
public class FloweeBPMSBpmConfigurationTest {

  @Test
  public void processEngineConfigurationImplTest() {
    FloweeBPMSBpmConfiguration floweeBPMSBpmConfiguration = new FloweeBPMSBpmConfiguration();
    List<ProcessEnginePlugin> processEnginePlugins = createUnordedList();
    ProcessEngineConfigurationImpl processEngineConfigurationImpl = floweeBPMSBpmConfiguration.processEngineConfigurationImpl(processEnginePlugins);
