 ...
 */
package com.finture.bpm.spring.boot.starter.contextcache.pa;

import com.finture.bpm.engine.runtime.ProcessInstance;
import com.finture.bpm.spring.boot.starter.contextcache.AbstractContextCacheTest;
import com.finture.bpm.spring.boot.starter.test.pa.TestProcessApplication;
...
@SpringBootTest(
  ...
  properties = {
    "flowee-bpms.bpm.process-engine-name=foo",
