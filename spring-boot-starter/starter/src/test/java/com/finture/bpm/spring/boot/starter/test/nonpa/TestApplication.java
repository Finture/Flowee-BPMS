 ...
 */
package com.finture.bpm.spring.boot.starter.test.nonpa;
...
public class TestApplication {
  ...
  @ConditionalOnProperty(prefix = "flowee-bpms.bpm", name = "process-engine-name", havingValue = "nojpaTestEngine")
  @Configuration
