 ...
 */
package com.finture.bpm.spring.boot.starter.rest.config.fetchandlock;
...
@TestPropertySource(properties = {"flowee-bpms.bpm.rest-api.fetch-and-lock.unique-worker-request=false"})
