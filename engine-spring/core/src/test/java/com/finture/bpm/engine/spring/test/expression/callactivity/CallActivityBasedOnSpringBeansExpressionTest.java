 ...
 */
package com.finture.bpm.engine.spring.test.expression.callactivity;

import com.finture.bpm.engine.runtime.ProcessInstance;
import com.finture.bpm.engine.spring.test.SpringProcessEngineTestCase;
 ...
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/expression/callactivity/testCallActivityByExpression-context.xml")
public class CallActivityBasedOnSpringBeansExpressionTest extends SpringProcessEngineTestCase {

	@Deployment(resources = {
			"com/finture/bpm/engine/spring/test/expression/callactivity/CallActivityBasedOnSpringBeansExpressionTest.testCallActivityByExpression.bpmn20.xml",
			"com/finture/bpm/engine/spring/test/expression/callactivity/simpleSubProcess.bpmn20.xml" })
