 ...
 */
package com.finture.bpm.engine.spring.test.taskassignment;
 ...
 * @author Joram Barrez
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/taskassignment/taskassignment-context.xml")
