 ...
 */
package com.finture.bpm.engine.spring.test.taskListener;
 ...
 * @author Joram Barrez
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/taskListener/TaskListenerDelegateExpressionTest-context.xml")
