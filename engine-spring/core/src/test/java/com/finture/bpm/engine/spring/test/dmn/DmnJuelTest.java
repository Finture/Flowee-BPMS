 ...
 */
package com.finture.bpm.engine.spring.test.dmn;
...
@ContextConfiguration(locations = {
    "classpath:com/finture/bpm/engine/spring/test/dmn/DmnJuelTest-applicationContext.xml" })
public class DmnJuelTest {
  ...
  public void deploy() {
    deploymentId = repositoryService.createDeployment()
        .addClasspathResource("com/finture/bpm/engine/spring/test/dmn/JuelTest.dmn")
        .deploy()
        .getId();
  }
