 ...
 */
package com.finture.bpm.engine.spring.test.expression;
 ...
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/expression/expressionLimitedBeans-context.xml")
