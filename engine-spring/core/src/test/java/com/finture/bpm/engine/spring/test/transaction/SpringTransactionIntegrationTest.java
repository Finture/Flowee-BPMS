 ...
 */
package com.finture.bpm.engine.spring.test.transaction;
 ...
 * @author Tom Baeyens
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest-context.xml")
public class SpringTransactionIntegrationTest extends SpringProcessEngineTestCase {
  ...
  @Deployment(resources={
      "com/finture/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest.testErrorPropagationOnExceptionInTransaction.bpmn20.xml",
      "com/finture/bpm/engine/spring/test/transaction/SpringTransactionIntegrationTest.throwExceptionProcess.bpmn20.xml"
  })
