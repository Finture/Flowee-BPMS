 ...
 */
package com.finture.bpm.engine.spring.test.components;
...
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/components/ProcessStartingBeanPostProcessorTest-context.xml")
