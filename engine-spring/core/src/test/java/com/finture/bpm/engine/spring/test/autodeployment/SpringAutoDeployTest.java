 ...
 */
package com.finture.bpm.engine.spring.test.autodeployment;

import com.finture.bpm.engine.RepositoryService;
import com.finture.bpm.engine.impl.test.PvmTestCase;
...
public class SpringAutoDeployTest extends PvmTestCase {
  ...
  protected static final String CTX_PATH
    = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployTest-context.xml";
  protected static final String CTX_CREATE_DROP_CLEAN_DB
    = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployTest-create-drop-clean-db-context.xml";
  protected static final String CTX_DYNAMIC_DEPLOY_PATH
  = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployTest-dynamic-deployment-context.xml";

  protected static final String CTX_CMMN_PATH
    = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployCmmnTest-context.xml";

  protected static final String CTX_CMMN_BPMN_TOGETHER_PATH
      = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployCmmnBpmnTest-context.xml";

  protected static final String CTX_DEPLOY_CHANGE_ONLY_PATH
      = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployDeployChangeOnlyTest-context.xml";

  protected static final String CTX_TENANT_ID_PATH
      = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployTenantIdTest-context.xml";

  protected static final String CTX_CUSTOM_NAME_PATH
      = "com/finture/bpm/engine/spring/test/autodeployment/SpringAutoDeployCustomNameTest-context.xml";
