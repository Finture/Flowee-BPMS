 ...
 */
package com.finture.bpm.engine.spring.test.container;

import com.finture.bpm.BpmPlatform;
import com.finture.bpm.engine.spring.container.ManagedProcessEngineFactoryBean;
...
public class ManagedProcessEngineFactoryBeanTest {
  ...
  public void testProcessApplicationDeployment() {
    ...
    AbstractApplicationContext applicationContext = new ClassPathXmlApplicationContext("com/finture/bpm/engine/spring/test/container/ManagedProcessEngineFactoryBean-context.xml");
