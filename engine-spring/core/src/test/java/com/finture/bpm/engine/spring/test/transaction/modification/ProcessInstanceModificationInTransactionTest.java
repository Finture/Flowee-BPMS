 ...
 */
package com.finture.bpm.engine.spring.test.transaction.modification;
...
@ContextConfiguration(locations = {"classpath:com/finture/bpm/engine/spring/test/transaction/ProcessInstanceModificationInTransactionTest-applicationContext.xml"})
