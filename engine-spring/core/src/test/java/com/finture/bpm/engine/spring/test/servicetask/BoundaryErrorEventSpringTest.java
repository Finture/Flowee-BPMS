 ...
 */
package com.finture.bpm.engine.spring.test.servicetask;
 ...
 * @author Falko Menge
 */
@ContextConfiguration("classpath:com/finture/bpm/engine/spring/test/servicetask/serviceraskSpringTestCatchError-context.xml")
