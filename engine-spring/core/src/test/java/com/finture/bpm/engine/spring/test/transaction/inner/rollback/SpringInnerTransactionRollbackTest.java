 ...
 */
package com.finture.bpm.engine.spring.test.transaction.inner.rollback;
...
@ContextConfiguration(locations = {"classpath:com/finture/bpm/engine/spring/test/transaction/"
...
public class SpringInnerTransactionRollbackTest {
  ...
  @Deployment(resources = {
    "com/finture/bpm/engine/spring/test/transaction/"
