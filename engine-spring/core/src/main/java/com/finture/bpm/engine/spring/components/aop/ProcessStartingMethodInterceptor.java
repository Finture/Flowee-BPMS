...
import com.finture.bpm.engine.spring.annotations.BusinessKey;
import com.finture.bpm.engine.spring.annotations.ProcessVariable;
import com.finture.bpm.engine.spring.annotations.StartProcess;
...
public class ProcessStartingMethodInterceptor implements MethodInterceptor {
	...
	/**
	 * injected reference - can be obtained via a {@link com.finture.bpm.engine.spring.ProcessEngineFactoryBean}
	 */
	protected ProcessEngine processEngine;

	/**
	 * @param processEngine takes a reference to a {@link com.finture.bpm.engine.ProcessEngine}
	 */
	...
	/**
	 * if there any arguments with the {@link com.finture.bpm.engine.annotations.ProcessVariable} annotation,
