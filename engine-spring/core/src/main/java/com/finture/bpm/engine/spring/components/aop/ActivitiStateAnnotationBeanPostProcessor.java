 ...
 */
package com.finture.bpm.engine.spring.components.aop;
...
import com.finture.bpm.engine.spring.annotations.ProcessId;
import com.finture.bpm.engine.spring.annotations.ProcessVariable;
import com.finture.bpm.engine.spring.annotations.ProcessVariables;
import com.finture.bpm.engine.spring.annotations.State;
import com.finture.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistration;
import com.finture.bpm.engine.spring.components.registry.ActivitiStateHandlerRegistry;
 ...
 * that have the {@link com.finture.bpm.engine.annotations.State} annotation.
 *
 * @author Josh Long
 * @since 5.3
 */
...
public class ActivitiStateAnnotationBeanPostProcessor implements BeanPostProcessor, BeanClassLoaderAware, BeanFactoryAware, InitializingBean, Ordered {
	...
	public Object postProcessAfterInitialization(final Object bean,
		...
		final com.finture.bpm.engine.spring.annotations.ProcessEngineComponent component = targetClass.getAnnotation(com.finture.bpm.engine.spring.annotations.ProcessEngineComponent.class);
