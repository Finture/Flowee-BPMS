 ...
 */
package com.finture.bpm.engine.spring.application;
...
import com.finture.bpm.application.impl.EjbProcessApplication;
import com.finture.bpm.engine.spring.ApplicationContextElResolver;
 ...
 *    <li>Bootstrapping through {@link com.finture.bpm.application.impl.ServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof com.finture.bpm.application.impl.ServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      com.finture.bpm.application.impl.ServletProcessApplication servletProcessApplication = (com.finture.bpm.application.impl.ServletProcessApplication) processApplication;
