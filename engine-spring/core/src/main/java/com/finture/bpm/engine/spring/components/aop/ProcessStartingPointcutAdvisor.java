...
import com.finture.bpm.engine.spring.components.aop.util.MetaAnnotationMatchingPointcut;
 ...
 * type of {@link com.finture.bpm.engine.runtime.ProcessInstance} and then subsequently
...
public class ProcessStartingPointcutAdvisor implements PointcutAdvisor, Serializable {
	...
	/**
	 * the injected reference to the {@link com.finture.bpm.engine.ProcessEngine}
	 */
