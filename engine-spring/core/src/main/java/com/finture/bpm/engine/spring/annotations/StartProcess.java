 ...
 */
package com.finture.bpm.engine.spring.annotations;
...
public @interface StartProcess {
	...
	/**
	 * returns the ID of the {@link com.finture.bpm.engine.runtime.ProcessInstance}. If specified, it'll only work if
	 * the return type of the invocation is compatabile with a {@link com.finture.bpm.engine.runtime.ProcessInstance}'s ID
