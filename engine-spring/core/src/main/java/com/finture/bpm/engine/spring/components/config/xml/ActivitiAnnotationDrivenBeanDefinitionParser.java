 ...
 */
package com.finture.bpm.engine.spring.components.config.xml;


import com.finture.bpm.engine.spring.components.ActivitiContextUtils;
import com.finture.bpm.engine.spring.components.aop.ProcessStartAnnotationBeanPostProcessor;
...
/**
 * registers support for handling the annotations in the com.finture.bpm.engine.annotations package.
 * <p/>
 ...
 * {@link com.finture.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} if none exists.
 *
 * @author Josh Long
 * @since 5.3
 */
