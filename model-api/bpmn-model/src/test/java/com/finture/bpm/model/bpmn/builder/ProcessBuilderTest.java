 ...
 */
package com.finture.bpm.model.bpmn.builder;

import static org.assertj.core.api.Assertions.assertThat;
import static org.assertj.core.api.Fail.fail;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.BOUNDARY_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.CALL_ACTIVITY_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.CATCH_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.CONDITION_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.EXTERNAL_TASK_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.FORM_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.PROCESS_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.SERVICE_TASK_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.START_EVENT_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.SUB_PROCESS_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TASK_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_CLASS_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_CONDITION;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_CONDITIONAL_VARIABLE_EVENTS;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_CONDITIONAL_VARIABLE_EVENTS_LIST;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_CONDITIONAL_VARIABLE_NAME;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_DELEGATE_EXPRESSION_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_DUE_DATE_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_EXPRESSION_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_EXTERNAL_TASK_TOPIC;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_FOLLOW_UP_DATE_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_GROUPS_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_GROUPS_LIST_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_HISTORY_TIME_TO_LIVE;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_PRIORITY_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_PROCESS_TASK_PRIORITY;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_SERVICE_TASK_PRIORITY;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_STARTABLE_IN_TASKLIST;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_STRING_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_STRING_FORM_REF_BINDING;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_STRING_FORM_REF_VERSION;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_USERS_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_USERS_LIST_API;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TEST_VERSION_TAG;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.TRANSACTION_ID;
import static com.finture.bpm.model.bpmn.BpmnTestConstants.USER_TASK_ID;
...
import com.finture.bpm.model.bpmn.AssociationDirection;
import com.finture.bpm.model.bpmn.Bpmn;
import com.finture.bpm.model.bpmn.BpmnModelException;
import com.finture.bpm.model.bpmn.BpmnModelInstance;
import com.finture.bpm.model.bpmn.GatewayDirection;
import com.finture.bpm.model.bpmn.TransactionMethod;
import com.finture.bpm.model.bpmn.instance.Activity;
import com.finture.bpm.model.bpmn.instance.Association;
import com.finture.bpm.model.bpmn.instance.BaseElement;
import com.finture.bpm.model.bpmn.instance.BoundaryEvent;
import com.finture.bpm.model.bpmn.instance.BpmnModelElementInstance;
import com.finture.bpm.model.bpmn.instance.BusinessRuleTask;
import com.finture.bpm.model.bpmn.instance.CallActivity;
import com.finture.bpm.model.bpmn.instance.CompensateEventDefinition;
import com.finture.bpm.model.bpmn.instance.ConditionalEventDefinition;
import com.finture.bpm.model.bpmn.instance.Definitions;
import com.finture.bpm.model.bpmn.instance.Documentation;
import com.finture.bpm.model.bpmn.instance.EndEvent;
import com.finture.bpm.model.bpmn.instance.Error;
import com.finture.bpm.model.bpmn.instance.ErrorEventDefinition;
import com.finture.bpm.model.bpmn.instance.Escalation;
import com.finture.bpm.model.bpmn.instance.EscalationEventDefinition;
import com.finture.bpm.model.bpmn.instance.Event;
import com.finture.bpm.model.bpmn.instance.EventDefinition;
import com.finture.bpm.model.bpmn.instance.ExtensionElements;
import com.finture.bpm.model.bpmn.instance.FlowElement;
import com.finture.bpm.model.bpmn.instance.FlowNode;
import com.finture.bpm.model.bpmn.instance.Gateway;
import com.finture.bpm.model.bpmn.instance.InclusiveGateway;
import com.finture.bpm.model.bpmn.instance.Message;
import com.finture.bpm.model.bpmn.instance.MessageEventDefinition;
import com.finture.bpm.model.bpmn.instance.MultiInstanceLoopCharacteristics;
import com.finture.bpm.model.bpmn.instance.Process;
import com.finture.bpm.model.bpmn.instance.ReceiveTask;
import com.finture.bpm.model.bpmn.instance.ScriptTask;
import com.finture.bpm.model.bpmn.instance.SendTask;
import com.finture.bpm.model.bpmn.instance.SequenceFlow;
import com.finture.bpm.model.bpmn.instance.ServiceTask;
import com.finture.bpm.model.bpmn.instance.Signal;
import com.finture.bpm.model.bpmn.instance.SignalEventDefinition;
import com.finture.bpm.model.bpmn.instance.StartEvent;
import com.finture.bpm.model.bpmn.instance.SubProcess;
import com.finture.bpm.model.bpmn.instance.Task;
import com.finture.bpm.model.bpmn.instance.TimeCycle;
import com.finture.bpm.model.bpmn.instance.TimeDate;
import com.finture.bpm.model.bpmn.instance.TimeDuration;
import com.finture.bpm.model.bpmn.instance.TimerEventDefinition;
import com.finture.bpm.model.bpmn.instance.Transaction;
import com.finture.bpm.model.bpmn.instance.UserTask;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaErrorEventDefinition;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaExecutionListener;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaFailedJobRetryTimeCycle;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaFormData;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaFormField;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaIn;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaInputOutput;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaInputParameter;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaOut;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaOutputParameter;
import com.finture.bpm.model.bpmn.instance.camunda.CamundaTaskListener;
import com.finture.bpm.model.xml.Model;
import com.finture.bpm.model.xml.instance.ModelElementInstance;
import com.finture.bpm.model.xml.type.ModelElementType;
...
public class ProcessBuilderTest {
  ...
  public void testCreateInvoiceProcess() {
    modelInstance = Bpmn.createProcess()
      ...
      .serviceTask()
        ...
        .camundaClass("com.finture.bpm.example.invoice.service.ArchiveInvoiceService" )
      .endEvent()
  ...
  public void testBusinessRuleTaskCamundaClass() {
    ...
    BusinessRuleTask businessRuleTask = modelInstance.getModelElementById(TASK_ID);
    assertThat(businessRuleTask.getCamundaClass()).isEqualTo("com.finture.bpm.model.bpmn.Bpmn");
  }
