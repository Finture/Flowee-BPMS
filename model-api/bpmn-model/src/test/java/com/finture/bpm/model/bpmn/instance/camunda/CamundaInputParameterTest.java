...
public class CamundaInputParameterTest extends BpmnModelElementInstanceTest {
  ...
  public void testIntputParameterScriptChildAssignment() {
    try {
      com.finture.bpm.model.bpmn.instance.camunda.CamundaInputParameter inputParamElement = modelInstance.newInstance(com.finture.bpm.model.bpmn.instance.camunda.CamundaInputParameter.class);
