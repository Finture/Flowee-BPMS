...
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_BEHAVIOR;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_IS_SEQUENTIAL;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_MULTI_INSTANCE_LOOP_CHARACTERISTICS;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_NONE_BEHAVIOR_EVENT_REF;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_ONE_BEHAVIOR_EVENT_REF;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ASYNC_AFTER;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ASYNC_BEFORE;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_EXCLUSIVE;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_COLLECTION;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ELEMENT_VARIABLE;
...
import com.finture.bpm.model.bpmn.MultiInstanceFlowCondition;
import com.finture.bpm.model.bpmn.builder.MultiInstanceLoopCharacteristicsBuilder;
import com.finture.bpm.model.bpmn.instance.CompletionCondition;
import com.finture.bpm.model.bpmn.instance.ComplexBehaviorDefinition;
import com.finture.bpm.model.bpmn.instance.DataInput;
import com.finture.bpm.model.bpmn.instance.DataOutput;
import com.finture.bpm.model.bpmn.instance.EventDefinition;
import com.finture.bpm.model.bpmn.instance.InputDataItem;
import com.finture.bpm.model.bpmn.instance.LoopCardinality;
import com.finture.bpm.model.bpmn.instance.LoopCharacteristics;
import com.finture.bpm.model.bpmn.instance.MultiInstanceLoopCharacteristics;
import com.finture.bpm.model.bpmn.instance.OutputDataItem;
...
import com.finture.bpm.model.xml.type.child.ChildElement;
...
import com.finture.bpm.model.xml.type.reference.AttributeReference;
import com.finture.bpm.model.xml.type.reference.ElementReference;
