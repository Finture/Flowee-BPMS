...
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_CLOSED;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_IS_EXECUTABLE;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ATTRIBUTE_PROCESS_TYPE;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.BPMN_ELEMENT_PROCESS;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_GROUPS;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_CANDIDATE_STARTER_USERS;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_HISTORY_TIME_TO_LIVE;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_IS_STARTABLE_IN_TASKLIST;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_JOB_PRIORITY;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_TASK_PRIORITY;
import static com.finture.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_VERSION_TAG;
...
import com.finture.bpm.model.bpmn.ProcessType;
import com.finture.bpm.model.bpmn.builder.ProcessBuilder;
import com.finture.bpm.model.bpmn.instance.Artifact;
import com.finture.bpm.model.bpmn.instance.Auditing;
import com.finture.bpm.model.bpmn.instance.CallableElement;
import com.finture.bpm.model.bpmn.instance.CorrelationSubscription;
import com.finture.bpm.model.bpmn.instance.FlowElement;
import com.finture.bpm.model.bpmn.instance.LaneSet;
import com.finture.bpm.model.bpmn.instance.Monitoring;
import com.finture.bpm.model.bpmn.instance.Process;
import com.finture.bpm.model.bpmn.instance.Property;
import com.finture.bpm.model.bpmn.instance.ResourceRole;
import com.finture.bpm.model.xml.ModelBuilder;
import com.finture.bpm.model.xml.impl.instance.ModelTypeInstanceContext;
import com.finture.bpm.model.xml.impl.util.StringUtil;
...
import com.finture.bpm.model.xml.type.reference.ElementReferenceCollection;
