...
[NOTE]
====
camunda BPMN model can be used standalone, independenly of Flowee BPMS / process engine.
====
...
and can be executed by the Flowee BPMS.
...
the tests in link:src/test/java/com/finture/bpm/model/bpmn/builder/ProcessBuilderTest.java[ProcessBuilderTest.java] or this
...
link:src/test/java/com/finture/bpm/model/bpmn/CreateModelTest.java[CreateModelTest.java].
...
link:src/main/java/com/finture/bpm/model/bpmn/instance[com.finture.bpm.model.bpmn.instance]
